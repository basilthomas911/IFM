...
{
    /// <summary>Provides the SpreadDistributionJobService UI service boundary.</summary>
    public class SpreadDistributionJobService : UiServiceBase<SpreadDistributionJobService>
    {
