...
{
    /// <summary>Provides the FundEventService UI service boundary.</summary>
    public class FundEventService : UiServiceBase<FundEventService>
    {
        ...
        public FundEventService(IFundUIEventConsumer fundEventConsumer)
        {
