...
/// <summary>Provides the TradeCommandService UI service boundary.</summary>
public class TradeCommandService : UiServiceBase<TradeCommandService>
{
    ...
    /// <returns></returns>
    public async Task<Guid> InsertOptionTradeSpreadDataAsync(OptionTradeSpreadsDataModel optionTradeSpreadData)
    ...
    /// <returns></returns>
    public async Task<Guid> DeleteOptionTradeSpreadBarDataAsync(OptionTradeEntityId optionTradeId, TradeType tradeType, DateOnly valueDate)
    ...
    /// <returns></returns>
    public async Task<Guid> InsertOptionTradeSpreadBarDataAsync(OptionTradeSpreadBarsDataModel optionTradeSpreadBarData)
    ...
    public async Task ChangeOptionLegDataAsync(int orderId, int tradeId, TradePositionEntityId key, decimal assetPrice, double riskFreeRate, OptionTradeLegDataReadModel optionLegData)
