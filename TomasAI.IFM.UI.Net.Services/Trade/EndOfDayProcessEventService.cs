...
/// <summary>Provides the EndOfDayProcessEventService UI service boundary.</summary>
public class EndOfDayProcessEventService(IEndOfDayProcessUIEventConsumer eodEventConsumer) : UiServiceBase<EndOfDayProcessEventService>
{
