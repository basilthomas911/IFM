namespace TomasAI.IFM.UI.Net.Views.MarketData
{
    partial class MarketDataForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            ddlMarketDataSelector = new ComboBox();
            ...
            pnlMarketDataSelector.Controls.Add(ddlMarketDataSelector);
            ...
            pnlMarketDataSelector.Size = new Size(1058, 37);
            pnlMarketDataSelector.TabIndex = 0;
            // 
            // ddlMarketDataSelector
            // 
            ddlMarketDataSelector.DropDownStyle = ComboBoxStyle.DropDownList;
            ddlMarketDataSelector.Font = new Font("Microsoft Sans Serif", 10F, FontStyle.Regular, GraphicsUnit.Point, 0);
            ddlMarketDataSelector.FormattingEnabled = true;
            ddlMarketDataSelector.Location = new Point(118, 8);
            ddlMarketDataSelector.Margin = new Padding(2);
            ddlMarketDataSelector.Name = "ddlMarketDataSelector";
            ddlMarketDataSelector.Size = new Size(826, 24);
            ddlMarketDataSelector.TabIndex = 1;
            ddlMarketDataSelector.SelectedIndexChanged += ddlMarketDataSelector_SelectedIndexChanged;
            // 
            ...
            pnlCommands.Location = new Point(943, 37);
            ...
            pnlMarketData.Size = new Size(943, 407);
            ...
            Text = "Market Data Manager";
            FormClosing += MarketDataForm_FormClosing;
            Load += MarketDataForm_Load;
