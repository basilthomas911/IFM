...
public sealed record ListParameterComponentsQuery:IQuery<ParameterComponentSummary[]>
{
    ...
    public ListParameterComponentsQuery() { }
    ...
    public ListParameterComponentsQuery(ActorSubject subject, IActorEntityId entityId, Guid setId, string componentCode, string payloadJson, int schemaVersion)
    {
        Subject = subject;
        EntityId = entityId;
        SetId = setId;
