...
public sealed record PublishParameterVersionCommand:IParameterSetMutation
{
    ...
    public PublishParameterVersionCommand() { }
    ...
    public PublishParameterVersionCommand(Guid commandId, ActorSubject subject, bool postEvents, ParameterSetEntityId entityId, int errorCode, BoundedContextName routeTo, long expectedRevision, int version, string componentCode, string name, string description, int schemaVersion, string payloadJson)
    {
        CommandId = commandId;
        Subject = subject;
