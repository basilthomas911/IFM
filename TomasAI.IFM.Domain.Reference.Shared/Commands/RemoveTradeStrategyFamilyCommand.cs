...
public sealed record RemoveTradeStrategyFamilyCommand : ICommand<ActorEntityId>
{

    /// <summary>Creates an empty command for serialization.</summary>
    public RemoveTradeStrategyFamilyCommand() { }
    ...
    public RemoveTradeStrategyFamilyCommand(Guid commandId, ActorSubject subject, bool postEvents, ActorEntityId entityId, int errorCode, BoundedContextName routeTo, RemoveTradeStrategyFamilyRequest request)
    {
        CommandId = commandId;
        Subject = subject;
    ...
    [IgnoreMember] public const int ErrorId = 8063;
    ...
    [Key(6)] public RemoveTradeStrategyFamilyRequest Request { get; init; } = new();
    [IgnoreMember] public string CommandName => nameof(RemoveTradeStrategyFamilyCommand);
