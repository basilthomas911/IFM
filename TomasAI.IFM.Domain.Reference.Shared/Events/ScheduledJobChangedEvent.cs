...
namespace TomasAI.IFM.Domain.Reference.Shared.Events
{
    ...
    public record ScheduledJobChangedEvent : IEvent
    {
        ...
        // payload (keys 8..)
        [Key(8)] public ScheduledJobReadModel ScheduledJob { get; init; }

        [IgnoreMember] public string UserName => CachedUserName;
        [IgnoreMember] public string EventName => nameof(ScheduledJobChangedEvent);
        [IgnoreMember] public EventType EventType => EventType.DomainEvent;

        public ScheduledJobChangedEvent() { }
        ...
        public ScheduledJobChangedEvent(
            ...
            string eventSource,
            DateTime receivedOn,
            ScheduledJobReadModel scheduledJob)
        {
            Subject = subject;
            Id = id;
            EntityId = entityId;
