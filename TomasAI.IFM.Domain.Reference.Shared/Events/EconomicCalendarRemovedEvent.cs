...
namespace TomasAI.IFM.Domain.Reference.Shared.Events;

/// <summary>
/// Represents a domain event indicating that an economic calendar entry has been removed. Used to communicate the removal
/// of an economic calendar entry within the event-driven system and to support denormalization workflows.
/// </summary>
/// <remarks>This event is typically published when an economic calendar entry is successfully deleted. It carries
/// metadata and the details of the removed economic calendar entry for downstream processing, auditing, or projection
...
public record EconomicCalendarRemovedEvent : IEvent<EconomicCalendarId>
{
    ...
    // payload (keys 8..)
    [Key(8)] public DateTime RemovedOn { get; init; }
    [Key(9)] public string RemovedBy { get; init; }

    [IgnoreMember] public string UserName => $"{Environment.UserDomainName}\\{Environment.UserName}";
    [IgnoreMember] public string EventName => GetType().Name;
    [IgnoreMember] public EventType EventType => EventType.DomainEvent;

    public EconomicCalendarRemovedEvent() { }
        ...
        where TEntityId : IActorEntityId
    {
        ...
        ICompleteEvent<EconomicCalendarId> completed = new EconomicCalendarRemovedCompleteEvent
        {
            Subject = new ActorSubject(ActorType.Event, EconomicCalendarRemovedCompleteEvent.Actor, EconomicCalendarRemovedCompleteEvent.Verb, this.Subject.EntityId),
        ...
        where TEntityId : IActorEntityId
    {
        ...
        IErrorEvent<EconomicCalendarId> failed = new EconomicCalendarRemovedFailEvent
        {
            Subject = new ActorSubject(ActorType.Event, EconomicCalendarRemovedFailEvent.Actor, EconomicCalendarRemovedFailEvent.Verb, this.Subject.EntityId),
            EntityId = this.EntityId,
            Id = this.Id,
...
/// <summary>
/// Event published when an economic calendar entry has been removed successfully.
/// Carries metadata from the original event.
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record EconomicCalendarRemovedCompleteEvent : ICompleteEvent<EconomicCalendarId>
{
    [IgnoreMember] public const string Actor = "EconomicCalendarEvent";
    ...
    public EconomicCalendarRemovedCompleteEvent() { }
...
/// <summary>
/// Event published when removing an economic calendar entry fails.
/// Carries standardized error details from the error event contract.
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record EconomicCalendarRemovedFailEvent : IErrorEvent<EconomicCalendarId>
{
    [IgnoreMember] public const string Actor = "EconomicCalendarEvent";
    ...
    public EconomicCalendarRemovedFailEvent() { }
