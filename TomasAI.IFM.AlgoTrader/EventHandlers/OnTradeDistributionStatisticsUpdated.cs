...
namespace TomasAI.IFM.Service.AlgoTrader.EventHandlers
{
    ...
    public class OnTradeDistributionStatisticsUpdated : BaseEventServiceHandler,
        IAsyncEventHandler<TradeDistributionStatisticsUpdatedEvent, AlgoTraderService>
    {
        private readonly ITradeStrategyEventProducer _tradeStrategyEventProducer;
        private readonly ILogger<TradeDistributionStatisticsUpdatedEvent> _logger;
        ...
        public OnTradeDistributionStatisticsUpdated(
            ...
            ILogger<TradeDistributionStatisticsUpdatedEvent> logger) : base(statusConsoleWriter)
        {
        ...
        /// <param name="e"></param>
        /// <returns></returns>
        public Task ExecuteAsync(TradeDistributionStatisticsUpdatedEvent e)
        {
