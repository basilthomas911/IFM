...
-- Description:	backup option pricer database
-- =============================================
...
BEGIN
	...
	if @backupType = 'full'
		BACKUP DATABASE [optionpricerdb] TO  URL = @backupName WITH  FORMAT, INIT,  NAME = N'optionpricerdb-Full Database Backup', SKIP, NOREWIND, NOUNLOAD,  STATS = 10
	else
		BACKUP DATABASE [optionpricerdb] TO  URL = @backupName WITH  DIFFERENTIAL , FORMAT, INIT,  NAME = N'optionpricerdb-Full Database Backup', SKIP, NOREWIND, NOUNLOAD,  STATS = 10
END