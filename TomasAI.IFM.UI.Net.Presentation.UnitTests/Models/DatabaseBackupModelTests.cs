...
public sealed class DatabaseBackupModelTests
{
    static readonly DateTimeOffset Now = new(2026, 8, 12, 12, 0, 0, TimeSpan.Zero);

    [Fact]
    public async Task Model_maps_bounded_query_results_to_immutable_ui_state()
    {
        ...
        var result = await model.LoadAsync(BackupSource.LocalWorkstation, "core");
