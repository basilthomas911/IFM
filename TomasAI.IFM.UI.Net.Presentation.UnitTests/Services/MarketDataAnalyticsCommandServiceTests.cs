...
/// <summary>Verifies the analytics command service intraday lifecycle.</summary>
public sealed class MarketDataAnalyticsCommandServiceTests
{
    ...
    static MarketDataAnalyticsCommandService CreateSubject(IMarketDataAnalyticsCommandApi commandApi)
        => new(
            commandApi,
