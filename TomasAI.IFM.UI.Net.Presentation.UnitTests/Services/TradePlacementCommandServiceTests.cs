...
/// <summary>Verifies Trade Placement command service correlation and cancellation.</summary>
public sealed class TradePlacementCommandServiceTests
{
    [Fact]
    public async Task Start_returns_confirmed_command_id_and_forwards_cancellation()
    {
        ...
        var subject = new TradePlacementCommandService(api);
