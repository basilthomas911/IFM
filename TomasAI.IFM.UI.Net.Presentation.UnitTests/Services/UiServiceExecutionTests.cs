...
/// <summary>Verifies UI service execution, error, cancellation, and completion semantics.</summary>
public sealed class UiServiceExecutionTests
{
    [Fact]
    public async Task QuerySuccess_InvokesResultCallbackExactlyOnce()
    {
        var model = new ProbeService();
    ...
    {
        var model = new ProbeService();
        IUiService<ProbeService> modelContract = model;
    ...
    sealed class ProbeService : UiServiceBase<ProbeService>
    {
