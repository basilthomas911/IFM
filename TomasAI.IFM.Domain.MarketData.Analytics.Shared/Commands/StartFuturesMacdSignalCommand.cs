...
public record StartFuturesMacdSignalCommand : ICommand<FuturesMacdSignalEntityId>
{
    ...
    public StartFuturesMacdSignalCommand() { }
    public StartFuturesMacdSignalCommand(FuturesMacdSignalEntityId entityId)
    {
