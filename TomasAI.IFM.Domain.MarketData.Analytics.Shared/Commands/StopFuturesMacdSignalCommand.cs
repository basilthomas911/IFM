...
public record StopFuturesMacdSignalCommand : ICommand<FuturesMacdSignalEntityId>
{
    ...
    public StopFuturesMacdSignalCommand(Guid commandId, ActorSubject subject, bool postEvents, FuturesMacdSignalEntityId entityId, int errorCode, BoundedContextName routeTo)
    {
        CommandId = commandId;
        Subject = subject;
    ...
    public StopFuturesMacdSignalCommand() { }
    public StopFuturesMacdSignalCommand(FuturesMacdSignalEntityId entityId)
    {
