...
public record StopFuturesAdxSignalCommand : ICommand<FuturesAdxSignalEntityId>
{
    ...
    public StopFuturesAdxSignalCommand(Guid commandId, ActorSubject subject, bool postEvents, FuturesAdxSignalEntityId entityId, int errorCode, BoundedContextName routeTo)
    {
        CommandId = commandId;
        Subject = subject;
