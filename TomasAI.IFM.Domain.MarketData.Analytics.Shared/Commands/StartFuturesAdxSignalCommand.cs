...
public record StartFuturesAdxSignalCommand : ICommand<FuturesAdxSignalEntityId>
{
    ...
    public StartFuturesAdxSignalCommand() { }
    public StartFuturesAdxSignalCommand(FuturesAdxSignalEntityId entityId)
    {
