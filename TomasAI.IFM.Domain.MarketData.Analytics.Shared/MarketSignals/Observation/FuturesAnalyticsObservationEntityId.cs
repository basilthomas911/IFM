...
[MessagePackObject]
public readonly record struct FuturesAnalyticsObservationId
{
    ...
    public FuturesAnalyticsObservationId(Guid value) => Value = value;
    ...
    public static FuturesAnalyticsObservationId Create(
    ...
    public static FuturesAnalyticsObservationId Parse(string value) => new(Guid.Parse(value));
    ...
    public static bool TryParse(string? value, out FuturesAnalyticsObservationId observationId)
    {
...
public sealed class FuturesAnalyticsObservationIdValidationRules
    : BaseValidationRules, IValidationStructRules<FuturesAnalyticsObservationId>
{
    ...
    public ValidationError[] Execute(FuturesAnalyticsObservationId value) => Validate(value, Rules);

    sealed class Validator : AbstractValidator<FuturesAnalyticsObservationId>
    {
...
/// </summary>
[MessagePackObject]
public readonly record struct FuturesAnalyticsObservationEntityId : IActorEntityId
{
    ...
    /// <param name="timeFrame">Observation timeframe.</param>
    [SerializationConstructor]
    public FuturesAnalyticsObservationEntityId(
    ...
    public static FuturesAnalyticsObservationEntityId Parse(string value) =>
        TryParse(value, out var parsed)
            ? parsed
            : throw new FormatException("FuturesAnalyticsObservationEntityId is malformed.");
    ...
    /// <returns><see langword="true"/> when parsing succeeds; otherwise <see langword="false"/>.</returns>
    public static bool TryParse(string? value, out FuturesAnalyticsObservationEntityId entityId)
    {
        entityId = default;
        ...
        return new FuturesAnalyticsObservationEntityIdValidationRules().Execute(entityId).Length == 0;
    }
...
public sealed class FuturesAnalyticsObservationEntityIdValidationRules
    : BaseValidationRules, IValidationStructRules<FuturesAnalyticsObservationEntityId>
{
    static readonly Validator Rules = new();
    ...
    /// <param name="value">Identity to validate.</param>
    /// <returns>All validation errors, or an empty array when valid.</returns>
    public ValidationError[] Execute(FuturesAnalyticsObservationEntityId value) => Validate(value, Rules);

    sealed class Validator : AbstractValidator<FuturesAnalyticsObservationEntityId>
    {
        public Validator()
        {
