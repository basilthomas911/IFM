...
5. Command load/save and simple query wrappers created unnecessary async state machines. Direct `ValueTask` propagation is used where no post-await work exists.
