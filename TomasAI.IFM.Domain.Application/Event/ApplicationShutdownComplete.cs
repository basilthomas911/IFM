...
public static class ApplicationShutdownComplete
{
    ...
    public static ValueTask ExecuteAsync(this ApplicationShutdownCompleteEvent eventValue, IApplicationEventContext context, CancellationToken cancellationToken)
    {
