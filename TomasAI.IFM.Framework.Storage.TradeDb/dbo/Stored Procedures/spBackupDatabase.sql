...
-- Description:	backup trade data database
-- =============================================
...
BEGIN
	...
	if @backupType = 'full'
		BACKUP DATABASE tradedb TO  URL = @backupName WITH  FORMAT, INIT,  NAME = N'tradedb-Full Database Backup', SKIP, NOREWIND, NOUNLOAD,  STATS = 10
	else
		BACKUP DATABASE tradedb TO  URL = @backupName WITH  DIFFERENTIAL , FORMAT, INIT,  NAME = N'tradedb-Full Database Backup', SKIP, NOREWIND, NOUNLOAD,  STATS = 10
END