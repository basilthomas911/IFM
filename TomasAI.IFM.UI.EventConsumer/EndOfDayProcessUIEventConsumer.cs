...
/// <summary>
/// Represents a consumer for end-of-day process UI events, utilizing Nats for asynchronous event consumption.
/// </summary>
/// <remarks>This class is designed to handle events related to the end-of-day process in a UI context. It extends
/// <see cref="NatsActorEventListener"/> to leverage Nats's capabilities for event-driven architecture.</remarks>
/// <param name="options"></param>
/// <param name="logger"></param>
public class EndOfDayProcessUIEventConsumer(INatsEventListenerOptions options, ILogger logger)
    : NatsActorEventListener(options, logger), IEndOfDayProcessUIEventConsumer
{
    readonly static string EventConsumer = "EndOfDayProcessUIEventConsumer";
    ...
    readonly Dictionary<ActorMailboxId, List<string>> _eventMap = new()
    {
        ...
        [new ActorMailboxId(ActorType.Event, OptionTradeEndOfDayProcessedFailEvent.Actor)]
...
public interface IEndOfDayProcessUIEventConsumer
{
