...
Raw run directories are ignored by Git because they can be large and environment-specific. Accepted full-gate or numbered-slice summaries that must be retained with the code should be copied into `TomasAI.IFM.UI.Net/Docs/TestResults/` and linked from the WinForms UI system-test specification.
