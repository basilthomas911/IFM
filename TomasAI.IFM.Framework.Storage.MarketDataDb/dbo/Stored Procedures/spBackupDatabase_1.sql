...
BEGIN
	...
	if @backupType = 'full'
		BACKUP DATABASE [marketdatadb] TO  URL = @backupName WITH  FORMAT, INIT,  NAME = N'marketdatadb-Full Database Backup', SKIP, NOREWIND, NOUNLOAD,  STATS = 10
	else
		BACKUP DATABASE [marketdatadb] TO  URL = @backupName WITH  DIFFERENTIAL , FORMAT, INIT,  NAME = N'marketdatadb-Full Database Backup', SKIP, NOREWIND, NOUNLOAD,  STATS = 10
END