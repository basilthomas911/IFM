...
public class ShortIronCondorTradePlan : TradePlan, ITradeAlgorithm
{
    ...
    public ShortIronCondorTradePlan(DateOnly valueDate, IOptionTradeCollection optionTrades, FuturesEodDataV2ReadModel futuresEodData, FuturesTradeSignalV2ReadModel futuresTradeSignal, IBlackboardService blackboardService, DateTime createdOn, string createdBy)
        : base(
            ...
            createdBy: createdBy)
    {
        ...
        var ironCondorMDILimit = new IronCondorMDILimitDataModel(
            Id: optionTrades.PrimaryTrade.EntityId,
            ValueDate: valueDate,
        ...
        blackboardService.IronCondorMDILimit.Set(optionTrades.PrimaryTrade.EntityId, valueDate, ironCondorMDILimit);
    ...
    public ShortIronCondorTradePlan SetForwardLossLimitType(Func<TradePlanForwardLossLimitEntityId, ForwardLossLimitType> getForwardLossLimitType)
    {
