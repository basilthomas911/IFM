...
public class LongIronCondorAlgorithm : LongIronCondorTradePlan, ITradeAlgorithm
{
    LongIronCondorRuleEngine _rule = default!;
    ...
    public LongIronCondorAlgorithm(DateOnly valueDate, IOptionTradeCollection optionTrades, FuturesEodDataV2ReadModel futuresEodData, FuturesTradeSignalV2ReadModel futuresTradeSignal, IBlackboardService blackboardService, DateTime createdOn, string createdBy)
    ...
    /// <summary>
    /// evaluate long iron condor trade strategy
    /// </summary>
    /// <returns></returns>
