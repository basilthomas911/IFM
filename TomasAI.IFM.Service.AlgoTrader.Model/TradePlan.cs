...
public abstract class TradePlan
{
    ...
    public FuturesTradeSignalV2ReadModel FuturesTradeSignal { get; private set; }
    public FuturesEodDataV2ReadModel FuturesEodData { get; private set; }
    ...
    public static TPlan As<TPlan>(TPlan tradePlan) => tradePlan;
