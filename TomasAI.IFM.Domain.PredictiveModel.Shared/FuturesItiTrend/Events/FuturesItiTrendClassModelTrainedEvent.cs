...
public record FuturesItiTrendClassModelTrainedEvent : IEvent
{
    ...
    [IgnoreMember] public string EventName => nameof(FuturesItiTrendClassModelTrainedEvent);
    [IgnoreMember] public EventType EventType => EventType.DomainEvent;

    public FuturesItiTrendClassModelTrainedEvent() { }
    ...
    public ICompleteEvent ToCompletedEvent() => new FuturesItiTrendClassModelTrainedCompleteEvent
    {
        CommandId = CommandId,
    ...
    public IErrorEvent ToFailedEvent(Exception ex) => new FuturesItiTrendClassModelTrainedFailEvent
    {
        CommandId = CommandId,
...
public record FuturesItiTrendClassModelTrainedCompleteEvent : CompleteEvent
{
...
public record FuturesItiTrendClassModelTrainedFailEvent : ErrorEvent
{
}
