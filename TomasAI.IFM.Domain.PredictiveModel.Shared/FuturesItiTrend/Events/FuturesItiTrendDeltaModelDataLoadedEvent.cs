...
namespace TomasAI.IFM.Domain.PredictiveModel.Shared.FuturesItiTrend.Events;

[MessagePackObject(AllowPrivate = true)]
public record FuturesItiTrendDeltaModelDataLoadedEvent : IEvent
{
    ...
    [IgnoreMember] public string EventName => nameof(FuturesItiTrendDeltaModelDataLoadedEvent);
    [IgnoreMember] public EventType EventType => EventType.DomainEvent;

    public FuturesItiTrendDeltaModelDataLoadedEvent() { }
    ...
    public ICompleteEvent ToCompletedEvent() => new FuturesItiTrendDeltaModelDataLoadedCompleteEvent
    {
        CommandId = CommandId,
        EntityId = EntityId,
        StartDate = StartDate,
    ...
    public IErrorEvent ToFailedEvent(Exception ex) => new FuturesItiTrendDeltaModelDataLoadedFailEvent
    {
        CommandId = CommandId,
...
public record FuturesItiTrendDeltaModelDataLoadedCompleteEvent : CompleteEvent
{
...
public record FuturesItiTrendDeltaModelDataLoadedFailEvent : ErrorEvent
{
}
