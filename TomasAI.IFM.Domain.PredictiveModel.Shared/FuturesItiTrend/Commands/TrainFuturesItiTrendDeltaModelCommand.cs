...
/// <summary>
/// Command to train a Futures ITI Trend delta model for a symbol over a historical date range,
...
/// Routes to <see cref="BoundedContextName.FuturesItiTrendBoundedContext"/> with error code 20016.
/// </remarks>
[MessagePackObject(AllowPrivate = true)]
public record TrainFuturesItiTrendDeltaModelCommand : ICommand<FuturesItiTrendEntityId>
{
    public const string Actor = "FuturesItiTrendCommand";
    public const string Verb = "TrainDeltaModel";
    ...
    /// <summary>The futures symbol whose delta trend model is trained.</summary>
    [Key(6)]
    ...
    /// </summary>
    public TrainFuturesItiTrendDeltaModelCommand() { }

    /// <summary>
    /// Creates a new command to train a Futures ITI Trend delta model.
    /// </summary>
    /// <param name="symbol">Target futures symbol (null becomes empty).</param>
    /// <param name="valueDate">As-of date for the model.</param>
    /// <param name="startDate">Start of the historical range.</param>
    /// <param name="endDate">End of the historical range.</param>
