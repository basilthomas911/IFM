...
public class FundQueryActorTests : IClassFixture<FundTestFixture>
{
    ...
    public class TestableFundQueryActor : FundQueryActor
    {
        ...
        public IQuery InvokeParseMessage(IQueryActorContext<FundQueryActor> context, NatsMsg<byte[]> message)
        ...
        public async ValueTask InvokeOnExceptionAsync(IQueryActorContext<FundQueryActor> context, ActorThreadId threadId, IQuery query, string verb, Exception ex)
