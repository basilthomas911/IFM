...
namespace TomasAI.IFM.Service.AlgoTrader.Model.LongIronCondor
{
    public class LongIronCondorAlgorithm : LongIronCondorTradePlan, ITradeAlgorithm
    {
        ...
        public LongIronCondorAlgorithm(DateTime valueDate, IOptionTradeCollection optionTrades, FuturesEodDataViewModel futuresEodData, FuturesTradeSignalViewModel futuresTradeSignal, IBlackboardService blackboardService, DateTime createdOn, string createdBy)
