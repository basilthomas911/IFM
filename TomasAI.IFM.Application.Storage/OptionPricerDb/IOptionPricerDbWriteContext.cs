...
public interface IOptionPricerDbWriteContext 
{
    ...
    Task UpdateSpreadDistributionJobStatusAsync(int orderId, int tradeId, DateOnly valueDate, SpreadDistributionJobStatus jobStatus, DateTime jobCompleted, DateTime? jobFailed = null);
}
