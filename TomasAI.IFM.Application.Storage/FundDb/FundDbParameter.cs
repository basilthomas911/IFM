...
{
    public object Bind() => new object?[] { fundId, transactionId };
}
...
{
    public object Bind() => new object?[] { fundId, valueDate, tradeStatus };
}
internal readonly record struct GetFundBalanceByTransactionDate(int fundId, DateTime transactionDate) : IBindValue
{
    public object Bind() => new object?[] { fundId, transactionDate };
}
