    ...
    : SchemaDbContext<TradeSchemaDb>(connectionSettings[TradeDbContext.TradeDbConnection], logger)
{
    ...
    [
        ...
        new("order_execution_fill_v2", TradeFlowSchemaCql.ExecutionFillByContract, "DROP TABLE IF EXISTS order_execution_fill_v2;"),
        ...
        new("open_position_route_v2", TradeFlowSchemaCql.OpenPositionRouteByContract, "DROP TABLE IF EXISTS open_position_route_v2;"),
        new("open_position_route_recovery_v2", TradeFlowSchemaCql.OpenPositionRouteRecoveryByContract, "DROP TABLE IF EXISTS open_position_route_recovery_v2;"),
