    ...
    : SchemaDbContext<MarketDataSchemaDb>(connectionSettings[MarketDataDbContext.MarketDataDbConnection], logger)
{
    ...
    [
        ...
        new("futures_iti_signal_by_contract_day_v2", MarketDataSchemaCql.CreateFuturesItiSignalByContractDayV2Table, "DROP TABLE IF EXISTS futures_iti_signal_by_contract_day_v2;"),
        new("futures_iti_signal_by_contract_month_v2", MarketDataSchemaCql.CreateFuturesItiSignalByContractMonthV2Table, "DROP TABLE IF EXISTS futures_iti_signal_by_contract_month_v2;"),
        new("futures_iti_signal_by_trend_mode_month_v2", MarketDataSchemaCql.CreateFuturesItiSignalByTrendModeMonthV2Table, "DROP TABLE IF EXISTS futures_iti_signal_by_trend_mode_month_v2;"),
        ...
        new("futures_iti_signal_band_level", MarketDataSchemaCql.AddFuturesItiSignalBandLevelColumn, "ALTER TABLE futures_iti_signal DROP bandLevel;", ["conflicts with an existing column", "already exists"]),
        new("futures_iti_signal_reversal_level", MarketDataSchemaCql.AddFuturesItiSignalReversalLevelColumn, "ALTER TABLE futures_iti_signal DROP reversalLevel;", ["conflicts with an existing column", "already exists"]),
        new("futures_iti_signal_by_contract_day_v2_band_level", MarketDataSchemaCql.AddFuturesItiSignalByContractDayV2BandLevelColumn, "ALTER TABLE futures_iti_signal_by_contract_day_v2 DROP bandLevel;", ["conflicts with an existing column", "already exists"]),
        new("futures_iti_signal_by_contract_day_v2_reversal_level", MarketDataSchemaCql.AddFuturesItiSignalByContractDayV2ReversalLevelColumn, "ALTER TABLE futures_iti_signal_by_contract_day_v2 DROP reversalLevel;", ["conflicts with an existing column", "already exists"]),
        new("futures_iti_signal_by_contract_month_v2_band_level", MarketDataSchemaCql.AddFuturesItiSignalByContractMonthV2BandLevelColumn, "ALTER TABLE futures_iti_signal_by_contract_month_v2 DROP bandLevel;", ["conflicts with an existing column", "already exists"]),
        new("futures_iti_signal_by_contract_month_v2_reversal_level", MarketDataSchemaCql.AddFuturesItiSignalByContractMonthV2ReversalLevelColumn, "ALTER TABLE futures_iti_signal_by_contract_month_v2 DROP reversalLevel;", ["conflicts with an existing column", "already exists"]),
        new("futures_iti_signal_by_trend_mode_month_v2_band_level", MarketDataSchemaCql.AddFuturesItiSignalByTrendModeMonthV2BandLevelColumn, "ALTER TABLE futures_iti_signal_by_trend_mode_month_v2 DROP bandLevel;", ["conflicts with an existing column", "already exists"]),
        new("futures_iti_signal_by_trend_mode_month_v2_reversal_level", MarketDataSchemaCql.AddFuturesItiSignalByTrendModeMonthV2ReversalLevelColumn, "ALTER TABLE futures_iti_signal_by_trend_mode_month_v2 DROP reversalLevel;", ["conflicts with an existing column", "already exists"]),
        new("futures_iti_timeframe_state_band_level", MarketDataSchemaCql.AddFuturesItiTimeFrameStateBandLevelColumn, "ALTER TABLE futures_iti_timeframe_state DROP bandLevel;", ["conflicts with an existing column", "already exists"]),
        new("futures_iti_timeframe_state_reversal_level", MarketDataSchemaCql.AddFuturesItiTimeFrameStateReversalLevelColumn, "ALTER TABLE futures_iti_timeframe_state DROP reversalLevel;", ["conflicts with an existing column", "already exists"]),
