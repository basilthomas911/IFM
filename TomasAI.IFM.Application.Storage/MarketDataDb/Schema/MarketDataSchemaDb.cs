    ...
    : SchemaDbContext<MarketDataSchemaDb>(connectionSettings[MarketDataDbContext.MarketDataDbConnection], logger)
{
    ...
    [
        ...
        new("yield_curve_rate_by_date_v1", MarketDataSchemaCql.CreateYieldCurveRateByDateV1Table, "DROP TABLE IF EXISTS yield_curve_rate_by_date_v1;"),
        new("yield_curve_rate_year_v1", MarketDataSchemaCql.CreateYieldCurveRateYearV1Table, "DROP TABLE IF EXISTS yield_curve_rate_year_v1;"),
