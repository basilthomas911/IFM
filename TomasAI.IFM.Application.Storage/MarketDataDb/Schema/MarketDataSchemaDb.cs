    ...
    : SchemaDbContext<MarketDataSchemaDb>(connectionSettings[MarketDataDbContext.MarketDataDbConnection], logger)
{
    ...
    [
        ...
        new("futures_macd_signal_v2_warm_state", MarketDataSchemaCql.AddFuturesMacdSignalV2WarmStateColumns, "ALTER TABLE futures_macd_signal_v2 DROP isWarm;", ["conflicts with an existing column", "already exists"]),
