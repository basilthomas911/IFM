    ...
    : SchemaDbContext<MarketDataSchemaDb>(connectionSettings[MarketDataDbContext.MarketDataDbConnection], logger)
{
    ...
    [
        ...
        new("futures_vx_term_structure_signal", MarketDataSchemaCql.CreateFuturesVxTermStructureSignalTable, "DROP TABLE IF EXISTS futures_vx_term_structure_signal;"),
        new("futures_vwap_signal", MarketDataSchemaCql.CreateFuturesVwapSignalTable, "DROP TABLE IF EXISTS futures_vwap_signal;"),
        ...
        new("market_outlook_snapshot_blob", MarketDataSchemaCql.AddMarketOutlookSnapshotBlobColumn, "ALTER TABLE market_outlook_snapshot DROP snapshot;", ["conflicts with an existing column", "already exists"]),
        new("market_outlook_working_state", MarketDataSchemaCql.CreateMarketOutlookWorkingStateTable, "DROP TABLE IF EXISTS market_outlook_working_state;"),
        ...
        new("futures_rsi_signal_provenance", MarketDataSchemaCql.AddFuturesRsiSignalProvenanceColumns, "ALTER TABLE futures_rsi_signal DROP configurationId;", ["conflicts with an existing column", "already exists"]),
        new("futures_rsi_signal_warm_state", MarketDataSchemaCql.AddFuturesRsiSignalWarmStateColumns, "ALTER TABLE futures_rsi_signal DROP previousRsi;", ["conflicts with an existing column", "already exists"]),
        ...
        new("futures_macd_signal_v2_provenance", MarketDataSchemaCql.AddFuturesMacdSignalV2ProvenanceColumns, "ALTER TABLE futures_macd_signal_v2 DROP configurationId;", ["conflicts with an existing column", "already exists"]),
        new("futures_adx_signal", MarketDataSchemaCql.CreateFuturesAdxSignalTable, "DROP TABLE IF EXISTS futures_adx_signal;"),
        new("futures_adx_signal_provenance", MarketDataSchemaCql.AddFuturesAdxSignalProvenanceColumns, "ALTER TABLE futures_adx_signal DROP configurationId;", ["conflicts with an existing column", "already exists"]),
        new("futures_atr_signal", MarketDataSchemaCql.CreateFuturesAtrSignalTable, "DROP TABLE IF EXISTS futures_atr_signal;"),
        new("futures_atr_signal_provenance", MarketDataSchemaCql.AddFuturesAtrSignalProvenanceColumns, "ALTER TABLE futures_atr_signal DROP configurationId;", ["conflicts with an existing column", "already exists"]),
        new("futures_atr_signal_wilder", MarketDataSchemaCql.AddFuturesAtrSignalWilderColumns, "ALTER TABLE futures_atr_signal DROP previousAtrValue;", ["conflicts with an existing column", "already exists"]),
