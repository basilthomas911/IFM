    ...
    : SchemaDbContext<MarketDataSchemaDb>(connectionSettings[MarketDataDbContext.MarketDataDbConnection], logger)
{
    ...
    [
        ...
        new("option_iv_snapshot_by_id", OptionVolatilitySchemaCql.CreateSnapshotById, "DROP TABLE IF EXISTS option_iv_snapshot_by_id;"),
        new("option_iv_latest", OptionVolatilitySchemaCql.CreateLatest, "DROP TABLE IF EXISTS option_iv_latest;"),
        new("option_trade_evidence", MarketDataSchemaCql.CreateOptionTradeEvidenceTable, "DROP TABLE IF EXISTS option_trade_evidence;"),
        new("composition_preparation", MarketDataSchemaCql.CreateCompositionPreparationTable, "DROP TABLE IF EXISTS composition_preparation;"),
        ...
        new("market_data_download_log", MarketDataSchemaCql.CreateMarketDataDownloadLogTable, "DROP TABLE IF EXISTS market_data_download_log;"),
        ...
        new("economic_calendar", MarketDataSchemaCql.CreateEconomicCalendarV2Table, "DROP TABLE IF EXISTS economic_calendar;"),
        ...
        new("market_data_projection_state", MarketDataSchemaCql.CreateMarketDataProjectionStateV2Table, "DROP TABLE IF EXISTS market_data_projection_state;"),
        ...
        new("market_data_projection_scope_state", MarketDataSchemaCql.CreateMarketDataProjectionScopeStateV3Table, "DROP TABLE IF EXISTS market_data_projection_scope_state;"),
        new("market_data_projection_scope_mutation", MarketDataSchemaCql.CreateMarketDataProjectionScopeMutationV3Table, "DROP TABLE IF EXISTS market_data_projection_scope_mutation;"),
        ...
        new("futures_macd_signal_provenance", MarketDataSchemaCql.AddFuturesMacdSignalProvenanceColumns, "ALTER TABLE futures_macd_signal DROP configurationId;", ["conflicts with an existing column", "already exists"]),
        new("futures_macd_signal_warm_state", MarketDataSchemaCql.AddFuturesMacdSignalWarmStateColumns, "ALTER TABLE futures_macd_signal DROP isWarm;", ["conflicts with an existing column", "already exists"]),
