...
internal static class MarketDataDbCql
{
    ...
    public const string GetOptionTradeEvidence = """
        SELECT source_digest,payload
        FROM option_trade_evidence
        WHERE contract_id=:contract AND value_date=:date AND source_id=:id;
        """;
