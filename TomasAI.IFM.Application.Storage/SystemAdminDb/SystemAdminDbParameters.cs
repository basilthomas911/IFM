...
internal readonly record struct UpsertOperationParameter(DatabaseBackupEventContract Event) : IBindValue
{
    public object Bind()
    {
        ...
        return Values(
            ...
            Text(e.BackupLineage.SerializeLineage()), Bigint(e.EventId), Uuid(e.Source.SourceEventId));
    }
}
    ...
    DatabaseBackupEventContract Event, bool Eligible, bool LegalHold, bool RestoreTested) : IBindValue
{
    public object Bind() => Values(
        ...
        Bigint(Event.ManifestRevision), Text(Event.BackupLineage.SerializeLineage()), Bigint(Event.EventId),
...
internal sealed record OperationProjectionRow(
...
internal sealed record StatisticsProjectionRow(
    BackupSource Source,
    long Revision,
