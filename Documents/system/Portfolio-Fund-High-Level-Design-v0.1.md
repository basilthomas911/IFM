...
> **Legacy Fund cutover (2026-09-21):** The legacy Fund domain, storage, APIs, UI, import/history path, and writer-fence/migration infrastructure have been removed. Canonical Portfolio/Fund and Portfolio financial schema version 2 are current. Legacy coexistence and migration passages below are retained as historical design rationale and are superseded as operational guidance.
...
Portfolio financial administration separates generated book setup, explicit development opening capital, journal reconciliation, canonical source qualification, and spending-authority review. Qualification verifies the trusted Development host, reconciled ledger, and exact committed Portfolio/Fund source versions, then leaves new spending disabled until authority is reviewed. It does not import historical balances.
