...
/// <summary>
/// Represents a command to process an end-of-day fund transaction.
/// </summary>
/// <remarks>
/// MessagePack-serializable using numeric keys:
/// - Base command members use keys 0�5.
/// - Payload member (<see cref="FundTransaction"/>) uses key 6.
/// Routes to <see cref="BoundedContextName.FundTransactionBoundedContext"/> and targets
/// <see cref="FundTransactionEntityId"/> derived from the supplied transaction.
/// </remarks>
[MessagePackObject(AllowPrivate = true)]
public record ProcessEndOfDayFundTransactionCommand : ICommand<FundTransactionEntityId>
{
    public const string Actor = "FundTransactionCommand";
    public const string Verb = "ProcessEndOfDay";
    public const int ErrorId = 2009;
    ...
    /// </summary>
    /// <param name="fundTransaction">The transaction to process.</param>
    public ProcessEndOfDayFundTransactionCommand(FundTransactionReadModel fundTransaction)
    {
