...
/// <summary>
/// MessagePack-serializable query to retrieve the Profit &amp; Loss report for a specific fund over a date range.
/// </summary>
/// <remarks>
...
public record GetFundPnlReportQuery : IQuery<FundPnlReportReadModel>
{
    [IgnoreMember] public const string Actor = "FundQuery";
    [IgnoreMember] public const string Verb = "GetFundPnlReport";
    ...
    /// <summary>
    /// Fund identifier to generate the PnL report for.
    /// </summary>
    [Key(2)]
    public int FundId { get; init; }

    /// <summary>
    /// Start date (inclusive) of the reporting range.
    /// </summary>
    [Key(3)]
    public DateOnly StartDate { get; init; }

    /// <summary>
    /// End date (inclusive) of the reporting range.
    /// </summary>
    [Key(4)]
    ...
    /// </summary>
    public GetFundPnlReportQuery() { }

    public GetFundPnlReportQuery(int fundId, DateOnly startDate, DateOnly endDate)
    {
        FundId = fundId;
        StartDate = startDate;
        EndDate = endDate;
        EntityId = new GetFundPnlReportParameter(fundId, startDate, endDate);
        ErrorCode = ErrorId;
    }
