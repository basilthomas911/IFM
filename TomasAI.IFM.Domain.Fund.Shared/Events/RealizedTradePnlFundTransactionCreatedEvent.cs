...
/// <summary>
/// Event emitted when a realized-trade PnL fund transaction is created.
...
public record RealizedTradePnlFundTransactionCreatedEvent : IEvent<FundTransactionEntityId>
{
    [IgnoreMember] public const string Actor = "FundTransaction";
    [IgnoreMember] public const string Verb = "RealizedTradePnlFundTransactionCreated";
    [IgnoreMember] public const int ErrorCode = 3011;
    ...
    public RealizedTradePnlFundTransactionCreatedEvent() { }
        ...
        where TEntityId : IActorEntityId
    {
        ...
        ICompleteEvent<FundTransactionEntityId> completed = new RealizedTradePnlFundTransactionCreatedCompleteEvent
        {
            Subject = new ActorSubject(ActorType.Event, RealizedTradePnlFundTransactionCreatedCompleteEvent.Actor, RealizedTradePnlFundTransactionCreatedCompleteEvent.Verb, this.Subject.EntityId),
        ...
        where TEntityId : IActorEntityId
    {
        ...
        IErrorEvent<FundTransactionEntityId> failed = new RealizedTradePnlFundTransactionCreatedFailEvent
        {
            Subject = new ActorSubject(ActorType.Event, RealizedTradePnlFundTransactionCreatedFailEvent.Actor, RealizedTradePnlFundTransactionCreatedFailEvent.Verb, this.Subject.EntityId),
            EntityId = this.EntityId,
            Id = this.Id,
...
/// <summary>
/// Event published when a realized-trade PnL fund transaction has been created successfully.
/// Carries metadata from the original event.
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record RealizedTradePnlFundTransactionCreatedCompleteEvent : ICompleteEvent<FundTransactionEntityId>
{
    [IgnoreMember] public const string Actor = "FundTransaction";
    [IgnoreMember] public const string Verb = "RealizedTradePnlFundTransactionCreatedComplete";
    [Key(0)] public ActorSubject Subject { get; init; }
    ...
    public RealizedTradePnlFundTransactionCreatedCompleteEvent() { }
...
/// <summary>
/// Event published when creating a realized-trade PnL fund transaction has failed.
/// Carries standardized error details from the error event contract.
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record RealizedTradePnlFundTransactionCreatedFailEvent : IErrorEvent<FundTransactionEntityId>
{
    [IgnoreMember] public const string Actor = "FundTransaction";
    [IgnoreMember] public const string Verb = "RealizedTradePnlFundTransactionCreatedFail";
    [Key(0)] public ActorSubject Subject { get; init; }
    [Key(1)] public FundTransactionEntityId EntityId { get; init; }
    [Key(2)] public Guid Id { get; init; }
    ...
    public RealizedTradePnlFundTransactionCreatedFailEvent() { }
