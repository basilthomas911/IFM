...
/// <summary>
/// Event emitted when an adjustment for an opening-trade fund transaction is created.
/// and update read models. Targets <see cref="FundTransactionEntityId"/> as the actor entity id.
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record OpeningTradeFundTransactionAdjustmentCreatedEvent : IEvent<FundTransactionEntityId>, IFundTransactionAdjustmentEvent
{
    [IgnoreMember] public const string Actor = "FundTransaction";
    [IgnoreMember] public const string Verb = "OpeningTradeAdjustmentCreated";
    [IgnoreMember] public const string CompleteName = $"{Verb}Complete";
    [IgnoreMember] public const string FailName = $"{Verb}Fail";
    [IgnoreMember] public const int ErrorCode = 3009;
    ...
    public OpeningTradeFundTransactionAdjustmentCreatedEvent() { }
        ...
        where TEntityId : IActorEntityId
    {
        ...
        ICompleteEvent<FundTransactionEntityId> completed = new OpeningTradeFundTransactionAdjustmentCreatedCompleteEvent
        {
        ...
        where TEntityId : IActorEntityId
    {
        ...
        IErrorEvent<FundTransactionEntityId> failed = new OpeningTradeFundTransactionAdjustmentCreatedFailEvent
        {
...
/// <summary>
/// Event published when an opening-trade fund transaction adjustment creation has completed successfully.
/// Carries metadata from the original event.
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record OpeningTradeFundTransactionAdjustmentCreatedCompleteEvent : ICompleteEvent<FundTransactionEntityId>
{
    [Key(0)] public ActorSubject Subject { get; init; }
    ...
    public OpeningTradeFundTransactionAdjustmentCreatedCompleteEvent() { }
...
/// <summary>
/// Event published when an opening-trade fund transaction adjustment creation has failed.
/// Carries standardized error details from the error event contract.
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record OpeningTradeFundTransactionAdjustmentCreatedFailEvent : IErrorEvent<FundTransactionEntityId>
{
    [Key(0)] public ActorSubject Subject { get; init; }
    [Key(1)] public FundTransactionEntityId EntityId { get; init; }
    [Key(2)] public Guid Id { get; init; }
    ...
    public OpeningTradeFundTransactionAdjustmentCreatedFailEvent() { }
