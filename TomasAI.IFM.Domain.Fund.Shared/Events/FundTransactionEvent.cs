...
/// <summary>
/// Event emitted when a fund transaction is created or changed.
/// and update read models. Targets <see cref="FundTransactionEntityId"/> as the actor entity id.
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record FundTransactionEvent : IEvent<FundTransactionEntityId>
{
    [IgnoreMember] public const string Actor = "FundTransactionEvent";
    [IgnoreMember] public const string Verb = "FundTransactionCreated";
        ...
        where TEntityId : IActorEntityId
    {
        ...
        ICompleteEvent<FundTransactionEntityId> completed = new FundTransactionCreatedCompleteEvent
        {
            Subject = new ActorSubject(ActorType.Event, FundTransactionCreatedCompleteEvent.Actor, FundTransactionCreatedCompleteEvent.Verb, this.Subject.EntityId),
        ...
        where TEntityId : IActorEntityId
    {
        ...
        IErrorEvent<FundTransactionEntityId> failed = new FundTransactionCreatedFailEvent
        {
            Subject = new ActorSubject(ActorType.Event, FundTransactionCreatedFailEvent.Actor, FundTransactionCreatedFailEvent.Verb, this.Subject.EntityId),
            EntityId = this.EntityId,
            Id = this.Id,
...
/// <summary>
/// Event published when a fund transaction creation has completed successfully.
/// Carries metadata from the original event.
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record FundTransactionCreatedCompleteEvent : ICompleteEvent<FundTransactionEntityId>
{
    [IgnoreMember] public const string Actor = "FundTransactionEvent";
    [IgnoreMember] public const string Verb = "FundTransactionCreatedComplete";
    ...
    public FundTransactionCreatedCompleteEvent() { }
...
/// <summary>
/// Event published when a fund transaction creation has failed.
/// Carries standardized error details from the error event contract.
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record FundTransactionCreatedFailEvent : IErrorEvent<FundTransactionEntityId>
{
    [IgnoreMember] public const string Actor = "FundTransactionEvent";
    [IgnoreMember] public const string Verb = "FundTransactionCreatedFail";
    ...
    public FundTransactionCreatedFailEvent() { }
