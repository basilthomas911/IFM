...
/// <summary>
/// Represents the parameters required to retrieve fund transactions for a specific fund over a date range.
/// </summary>
[MessagePackObject(false)]
public record GetFundTransactionsParameter : IActorEntityId, IQueryParameter
{
    ...
    public GetFundTransactionsParameter() { }

    [SerializationConstructor]
    public GetFundTransactionsParameter(int fundId, DateOnly startDate, DateOnly endDate)
    {
        FundId = fundId;
        StartDate = startDate;
        EndDate = endDate;
