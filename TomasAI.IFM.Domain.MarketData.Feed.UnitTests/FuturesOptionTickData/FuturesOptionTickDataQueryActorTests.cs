...
public class FuturesOptionTickDataQueryActorTests : IClassFixture<MarketDataFeedTestFixture>
{
    ...
    public class TestableFuturesOptionTickDataQueryActor : FuturesOptionTickDataQueryActor
    {
        ...
        public async ValueTask InvokeReceiveAsync(IQueryActorContext<FuturesOptionTickDataQueryActor> context, IQuery query)
            => await ReceiveAsync(context, query);

        public async ValueTask InvokeOnExceptionAsync(IQueryActorContext<FuturesOptionTickDataQueryActor> context, ActorThreadId threadId, IQuery query, string verb, Exception ex)
    ...
    public void ParseMessage_ShouldThrowInvalidOperationException_WhenDeserializedQueryIsNull()
    {
        ...
        var act = () => actor.InvokeParseMessage(context, message);
        act.Should().Throw<InvalidOperationException>()
            .WithMessage("Parser for FuturesOptionTickDataQuery.GetLastFuturesOptionTickData returned no query.");
    }
