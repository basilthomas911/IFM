...
public class FuturesOptionTickDataCommandActorTests : IClassFixture<MarketDataFeedTestFixture>
{
    ...
    [Fact]
    public async Task ParseMessage_DeserializesInsertFuturesOptionTickDataCommand_WithoutDomainAuditWrite()
    {
        // Arrange
    ...
    [Fact]
    public async Task ParseMessage_DeserializesStartFuturesOptionTickDataStreamingCommand_WithoutDomainAuditWrite()
    {
        // Arrange
        var dbEventSource = Substitute.For<IEventSourceActorDbContext>();
        var logger = Substitute.For<ILogger<FuturesOptionTickDataCommandActor>>();
    ...
    [Fact]
    public async Task ParseMessage_DeserializesStopFuturesOptionTickDataStreamingCommand_WithoutDomainAuditWrite()
    {
        // Arrange
        var dbEventSource = Substitute.For<IEventSourceActorDbContext>();
        var logger = Substitute.For<ILogger<FuturesOptionTickDataCommandActor>>();
