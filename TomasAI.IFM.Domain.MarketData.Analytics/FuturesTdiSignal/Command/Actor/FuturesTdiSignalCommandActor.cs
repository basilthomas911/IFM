    ...
    : BaseEventSourceCommandActor<FuturesTdiSignalCommandActor>(actorContext, actorContext.Logger)
{
    ...
    protected IFuturesTdiSignalCommandContext ActorContext { get; } =
        IsArgumentNull.Set(actorContext as IFuturesTdiSignalCommandContext, nameof(actorContext))!;
    ...
    readonly IEventProjector<FuturesTdiSignalCommandActor> _eventProjector = IsArgumentNull.Set(actorContext.EventProjector);
    ...
    protected override ICommand ParseMessage(ICommandActorContext<FuturesTdiSignalCommandActor> context, IActorMessage message)
    {
        IsArgumentNull.Check(context);
    ...
    {
        [typeof(GenerateFuturesTdiSignalCommand).Name] = cmd => {
