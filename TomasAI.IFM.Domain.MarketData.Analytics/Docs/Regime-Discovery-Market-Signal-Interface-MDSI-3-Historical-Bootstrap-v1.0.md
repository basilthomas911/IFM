# Regime Discovery Market Signal Interface MDSI-3 Historical Bootstrap

Roll-Aware One-Year Normalized Bootstrap v1.0

| Item | Value |
| --- | --- |
| Gate | `MDSI-3 - Roll-aware one-year normalized bootstrap` |
| Status | Complete |
| Date | 2026-08-25 |
...
MDSI-3 adds the durable bootstrap actor surface and the application coordinator
