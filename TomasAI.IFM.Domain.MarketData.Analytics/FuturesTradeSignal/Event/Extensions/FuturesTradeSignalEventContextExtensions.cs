...
namespace TomasAI.IFM.Domain.MarketData.Analytics.FuturesTradeSignal.Event.Extensions;

/// <summary>Exposes readonly FuturesTradeSignalEvent Event context properties.</summary>
public static class FuturesTradeSignalEventContextExtensions
{
    extension(IEventActorContext<FuturesTradeSignalEventActor> context)
    {
        /// <summary>Gets the domain-specific typed context.</summary>
        public IFuturesTradeSignalEventContext DomainContext =>
        ...
        public ILogger<FuturesTradeSignalEventActor> Logger => context.DomainContext.Logger;
    }
}
