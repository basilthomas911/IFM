...
{
    public static bool Execute(this StartFuturesMacdSignalCommand command, FuturesMacdSignalCommandState state)
        => state.Update(new FuturesMacdSignalStartedEvent
        {
    ...
    public static bool Execute(this StopFuturesMacdSignalCommand command, FuturesMacdSignalCommandState state)
        => state.Update(new FuturesMacdSignalStoppedEvent
        {
