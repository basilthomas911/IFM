...
namespace TomasAI.IFM.Domain.MarketData.Analytics.FuturesItiSignal.Query.Extensions;

/// <summary>Exposes readonly FuturesItiSignalQuery Query context properties.</summary>
public static class FuturesItiSignalQueryContextExtensions
{
    extension(IQueryActorContext<FuturesItiSignalQueryActor> context)
    {
        /// <summary>Gets the domain-specific typed context.</summary>
        public IFuturesItiSignalQueryContext DomainContext =>
        ...
        public ILogger<FuturesItiSignalQueryActor> Logger => context.DomainContext.Logger;
    }
}
