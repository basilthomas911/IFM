...
public static class FuturesTickTradeDataInsertedComplete
{
    /// <summary>Completes because the owning projection already applied the observation.</summary>
    public static ValueTask ExecuteAsync(this FuturesTickTradeDataInsertedCompleteEvent domainEvent, ITickAggregationRealtimeContext context)
