...
public static class FuturesTickQuoteDataInsertedComplete
{
    /// <summary>Completes because the owning projection already applied the observation.</summary>
    public static ValueTask ExecuteAsync(this FuturesTickQuoteDataInsertedCompleteEvent domainEvent, ITickAggregationRealtimeContext context)
