...
public static class FuturesBarDataInserted
{
    ...
    public static ValueTask<bool> ExecuteAsync(this FuturesBarDataInsertedEvent eventValue, IFuturesBarDataEventContext context, IEventActorContext commandApi, IEventActorContext eventApi, FuturesBarDataEventParameters parameters, ILogger<FuturesBarDataEventActor> logger)
    {
