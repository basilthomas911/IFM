...
$checks = @(
    ...
    @('TomasAI.IFM.UI.Net.SystemTests', 'Category=PortfolioFinancial'),
    ...
    @('TomasAI.IFM.Domain.Trade.IntegratedTests', 'Category=PortfolioFinancialFiveStage|Category=PortfolioFinancialRuntime'),
