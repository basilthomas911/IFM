...
/// </remarks>
public static class OptionPricerCommandApiExtensions
{
    ...
    public static ValueTask<ServiceResult<GuidResult>> SubmitSpreadDistributionJobAsync(
        ...
        SpreadDistributionJobReadModel spreadDistributionJob)
    {
        ...
        return RequestAsync<SubmitSpreadDistributionJobCommand, SpreadDistributionJobEntityId>(context, command);
    }
    ...
    /// <returns>A value task containing the typed command result returned by the target actor.</returns>
    public static ValueTask<ServiceResult<GuidResult>> CompleteSpreadDistributionJobAsync(
        this IEventActorContext context,
        ...
        SpreadDistributionJobStatus jobStatus)
    {
        ...
        return RequestAsync<CompleteSpreadDistributionJobCommand, SpreadDistributionJobEntityId>(context, command);
    }
    ...
    /// <returns>A value task containing the typed command result returned by the target actor.</returns>
    public static ValueTask<ServiceResult<GuidResult>> FailSpreadDistributionJobAsync(
        this IEventActorContext context,
        SpreadDistributionJobEntityId entityId,
        DateTime jobFailed,
        SpreadDistributionJobStatus jobStatus,
        string errorMessage)
    {
        ...
        return RequestAsync<FailSpreadDistributionJobCommand, SpreadDistributionJobEntityId>(context, command);
    }
