...
public sealed record CreateTradeOrderCommand : ICommand<NewTradeOrderId>
{
    ...
    public CreateTradeOrderCommand() { }
    ...
    public CreateTradeOrderCommand(Guid commandId, ActorSubject subject, bool postEvents, NewTradeOrderId entityId, TradeOrderDefinition order)
    {
        CommandId = commandId;
        Subject = subject;
