...
/// <summary>Records timeout of the Trade Selection pipeline stage.</summary>
...
public sealed record StrategyWorkflowTradeSelectionTimedOutEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "TradeSelectionTimedOut";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 22017;
    ...
    [IgnoreMember] public string EventName => nameof(StrategyWorkflowTradeSelectionTimedOutEvent);
    ...
    public StrategyWorkflowTradeSelectionTimedOutEvent() { }
