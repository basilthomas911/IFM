...
/// <summary>Records the workflow continuation decision after the Risk Management result.</summary>
...
public sealed record StrategyWorkflowRiskManagementContinuationEvaluatedEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "RiskManagementContinuationEvaluated";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 22025;
    ...
    [IgnoreMember] public string EventName => nameof(StrategyWorkflowRiskManagementContinuationEvaluatedEvent);
    ...
    public StrategyWorkflowRiskManagementContinuationEvaluatedEvent() { }
