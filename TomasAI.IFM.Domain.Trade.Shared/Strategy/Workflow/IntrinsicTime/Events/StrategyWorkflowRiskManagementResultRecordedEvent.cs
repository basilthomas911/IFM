...
/// <summary>Records the accepted opaque result from the Risk Management pipeline.</summary>
...
public sealed record StrategyWorkflowRiskManagementResultRecordedEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "RiskManagementResultRecorded";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 22024;
    ...
    [IgnoreMember] public string EventName => nameof(StrategyWorkflowRiskManagementResultRecordedEvent);
    ...
    public StrategyWorkflowRiskManagementResultRecordedEvent() { }
