...
/// <summary>Records the accepted opaque result from the Market Condition pipeline.</summary>
...
public sealed record StrategyWorkflowMarketConditionResultRecordedEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "MarketConditionResultRecorded";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 22009;
    ...
    [IgnoreMember] public string EventName => nameof(StrategyWorkflowMarketConditionResultRecordedEvent);
    ...
    public StrategyWorkflowMarketConditionResultRecordedEvent() { }
