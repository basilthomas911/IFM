...
/// <summary>Records timeout of the Risk Management pipeline stage.</summary>
...
public sealed record StrategyWorkflowRiskManagementTimedOutEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "RiskManagementTimedOut";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 22027;
    ...
    [IgnoreMember] public string EventName => nameof(StrategyWorkflowRiskManagementTimedOutEvent);
    ...
    public StrategyWorkflowRiskManagementTimedOutEvent() { }
