...
/// <summary>Records the accepted opaque result from the Trade Selection pipeline.</summary>
...
public sealed record StrategyWorkflowTradeSelectionResultRecordedEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "TradeSelectionResultRecorded";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 22014;
    ...
    [IgnoreMember] public string EventName => nameof(StrategyWorkflowTradeSelectionResultRecordedEvent);
    ...
    public StrategyWorkflowTradeSelectionResultRecordedEvent() { }
