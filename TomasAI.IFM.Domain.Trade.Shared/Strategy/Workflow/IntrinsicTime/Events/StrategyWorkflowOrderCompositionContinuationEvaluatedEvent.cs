...
/// <summary>Records the workflow continuation decision after the Order Composition result.</summary>
...
public sealed record StrategyWorkflowOrderCompositionContinuationEvaluatedEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "OrderCompositionContinuationEvaluated";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 22020;
    ...
    [IgnoreMember] public string EventName => nameof(StrategyWorkflowOrderCompositionContinuationEvaluatedEvent);
    ...
    public StrategyWorkflowOrderCompositionContinuationEvaluatedEvent() { }
