...
/// <summary>Records failure of the Market Condition pipeline and its standard failure data.</summary>
...
public sealed record StrategyWorkflowMarketConditionFailedEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "MarketConditionFailed";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 22011;
    ...
    [IgnoreMember] public string EventName => nameof(StrategyWorkflowMarketConditionFailedEvent);
    ...
    public StrategyWorkflowMarketConditionFailedEvent() { }
