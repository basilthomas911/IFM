...
/// <summary>Records timeout of the Regime Discovery pipeline stage.</summary>
...
public sealed record StrategyWorkflowRegimeDiscoveryTimedOutEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "RegimeDiscoveryTimedOut";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 22007;
    ...
    [IgnoreMember] public string EventName => nameof(StrategyWorkflowRegimeDiscoveryTimedOutEvent);
    ...
    public StrategyWorkflowRegimeDiscoveryTimedOutEvent() { }
