...
/// <summary>Records the workflow continuation decision after the Market Condition result.</summary>
...
public sealed record StrategyWorkflowMarketConditionContinuationEvaluatedEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "MarketConditionContinuationEvaluated";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 22010;
    ...
    [IgnoreMember] public string EventName => nameof(StrategyWorkflowMarketConditionContinuationEvaluatedEvent);
    ...
    public StrategyWorkflowMarketConditionContinuationEvaluatedEvent() { }
