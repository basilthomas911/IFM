...
/// <summary>Records timeout of the Market Condition pipeline stage.</summary>
...
public sealed record StrategyWorkflowMarketConditionTimedOutEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "MarketConditionTimedOut";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 22012;
    ...
    [IgnoreMember] public string EventName => nameof(StrategyWorkflowMarketConditionTimedOutEvent);
    ...
    public StrategyWorkflowMarketConditionTimedOutEvent() { }
