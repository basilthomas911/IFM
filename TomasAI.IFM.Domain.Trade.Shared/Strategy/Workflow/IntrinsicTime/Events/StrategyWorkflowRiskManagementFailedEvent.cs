...
/// <summary>Records failure of the Risk Management pipeline and its standard failure data.</summary>
...
public sealed record StrategyWorkflowRiskManagementFailedEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "RiskManagementFailed";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 22026;
    ...
    [IgnoreMember] public string EventName => nameof(StrategyWorkflowRiskManagementFailedEvent);
    ...
    public StrategyWorkflowRiskManagementFailedEvent() { }
