...
/// <summary>Records successful completion after the accepted Risk Manager approval result.</summary>
...
public sealed record IntrinsicTimeStrategyWorkflowCompletedEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const int ErrorId = 22028;
    ...
    /// <summary>Gets the causative Risk Manager result identity.</summary>
    [Key(11)] public Guid CausationId { get; init; }
    /// <summary>Gets the final workflow stage.</summary>
    [Key(12)] public StrategyWorkflowStage Stage { get; init; }
    /// <summary>Gets the UTC workflow completion timestamp.</summary>
    ...
    [IgnoreMember] public string EventName => nameof(IntrinsicTimeStrategyWorkflowCompletedEvent);
    ...
    public IntrinsicTimeStrategyWorkflowCompletedEvent() { }
    ...
    /// <param name="causationId">Causative Risk Manager result identity.</param>
    /// <param name="stage">Final workflow stage.</param>
    /// <param name="completedAtUtc">UTC workflow completion timestamp.</param>
