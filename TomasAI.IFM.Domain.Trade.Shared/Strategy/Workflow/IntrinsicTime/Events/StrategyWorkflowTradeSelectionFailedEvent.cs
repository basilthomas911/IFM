...
/// <summary>Records failure of the Trade Selection pipeline and its standard failure data.</summary>
...
public sealed record StrategyWorkflowTradeSelectionFailedEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "TradeSelectionFailed";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 22016;
    ...
    [IgnoreMember] public string EventName => nameof(StrategyWorkflowTradeSelectionFailedEvent);
    ...
    public StrategyWorkflowTradeSelectionFailedEvent() { }
