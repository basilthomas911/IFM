...
/// <summary>Records failure of the Regime Discovery pipeline and its standard failure data.</summary>
...
public sealed record StrategyWorkflowRegimeDiscoveryFailedEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "RegimeDiscoveryFailed";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 22006;
    ...
    [IgnoreMember] public string EventName => nameof(StrategyWorkflowRegimeDiscoveryFailedEvent);
    ...
    public StrategyWorkflowRegimeDiscoveryFailedEvent() { }
