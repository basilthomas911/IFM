...
/// <summary>Records the workflow continuation decision after the Regime Discovery result.</summary>
...
public sealed record StrategyWorkflowRegimeDiscoveryContinuationEvaluatedEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "RegimeDiscoveryContinuationEvaluated";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 22005;
    ...
    [IgnoreMember] public string EventName => nameof(StrategyWorkflowRegimeDiscoveryContinuationEvaluatedEvent);
    ...
    public StrategyWorkflowRegimeDiscoveryContinuationEvaluatedEvent() { }
