...
/// <summary>Records the accepted opaque result from the Regime Discovery pipeline.</summary>
...
public sealed record StrategyWorkflowRegimeDiscoveryResultRecordedEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "RegimeDiscoveryResultRecorded";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 22004;
    ...
    [IgnoreMember] public string EventName => nameof(StrategyWorkflowRegimeDiscoveryResultRecordedEvent);
    ...
    public StrategyWorkflowRegimeDiscoveryResultRecordedEvent() { }
