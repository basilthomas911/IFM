...
public sealed record RiskManagementFunctionFailedEvent : IErrorEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "RiskManagementFunctionFailed";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 24032;
    ...
    [IgnoreMember] public string EventName => nameof(RiskManagementFunctionFailedEvent);
