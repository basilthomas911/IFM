...
public sealed record TradeSelectionFunctionFailedEvent : IErrorEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "TradeSelectionFunctionFailed";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 24028;
    ...
    [IgnoreMember] public string EventName => nameof(TradeSelectionFunctionFailedEvent);
