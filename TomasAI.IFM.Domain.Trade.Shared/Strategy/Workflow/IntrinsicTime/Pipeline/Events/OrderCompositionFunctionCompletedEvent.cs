...
/// <summary>Reports that the Order Composition pipeline completed successfully.</summary>
/// <remarks>
/// The Function projects and stores completed-only state before returning this event directly. It is never published.
/// </remarks>
[MessagePackObject(AllowPrivate = true)]
public sealed record OrderCompositionFunctionCompletedEvent : ICompleteEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "OrderCompositionFunctionCompleted";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 24029;
    ...
    [IgnoreMember] public string EventName => nameof(OrderCompositionFunctionCompletedEvent);
