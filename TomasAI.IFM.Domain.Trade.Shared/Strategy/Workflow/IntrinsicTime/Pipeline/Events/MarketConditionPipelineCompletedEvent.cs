...
public sealed record MarketConditionPipelineCompletedEvent : ICompleteEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const int ErrorId = 24005;
    ...
    [IgnoreMember] public string EventName => nameof(MarketConditionPipelineCompletedEvent);
    ...
    public MarketConditionPipelineCompletedEvent() { }
