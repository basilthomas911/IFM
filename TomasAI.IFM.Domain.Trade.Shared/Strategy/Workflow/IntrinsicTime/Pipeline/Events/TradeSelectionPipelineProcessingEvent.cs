...
/// <summary>Reports that the Trade Selection pipeline accepted its Start command and began processing.</summary>
/// <remarks>
...
public sealed record TradeSelectionPipelineProcessingEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const int ErrorId = 24007;
    ...
    [IgnoreMember] public string EventName => nameof(TradeSelectionPipelineProcessingEvent);
    ...
    public TradeSelectionPipelineProcessingEvent() { }
