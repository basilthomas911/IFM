...
public sealed record OrderCompositionPipelineCompletedEvent : ICompleteEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public string EventName => nameof(OrderCompositionPipelineCompletedEvent);
    ...
    public OrderCompositionPipelineCompletedEvent() { }
