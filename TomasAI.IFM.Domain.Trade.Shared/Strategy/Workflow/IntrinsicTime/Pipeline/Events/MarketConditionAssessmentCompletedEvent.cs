...
public sealed record MarketConditionAssessmentCompletedEvent : ICompleteEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "MarketConditionAssessmentCompleted";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 24025;
    ...
    [Key(20)] public string RequestFingerprint { get; init; } = string.Empty;
    [Key(21)] public MarketCondition.Assessment.MarketConditionAssessmentSnapshot Snapshot { get; init; } = new();
    ...
    [IgnoreMember] public string EventName => nameof(MarketConditionAssessmentCompletedEvent);
    ...
    public MarketConditionAssessmentCompletedEvent() { }
    ...
    public MarketConditionAssessmentCompletedEvent(
        ...
        DateTime? validUntilUtc = default, string requestFingerprint = "", MarketCondition.Assessment.MarketConditionAssessmentSnapshot? snapshot = null)
    {
        Subject = subject;
        Id = id;
        EntityId = entityId;
