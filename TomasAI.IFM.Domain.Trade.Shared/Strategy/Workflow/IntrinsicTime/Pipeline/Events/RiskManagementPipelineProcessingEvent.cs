...
/// <summary>Reports that the Risk Management pipeline accepted its Start command and began processing.</summary>
/// <remarks>
...
public sealed record RiskManagementPipelineProcessingEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const int ErrorId = 24013;
    ...
    [IgnoreMember] public string EventName => nameof(RiskManagementPipelineProcessingEvent);
    ...
    public RiskManagementPipelineProcessingEvent() { }
