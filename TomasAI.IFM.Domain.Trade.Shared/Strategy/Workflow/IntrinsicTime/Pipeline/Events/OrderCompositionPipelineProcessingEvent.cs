...
/// <summary>Reports that the Order Composition pipeline accepted its Start command and began processing.</summary>
/// <remarks>
...
public sealed record OrderCompositionPipelineProcessingEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const int ErrorId = 24010;
    ...
    [IgnoreMember] public string EventName => nameof(OrderCompositionPipelineProcessingEvent);
    ...
    public OrderCompositionPipelineProcessingEvent() { }
