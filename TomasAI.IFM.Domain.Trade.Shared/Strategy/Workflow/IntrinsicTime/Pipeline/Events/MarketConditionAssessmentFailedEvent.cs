...
public sealed record MarketConditionAssessmentFailedEvent : IErrorEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "MarketConditionAssessmentFailed";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 24026;
    ...
    [IgnoreMember] public string EventName => nameof(MarketConditionAssessmentFailedEvent);
    ...
    public MarketConditionAssessmentFailedEvent() { }
