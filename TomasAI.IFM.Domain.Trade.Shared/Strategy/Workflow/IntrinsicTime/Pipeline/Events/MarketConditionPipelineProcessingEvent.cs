...
/// <summary>Reports that the Market Condition pipeline accepted its Start command and began processing.</summary>
/// <remarks>
...
public sealed record MarketConditionPipelineProcessingEvent : IEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const int ErrorId = 24004;
    ...
    [IgnoreMember] public string EventName => nameof(MarketConditionPipelineProcessingEvent);
    ...
    public MarketConditionPipelineProcessingEvent() { }
