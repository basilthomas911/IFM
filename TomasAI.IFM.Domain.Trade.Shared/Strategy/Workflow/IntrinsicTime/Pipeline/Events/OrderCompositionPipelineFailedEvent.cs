...
public sealed record OrderCompositionPipelineFailedEvent : IErrorEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public string EventName => nameof(OrderCompositionPipelineFailedEvent);
    ...
    public OrderCompositionPipelineFailedEvent() { }
