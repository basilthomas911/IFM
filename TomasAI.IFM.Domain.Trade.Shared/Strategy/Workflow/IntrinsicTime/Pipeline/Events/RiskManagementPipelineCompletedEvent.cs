...
public sealed record RiskManagementPipelineCompletedEvent : ICompleteEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public string EventName => nameof(RiskManagementPipelineCompletedEvent);
    ...
    public RiskManagementPipelineCompletedEvent() { }
