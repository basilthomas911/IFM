...
/// <summary>Reports terminal failure of the Risk Management pipeline calculation.</summary>
/// <remarks>
...
public sealed record RiskManagementPipelineFailedEvent : IErrorEvent<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "RiskManagementPipelineFailed";
    /// <summary>Stable event error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 24015;
    ...
    [IgnoreMember] public string EventName => nameof(RiskManagementPipelineFailedEvent);
    ...
    public RiskManagementPipelineFailedEvent() { }
