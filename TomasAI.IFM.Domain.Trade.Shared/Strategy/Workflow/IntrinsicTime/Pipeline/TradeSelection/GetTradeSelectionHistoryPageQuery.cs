...
public sealed record GetTradeSelectionHistoryPageQuery:IQuery<TradeSelectionHistoryPage>
{
    ...
    public GetTradeSelectionHistoryPageQuery() { }
    ...
    public GetTradeSelectionHistoryPageQuery(ActorSubject subject, IActorEntityId entityId, SelectionQueryAccess access, int portfolioId, int fundId, DateOnly valueDate, int pageSize, string? pagingState)
    {
        Subject = subject;
        EntityId = entityId;
        Access = access;
