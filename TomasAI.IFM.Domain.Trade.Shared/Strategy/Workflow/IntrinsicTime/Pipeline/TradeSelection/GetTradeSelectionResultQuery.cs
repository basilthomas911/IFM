...
public sealed record GetTradeSelectionResultQuery:IQuery<TradeSelectionResult>
{
    ...
    public GetTradeSelectionResultQuery() { }
    ...
    public GetTradeSelectionResultQuery(ActorSubject subject, IActorEntityId entityId, SelectionQueryAccess access, StrategyWorkflowId workflowId, Guid invocationId, Guid resultId)
    {
        Subject = subject;
        EntityId = entityId;
        Access = access;
