...
public sealed record GetRiskInvocationQuery:IQuery<RiskObservation>
{
    ...
    public GetRiskInvocationQuery(ActorSubject subject, IActorEntityId entityId, CompositionQueryAccess access, StrategyWorkflowId workflowId, Guid invocationId)
    {
        Subject = subject;
        EntityId = entityId;
        Access = access;
