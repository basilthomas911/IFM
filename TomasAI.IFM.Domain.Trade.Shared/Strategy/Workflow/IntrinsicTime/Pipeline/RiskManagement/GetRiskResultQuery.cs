...
public sealed record GetRiskResultQuery:IQuery<RiskAssessmentResult>
{
    ...
    public GetRiskResultQuery(ActorSubject subject, IActorEntityId entityId, CompositionQueryAccess access, StrategyWorkflowId workflowId, Guid invocationId, Guid resultId)
    {
        Subject = subject;
        EntityId = entityId;
        Access = access;
