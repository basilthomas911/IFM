...
/// <summary>Requests processing by the Regime Discovery strategy pipeline.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record StartRegimeDiscoveryPipelineCommand : ICommand<IntrinsicTimeStrategyWorkflowEntityId>
{
