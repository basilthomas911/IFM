...
/// <summary>Requests processing by the Market Condition strategy pipeline.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record StartMarketConditionPipelineCommand : ICommand<IntrinsicTimeStrategyWorkflowEntityId>
{
    /// <summary>Future pipeline Command actor name.</summary>
    [IgnoreMember] public const string Actor = "MarketConditionPipelineCommand";
    ...
    [IgnoreMember] public string CommandName => nameof(StartMarketConditionPipelineCommand);
    ...
    public StartMarketConditionPipelineCommand()
    {
        PostEvents = true;
        ErrorCode = ErrorId;
