...
/// <summary>Requests processing by the Order Composition strategy pipeline.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record StartOrderCompositionPipelineCommand : ICommand<IntrinsicTimeStrategyWorkflowEntityId>
{
    /// <summary>Future pipeline Command actor name.</summary>
    [IgnoreMember] public const string Actor = "OrderCompositionPipelineCommand";
    ...
    [IgnoreMember] public const int ErrorId = 23004;
    ...
    public StartOrderCompositionPipelineCommand()
    {
        PostEvents = true;
        ErrorCode = ErrorId;
        RouteTo = BoundedContextName.OrderCompositionPipelineBoundedContext;
    }
