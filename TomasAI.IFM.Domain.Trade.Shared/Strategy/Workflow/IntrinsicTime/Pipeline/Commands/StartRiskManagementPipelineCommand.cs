...
/// <summary>Requests processing by the Risk Management strategy pipeline.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record StartRiskManagementPipelineCommand : ICommand<IntrinsicTimeStrategyWorkflowEntityId>
{
    /// <summary>Future pipeline Command actor name.</summary>
    [IgnoreMember] public const string Actor = "RiskManagementPipelineCommand";
    ...
    [IgnoreMember] public const int ErrorId = 23005;
    ...
    [IgnoreMember] public string CommandName => nameof(StartRiskManagementPipelineCommand);
    ...
    public StartRiskManagementPipelineCommand()
    {
        PostEvents = true;
        ErrorCode = ErrorId;
        RouteTo = BoundedContextName.RiskManagementPipelineBoundedContext;
    }
