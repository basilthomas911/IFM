...
public sealed record GetOrderCompositionHistoryPageQuery:IQuery<OrderCompositionHistoryPage>
{
    ...
    public GetOrderCompositionHistoryPageQuery() { }
    ...
    public GetOrderCompositionHistoryPageQuery(ActorSubject subject, IActorEntityId entityId, CompositionQueryAccess access, int portfolioId, int fundId, DateOnly valueDate, int pageSize, string? pagingState)
    {
        Subject = subject;
        EntityId = entityId;
        Access = access;
