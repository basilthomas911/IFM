...
/// <summary>Records a failed Trade Selection pipeline execution.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record FailTradeSelectionCommand : ICommand<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "FailTradeSelection";
    /// <summary>Stable command error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 21009;
    ...
    [IgnoreMember] public string CommandName => nameof(FailTradeSelectionCommand);
    ...
    public FailTradeSelectionCommand()
    {
        PostEvents = true;
        ErrorCode = ErrorId;
