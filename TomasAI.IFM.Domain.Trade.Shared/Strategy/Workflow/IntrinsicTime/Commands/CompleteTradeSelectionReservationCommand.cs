...
/// <summary>Records the completed Trade Selection pipeline result.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record CompleteTradeSelectionReservationCommand : ICommand<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "CompleteTradeSelectionReservation";
    /// <summary>Stable command error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 21019;
    ...
    [Key(9)] public TomasAI.IFM.Domain.Portfolio.Shared.Contracts.FundCompositionReservationResult Reservation { get; init; } = new();
    ...
    public CompleteTradeSelectionReservationCommand()
    {
        PostEvents = true;
        ErrorCode = ErrorId;
    ...
    public CompleteTradeSelectionReservationCommand(
        ...
        Guid sourceEventId,
        TomasAI.IFM.Domain.Portfolio.Shared.Contracts.FundCompositionReservationResult reservation,
        Guid correlationId,
        Guid causationId,
        DateTime completedAtUtc, string reservationRequestSha256 = "")
    {
        CommandId = commandId;
        Subject = subject;
