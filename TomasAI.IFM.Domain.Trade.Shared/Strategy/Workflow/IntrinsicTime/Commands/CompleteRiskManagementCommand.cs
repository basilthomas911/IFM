...
/// <summary>Records the completed Risk Management pipeline result.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record CompleteRiskManagementCommand : ICommand<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "CompleteRiskManagement";
    /// <summary>Stable command error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 21006;
    ...
    public CompleteRiskManagementCommand()
    {
        PostEvents = true;
        ErrorCode = ErrorId;
