...
/// <summary>Records the completed Market Condition pipeline result.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record CompleteMarketConditionCommand : ICommand<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "CompleteMarketCondition";
    ...
    public CompleteMarketConditionCommand()
    {
        PostEvents = true;
        ErrorCode = ErrorId;
