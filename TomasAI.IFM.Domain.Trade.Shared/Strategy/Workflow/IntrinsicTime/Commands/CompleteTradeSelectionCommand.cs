...
public sealed record CompleteTradeSelectionCommand : ICommand<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "CompleteTradeSelection";
    /// <summary>Stable command error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 21004;
    ...
    [IgnoreMember] public string CommandName => nameof(CompleteTradeSelectionCommand);
    ...
    public CompleteTradeSelectionCommand()
    {
        PostEvents = true;
        ErrorCode = ErrorId;
