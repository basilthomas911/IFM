...
/// <summary>Requests idempotent redispatch of the currently active strategy pipeline without a state transition.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record RedispatchCurrentStrategyPipelineCommand : ICommand<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "RedispatchCurrentPipeline";
    /// <summary>Stable command error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 21018;
    ...
    /// <summary>Gets the workflow revision that may be redispatched.</summary>
    [Key(7)] public long ExpectedWorkflowRevision { get; init; }
    /// <summary>Gets the stage that may be redispatched.</summary>
    [Key(8)] public StrategyWorkflowStage ExpectedStage { get; init; }
    /// <summary>Gets the UTC redispatch request timestamp.</summary>
    ...
    [IgnoreMember] public string CommandName => nameof(RedispatchCurrentStrategyPipelineCommand);
    ...
    public RedispatchCurrentStrategyPipelineCommand()
    {
        PostEvents = true;
        ErrorCode = ErrorId;
    ...
    /// <param name="expectedWorkflowRevision">Workflow revision that may be redispatched.</param>
    /// <param name="expectedStage">Stage that may be redispatched.</param>
    /// <param name="requestedAtUtc">UTC redispatch request timestamp.</param>
