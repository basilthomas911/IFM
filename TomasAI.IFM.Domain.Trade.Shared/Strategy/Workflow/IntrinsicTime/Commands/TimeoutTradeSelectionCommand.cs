...
/// <summary>Times out the active Trade Selection workflow stage when its revision still matches.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record TimeoutTradeSelectionCommand : ICommand<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "TimeoutTradeSelection";
    /// <summary>Stable command error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 21014;
    ...
    [IgnoreMember] public string CommandName => nameof(TimeoutTradeSelectionCommand);
    ...
    public TimeoutTradeSelectionCommand()
    {
        PostEvents = true;
        ErrorCode = ErrorId;
