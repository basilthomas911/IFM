...
/// <summary>Records a failed Risk Management pipeline execution.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record FailRiskManagementCommand : ICommand<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "FailRiskManagement";
    /// <summary>Stable command error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 21011;
    ...
    [IgnoreMember] public string CommandName => nameof(FailRiskManagementCommand);
    ...
    public FailRiskManagementCommand()
    {
        PostEvents = true;
        ErrorCode = ErrorId;
