...
/// <summary>Times out the active Regime Discovery workflow stage when its revision still matches.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record TimeoutRegimeDiscoveryCommand : ICommand<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "TimeoutRegimeDiscovery";
    /// <summary>Stable command error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 21012;
    ...
    [IgnoreMember] public string CommandName => nameof(TimeoutRegimeDiscoveryCommand);
    ...
    public TimeoutRegimeDiscoveryCommand()
    {
        PostEvents = true;
        ErrorCode = ErrorId;
