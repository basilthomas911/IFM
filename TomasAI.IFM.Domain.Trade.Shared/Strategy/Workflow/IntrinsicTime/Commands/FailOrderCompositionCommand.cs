...
/// <summary>Records a failed Order Composition pipeline execution.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record FailOrderCompositionCommand : ICommand<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "FailOrderComposition";
    /// <summary>Stable command error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 21010;
    ...
    [IgnoreMember] public string CommandName => nameof(FailOrderCompositionCommand);
    ...
    public FailOrderCompositionCommand()
    {
        PostEvents = true;
        ErrorCode = ErrorId;
