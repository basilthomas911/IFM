...
/// <summary>Records the completed Order Composition pipeline result.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record CompleteOrderCompositionCommand : ICommand<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "CompleteOrderComposition";
    /// <summary>Stable command error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 21005;
    ...
    public CompleteOrderCompositionCommand()
    {
        PostEvents = true;
        ErrorCode = ErrorId;
