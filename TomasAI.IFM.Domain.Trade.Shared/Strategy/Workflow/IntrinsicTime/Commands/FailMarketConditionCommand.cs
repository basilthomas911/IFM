...
/// <summary>Records a failed Market Condition pipeline execution.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record FailMarketConditionCommand : ICommand<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "FailMarketCondition";
    /// <summary>Stable command error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 21008;
    ...
    public FailMarketConditionCommand()
    {
        PostEvents = true;
        ErrorCode = ErrorId;
