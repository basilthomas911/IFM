...
/// <summary>Times out the active Order Composition workflow stage when its revision still matches.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record TimeoutOrderCompositionCommand : ICommand<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "TimeoutOrderComposition";
    /// <summary>Stable command error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 21015;
    ...
    [IgnoreMember] public string CommandName => nameof(TimeoutOrderCompositionCommand);
    ...
    public TimeoutOrderCompositionCommand()
    {
        PostEvents = true;
        ErrorCode = ErrorId;
