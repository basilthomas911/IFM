...
/// <summary>Times out the active Risk Management workflow stage when its revision still matches.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record TimeoutRiskManagementCommand : ICommand<IntrinsicTimeStrategyWorkflowEntityId>
{
    ...
    [IgnoreMember] public const string Verb = "TimeoutRiskManagement";
    /// <summary>Stable command error identifier.</summary>
    [IgnoreMember] public const int ErrorId = 21016;
    ...
    [IgnoreMember] public string CommandName => nameof(TimeoutRiskManagementCommand);
    ...
    public TimeoutRiskManagementCommand()
    {
        PostEvents = true;
        ErrorCode = ErrorId;
