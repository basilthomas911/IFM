...
public sealed record GetStoppedIntrinsicTimeStrategyWorkflowsQuery : IQuery<IntrinsicTimeStrategyWorkflowHistoryReadModel[]>
{
    ...
    public GetStoppedIntrinsicTimeStrategyWorkflowsQuery() { }
    ...
    public GetStoppedIntrinsicTimeStrategyWorkflowsQuery(ActorSubject subject, IActorEntityId entityId, DateOnly startDate, DateOnly endDate, int pageSize)
    {
        Subject = subject;
        EntityId = entityId;
        StartDate = startDate;
