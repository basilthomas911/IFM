...
public sealed record GetIntrinsicTimeStrategyWorkflowStartAttemptsQuery : IQuery<IntrinsicTimeStrategyWorkflowStartAttemptReadModel[]>
{
    ...
    public GetIntrinsicTimeStrategyWorkflowStartAttemptsQuery() { }
    ...
    public GetIntrinsicTimeStrategyWorkflowStartAttemptsQuery(ActorSubject subject, IActorEntityId entityId, string workflowEntityId, DateTime beforeUtc, int pageSize)
    {
        Subject = subject;
        EntityId = entityId;
