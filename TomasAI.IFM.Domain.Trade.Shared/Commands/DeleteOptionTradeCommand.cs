...
/// <summary>
/// Command to delete an option trade identified by OrderId and TradeId.
/// </summary>
/// <remarks>
/// MessagePack serialization pattern: base command keys 0�5; custom properties start at key 6.
/// Routes to OptionTrade bounded context with error code 4004.
/// </remarks>
[MessagePackObject(AllowPrivate = true)]
public record DeleteOptionTradeCommand
    : ICommand<OptionTradeEntityId>
{
    ...
    /// </summary>
    public DeleteOptionTradeCommand() { }

    /// <summary>
    /// Creates a new command to delete the specified option trade.
    /// </summary>
    /// <param name="orderId">Order identifier.</param>
    /// <param name="tradeId">Trade identifier.</param>
    public DeleteOptionTradeCommand(int orderId, int tradeId)
    {
        OrderId = orderId;
        TradeId = tradeId;
