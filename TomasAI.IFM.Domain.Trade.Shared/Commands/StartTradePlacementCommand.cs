...
/// <summary>
/// Command to initiate the placement of a trade for a given trade placement identifier.
/// </summary>
/// <remarks>
/// MessagePack serialization pattern: base command keys 0�5; custom members start at key 6.
/// Routes to <see cref="BoundedContextName.TradePlacementBoundedContext"/> with error code 4036.
/// </remarks>
[MessagePackObject(AllowPrivate = true)]
public record StartTradePlacementCommand
    : ICommand<TradePlacementId>
{
    public const string Actor = "TradePlacementCommand";
    public const string Verb = "Start";
    public const int ErrorId = 4036;
    ...
    /// </summary>
    public StartTradePlacementCommand() { }

    /// <summary>
    /// Creates a new command to start trade placement.
    /// </summary>
    /// <param name="id">The trade placement identifier.</param>
    public StartTradePlacementCommand(TradePlacementId id)
    {
        Id = id;
