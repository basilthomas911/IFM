...
/// <summary>
/// Command to open an option trade based on the provided trade order details.
/// </summary>
/// <remarks>
...
public record OpenOptionTradeCommand
    : ICommand<OptionTradeEntityId>
{
    ...
    /// <summary>The trade order payload used to open the option trade.</summary>
    [Key(6)]
    ...
    /// </summary>
    public OpenOptionTradeCommand() { }

    /// <summary>
    /// Creates a new command to open an option trade.
    /// </summary>
    /// <param name="tradeOrder">The trade order payload (cannot be null).</param>
    public OpenOptionTradeCommand(TradeOrderReadModel tradeOrder)
    {
