...
public sealed record GetVerticalSpreadOptionTradesQuery : IQuery<EstablishedTradeDefinition[]>
{
    ...
    public GetVerticalSpreadOptionTradesQuery() { }
    ...
    public GetVerticalSpreadOptionTradesQuery(ActorSubject subject, IActorEntityId entityId, int portfolioId, int fundId, DateTime fromUtc, DateTime toUtc, int pageSize, byte[]? pagingState)
    {
        Subject = subject;
        EntityId = entityId;
