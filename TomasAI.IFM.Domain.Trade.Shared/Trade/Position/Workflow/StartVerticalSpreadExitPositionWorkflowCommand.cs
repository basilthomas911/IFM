...
public sealed record StartVerticalSpreadExitPositionWorkflowCommand : ICommand<ExitPositionWorkflowId>
{
    ...
    public StartVerticalSpreadExitPositionWorkflowCommand() { }
    ...
    public StartVerticalSpreadExitPositionWorkflowCommand(Guid commandId, ActorSubject subject, bool postEvents, ExitPositionWorkflowId entityId, VerticalSpreadTradePlanUpdatedEvent exitPlan)
    {
        CommandId = commandId;
        Subject = subject;
