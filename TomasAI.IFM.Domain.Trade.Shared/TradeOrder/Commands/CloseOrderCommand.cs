...
namespace TomasAI.IFM.Domain.Trade.Shared.TradeOrder.Commands;

/// <summary>
/// Command to close a trade order, capturing execution status and an optional error message.
/// </summary>
/// <remarks>
/// MessagePack serialization pattern: base command keys 0�5; custom properties start at key 6.
/// Routes to <see cref="BoundedContextName.TradeOrderBoundedContext"/> with error code 5001.
/// </remarks>
    ...
    : ICommand<TradeOrderEntityId>
{
    ...
    /// <summary>The trade order identifier to close.</summary>
    [Key(6)]
    public TradeOrderEntityId TradeOrderId { get; init; }

    /// <summary>Indicates whether the close operation was executed.</summary>
    [Key(7)]
    public bool Executed { get; init; }

    /// <summary>Optional error message if the close operation failed or had issues.</summary>
    [Key(8)]
    ...
    /// <summary>
    /// Creates a new command to close a trade order.
    /// </summary>
    /// <param name="tradeOrderId">The trade order identifier.</param>
    /// <param name="executed">True if the order was executed; otherwise false.</param>
    /// <param name="errorMessage">Optional error message.</param>
    public CloseOrderCommand(TradeOrderEntityId tradeOrderId, bool executed, string errorMessage)
    {
