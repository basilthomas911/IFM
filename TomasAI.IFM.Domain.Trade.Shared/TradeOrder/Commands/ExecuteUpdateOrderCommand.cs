...
/// <summary>
/// Command to execute an update of a trade order price.
/// </summary>
/// <remarks>
...
public record ExecuteUpdateOrderCommand
    : ICommand<TradeOrderEntityId>
{
    public const string Actor = "TradeOrderCommand";
    public const string Verb = "ExecuteUpdate";
    ...
    /// <summary>The new order price to apply.</summary>
    [Key(7)]
    ...
    /// </summary>
    public ExecuteUpdateOrderCommand() { }

    /// <summary>
    /// Creates a new command to update the price of a trade order.
    /// </summary>
    /// <param name="tradeOrderId">The trade order identifier.</param>
    /// <param name="orderPrice">The price to set on the order.</param>
    public ExecuteUpdateOrderCommand(TradeOrderEntityId tradeOrderId, decimal orderPrice)
    {
