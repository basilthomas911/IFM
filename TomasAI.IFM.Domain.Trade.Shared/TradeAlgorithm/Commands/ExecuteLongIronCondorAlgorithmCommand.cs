...
namespace TomasAI.IFM.Domain.Trade.Shared.TradeAlgorithm.Commands;

/// <summary>
/// Command to execute a Long Iron Condor trade algorithm for a specific option trade context and value date,
...
/// Routes to <see cref="BoundedContextName.TradeAlgorithmBoundedContext"/> with error code 7001.
/// </remarks>
[MessagePackObject(AllowPrivate = true)]
public record ExecuteLongIronCondorAlgorithmCommand
    : ICommand<TradeAlgorithmId>
{
    public const string Actor = "TradeAlgorithmCommand";
    public const string Verb = "ExecuteLongIronCondor";
    ...
    /// <summary>Trade type/classification (expected LongIronCondor for this command context).</summary>
    [Key(7)]
    ...
    /// <summary>
    /// Collection of option trades (legs/spreads) relevant to the algorithm (excluded from MessagePack).
    /// </summary>
    [IgnoreMember]
    ...
    /// </summary>
    public ExecuteLongIronCondorAlgorithmCommand() { }

    /// <summary>
    /// Creates a new command to execute the Long Iron Condor algorithm.
    /// </summary>
    /// <param name="valueDate">Trading date.</param>
    /// <param name="tradeType">Trade type (should be LongIronCondor).</param>
