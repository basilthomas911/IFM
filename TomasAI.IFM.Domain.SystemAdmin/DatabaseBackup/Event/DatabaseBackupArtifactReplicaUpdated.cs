...
/// <summary>Handles <see cref="DatabaseBackupArtifactReplicaUpdatedEvent"/>.</summary>
public static class DatabaseBackupArtifactReplicaUpdated
{
    /// <summary>Translates and records this Database Backup service event through the command actor.</summary>
    public static ValueTask ExecuteAsync(this DatabaseBackupArtifactReplicaUpdatedEvent eventValue, IEventActorContext<DatabaseBackupEventActor> context, ILogger<DatabaseBackupEventActor> logger)
