...
public static class DatabaseBackupServiceAccepted
{
    ...
    public static ValueTask ExecuteAsync(this DatabaseBackupServiceAcceptedEvent eventValue, IEventActorContext<DatabaseBackupEventActor> context, ILogger<DatabaseBackupEventActor> logger)
