...
/// <summary>Handles <see cref="RequestDatabaseRestoreCommand"/> against the database backup aggregate.</summary>
public static class RequestDatabaseRestore
{
    /// <summary>Applies the command's business guards and returns the resulting recovery operation identity.</summary>
    public static ServiceResult<GuidResult> Execute(this RequestDatabaseRestoreCommand command, DatabaseBackupCommandState state)
