...
/// <summary>Handles <see cref="PlaceBackupLegalHoldCommand"/> against the database backup aggregate.</summary>
public static class PlaceBackupLegalHold
{
    /// <summary>Applies the command's business guards and returns the resulting recovery operation identity.</summary>
    public static ServiceResult<GuidResult> Execute(this PlaceBackupLegalHoldCommand command, DatabaseBackupCommandState state)
