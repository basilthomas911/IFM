...
/// <summary>Handles <see cref="RecordDatabaseBackupServiceCapabilityCommand"/> against the database backup aggregate.</summary>
public static class RecordDatabaseBackupServiceCapability
{
    /// <summary>Applies the command's business guards and returns the resulting recovery operation identity.</summary>
    public static ServiceResult<GuidResult> Execute(this RecordDatabaseBackupServiceCapabilityCommand command, DatabaseBackupCommandState state)
