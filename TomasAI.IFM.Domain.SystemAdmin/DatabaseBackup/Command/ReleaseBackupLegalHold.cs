...
/// <summary>Handles <see cref="ReleaseBackupLegalHoldCommand"/> against the database backup aggregate.</summary>
public static class ReleaseBackupLegalHold
{
    /// <summary>Applies the command's business guards and returns the resulting recovery operation identity.</summary>
    public static ServiceResult<GuidResult> Execute(this ReleaseBackupLegalHoldCommand command, DatabaseBackupCommandState state)
