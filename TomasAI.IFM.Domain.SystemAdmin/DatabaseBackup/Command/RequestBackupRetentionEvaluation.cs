...
/// <summary>Handles <see cref="RequestBackupRetentionEvaluationCommand"/> against the database backup aggregate.</summary>
public static class RequestBackupRetentionEvaluation
{
    /// <summary>Applies the command's business guards and returns the resulting recovery operation identity.</summary>
    public static ServiceResult<GuidResult> Execute(this RequestBackupRetentionEvaluationCommand command, DatabaseBackupCommandState state)
