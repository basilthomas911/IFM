...
/// <summary>Handles <see cref="CancelDatabaseRestoreCommand"/> against the database backup aggregate.</summary>
public static class CancelDatabaseRestore
{
    /// <summary>Applies the command's business guards and returns the resulting recovery operation identity.</summary>
    public static ServiceResult<GuidResult> Execute(this CancelDatabaseRestoreCommand command, DatabaseBackupCommandState state)
