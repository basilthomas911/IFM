...
/// <summary>Handles <see cref="ApproveDatabaseRestoreCommand"/> against the database backup aggregate.</summary>
public static class ApproveDatabaseRestore
{
    /// <summary>Applies the command's business guards and returns the resulting recovery operation identity.</summary>
    public static ServiceResult<GuidResult> Execute(this ApproveDatabaseRestoreCommand command, DatabaseBackupCommandState state)
