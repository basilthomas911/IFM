...
/// <summary>Handles <see cref="RecordDatabaseOperationCancelledCommand"/> against the database backup aggregate.</summary>
public static class RecordDatabaseOperationCancelled
{
    /// <summary>Applies the command's business guards and returns the resulting recovery operation identity.</summary>
    public static ServiceResult<GuidResult> Execute(this RecordDatabaseOperationCancelledCommand command, DatabaseBackupCommandState state)
