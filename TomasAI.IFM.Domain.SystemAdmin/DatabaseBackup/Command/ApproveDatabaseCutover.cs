...
/// <summary>Handles <see cref="ApproveDatabaseCutoverCommand"/> against the database backup aggregate.</summary>
public static class ApproveDatabaseCutover
{
    /// <summary>Applies the command's business guards and returns the resulting recovery operation identity.</summary>
    public static ServiceResult<GuidResult> Execute(this ApproveDatabaseCutoverCommand command, DatabaseBackupCommandState state)
