...
/// <summary>Handles <see cref="RecordDatabaseArtifactReplicaCommand"/> against the database backup aggregate.</summary>
public static class RecordDatabaseArtifactReplica
{
    /// <summary>Applies the command's business guards and returns the resulting recovery operation identity.</summary>
    public static ServiceResult<GuidResult> Execute(this RecordDatabaseArtifactReplicaCommand command, DatabaseBackupCommandState state)
