...
/// <summary>Handles <see cref="RecordDatabaseBackupPolicyStatusCommand"/> against the database backup aggregate.</summary>
public static class RecordDatabaseBackupPolicyStatus
{
    /// <summary>Applies the command's business guards and returns the resulting recovery operation identity.</summary>
    public static ServiceResult<GuidResult> Execute(this RecordDatabaseBackupPolicyStatusCommand command, DatabaseBackupCommandState state)
