...
/// <summary>Handles <see cref="ReconcileDatabaseBackupServiceStateCommand"/> against the database backup aggregate.</summary>
public static class ReconcileDatabaseBackupServiceState
{
    /// <summary>Applies the command's business guards and returns the resulting recovery operation identity.</summary>
    public static ServiceResult<GuidResult> Execute(this ReconcileDatabaseBackupServiceStateCommand command, DatabaseBackupCommandState state)
