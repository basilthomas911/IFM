...
/// <summary>Handles <see cref="UpdateDatabaseBackupPolicyCommand"/> against the database backup aggregate.</summary>
public static class UpdateDatabaseBackupPolicy
{
    /// <summary>Applies the command's business guards and returns the resulting recovery operation identity.</summary>
    public static ServiceResult<GuidResult> Execute(this UpdateDatabaseBackupPolicyCommand command, DatabaseBackupCommandState state)
