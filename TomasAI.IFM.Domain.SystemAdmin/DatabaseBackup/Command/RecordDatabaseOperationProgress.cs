...
/// <summary>Handles <see cref="RecordDatabaseOperationProgressCommand"/> against the database backup aggregate.</summary>
public static class RecordDatabaseOperationProgress
{
    /// <summary>Applies the command's business guards and returns the resulting recovery operation identity.</summary>
    public static ServiceResult<GuidResult> Execute(this RecordDatabaseOperationProgressCommand command, DatabaseBackupCommandState state)
