...
/// <summary>Handles <see cref="RequestDatabaseRestoreDrillCommand"/> against the database backup aggregate.</summary>
public static class RequestDatabaseRestoreDrill
{
    /// <summary>Applies the command's business guards and returns the resulting recovery operation identity.</summary>
    public static ServiceResult<GuidResult> Execute(this RequestDatabaseRestoreDrillCommand command, DatabaseBackupCommandState state)
