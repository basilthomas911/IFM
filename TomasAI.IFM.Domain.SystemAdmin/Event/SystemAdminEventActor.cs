...
namespace TomasAI.IFM.Domain.Reference.Actor.EconomicCalendar.Event;

public class SystemAdminEventActor(IActorSupervisor supervisor, ILogger<SystemAdminEventActor> logger)
    : BaseEventActor<SystemAdminEventActor>(supervisor, logger, new ActorMailboxId(ActorType.Event, Actor))
{
    public const string Actor = "SystemAdminEvent";
