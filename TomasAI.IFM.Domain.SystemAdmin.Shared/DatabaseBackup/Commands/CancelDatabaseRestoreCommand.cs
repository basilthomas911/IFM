...
/// <summary>Direct-key command for CancelRestore.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record CancelDatabaseRestoreCommand : IDatabaseBackupCommand
{
    /// <summary>Creates an empty command for serialization.</summary>
    public CancelDatabaseRestoreCommand() { }
    ...
    public const string VerbValue = "CancelRestore";
    ...
    [IgnoreMember] public string CommandName => nameof(CancelDatabaseRestoreCommand);
