...
/// <summary>Direct-key command for RequestRestoreDrill.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record RequestDatabaseRestoreDrillCommand : IDatabaseBackupCommand
{
    /// <summary>Creates an empty command for serialization.</summary>
    public RequestDatabaseRestoreDrillCommand() { }
    ...
    public const string VerbValue = "RequestRestoreDrill";
    ...
    [IgnoreMember] public string CommandName => nameof(RequestDatabaseRestoreDrillCommand);
