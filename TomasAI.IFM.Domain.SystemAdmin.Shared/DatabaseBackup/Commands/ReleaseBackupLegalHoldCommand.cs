...
/// <summary>Direct-key command for ReleaseLegalHold.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record ReleaseBackupLegalHoldCommand : IDatabaseBackupCommand
{
    /// <summary>Creates an empty command for serialization.</summary>
    public ReleaseBackupLegalHoldCommand() { }
    ...
    public const string VerbValue = "ReleaseLegalHold";
    ...
    [IgnoreMember] public string CommandName => nameof(ReleaseBackupLegalHoldCommand);
