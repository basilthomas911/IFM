...
/// <summary>Direct-key command for ApproveCutover.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record ApproveDatabaseCutoverCommand : IDatabaseBackupCommand
{
    /// <summary>Creates an empty command for serialization.</summary>
    public ApproveDatabaseCutoverCommand() { }
    ...
    public const string VerbValue = "ApproveCutover";
    ...
    [IgnoreMember] public string CommandName => nameof(ApproveDatabaseCutoverCommand);
