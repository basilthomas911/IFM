...
/// <summary>Direct-key command for CancelBackup.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record CancelDatabaseBackupCommand : IDatabaseBackupCommand
{
    /// <summary>Creates an empty command for serialization.</summary>
    public CancelDatabaseBackupCommand() { }
    ...
    public const string VerbValue = "CancelBackup";
    ...
    [IgnoreMember] public string CommandName => nameof(CancelDatabaseBackupCommand);
