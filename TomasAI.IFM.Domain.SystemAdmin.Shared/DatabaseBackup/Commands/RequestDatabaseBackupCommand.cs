...
/// <summary>Direct-key command for RequestBackup.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record RequestDatabaseBackupCommand : IDatabaseBackupCommand
{
    /// <summary>Creates an empty command for serialization.</summary>
    public RequestDatabaseBackupCommand() { }
    ...
    public const string VerbValue = "RequestBackup";
    ...
    [IgnoreMember] public string CommandName => nameof(RequestDatabaseBackupCommand);
