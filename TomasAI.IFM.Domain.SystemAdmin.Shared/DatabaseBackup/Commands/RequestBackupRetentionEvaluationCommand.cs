...
/// <summary>Direct-key command for EvaluateRetention.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record RequestBackupRetentionEvaluationCommand : IDatabaseBackupCommand
{
    /// <summary>Creates an empty command for serialization.</summary>
    public RequestBackupRetentionEvaluationCommand() { }
    ...
    public const string VerbValue = "EvaluateRetention";
    ...
    [IgnoreMember] public string CommandName => nameof(RequestBackupRetentionEvaluationCommand);
