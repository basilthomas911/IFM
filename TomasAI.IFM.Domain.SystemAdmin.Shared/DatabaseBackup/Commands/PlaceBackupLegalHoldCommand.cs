...
/// <summary>Direct-key command for PlaceLegalHold.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record PlaceBackupLegalHoldCommand : IDatabaseBackupCommand
{
    /// <summary>Creates an empty command for serialization.</summary>
    public PlaceBackupLegalHoldCommand() { }
    ...
    public const string VerbValue = "PlaceLegalHold";
    ...
    [IgnoreMember] public string CommandName => nameof(PlaceBackupLegalHoldCommand);
