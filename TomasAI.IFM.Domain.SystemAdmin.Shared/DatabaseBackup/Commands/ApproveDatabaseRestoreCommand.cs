...
/// <summary>Direct-key command for ApproveRestore.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record ApproveDatabaseRestoreCommand : IDatabaseBackupCommand
{
    /// <summary>Creates an empty command for serialization.</summary>
    public ApproveDatabaseRestoreCommand() { }
    ...
    public const string VerbValue = "ApproveRestore";
    ...
    [IgnoreMember] public string CommandName => nameof(ApproveDatabaseRestoreCommand);
