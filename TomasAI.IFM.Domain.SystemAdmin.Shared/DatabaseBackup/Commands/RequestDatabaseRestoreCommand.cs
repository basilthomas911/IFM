...
/// <summary>Direct-key command for RequestRestore.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record RequestDatabaseRestoreCommand : IDatabaseBackupCommand
{
    /// <summary>Creates an empty command for serialization.</summary>
    public RequestDatabaseRestoreCommand() { }
    ...
    public const string VerbValue = "RequestRestore";
    ...
    [IgnoreMember] public string CommandName => nameof(RequestDatabaseRestoreCommand);
