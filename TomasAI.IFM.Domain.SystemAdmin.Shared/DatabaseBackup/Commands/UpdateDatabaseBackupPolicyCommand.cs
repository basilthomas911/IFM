...
/// <summary>Direct-key command for UpdatePolicy.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record UpdateDatabaseBackupPolicyCommand : IDatabaseBackupCommand
{
    /// <summary>Creates an empty command for serialization.</summary>
    public UpdateDatabaseBackupPolicyCommand() { }
    ...
    public const string VerbValue = "UpdatePolicy";
    ...
    [IgnoreMember] public string CommandName => nameof(UpdateDatabaseBackupPolicyCommand);
