...
/// <summary>Direct-key query for GetRetentionForecast.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record GetDatabaseRetentionForecastQuery : IDatabaseBackupQuery, IQuery<DatabaseRetentionReadModel>
{
    /// <summary>Creates an empty query for serialization.</summary>
    public GetDatabaseRetentionForecastQuery() { }
    ...
    [IgnoreMember] public string Verb => "GetRetentionForecast";
