...
/// <summary>Direct-key query for ListRestoreDrills.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record ListDatabaseRestoreDrillsQuery : IDatabaseBackupQuery, IQuery<DatabaseRestoreOperationReadModel[]>
{
    /// <summary>Creates an empty query for serialization.</summary>
    public ListDatabaseRestoreDrillsQuery() { }
    ...
    public ListDatabaseRestoreDrillsQuery(ActorSubject subject, DatabaseRecoveryOperationId entityId, DatabaseRequestEnvelope request, BackupSource source, DatabaseRecoveryOperationId? operationId, DatabaseBackupSetId? backupSetId, DatabaseRestorePointId? restorePointId, DatabaseBackupPolicyId? policyId, DatabaseProtectionSetId? protectionSetId, DatabaseRetentionPlanId? retentionPlanId, int pageSize, string continuationIdentity, DateTimeOffset? fromUtc, DateTimeOffset? toUtc)
    {
        Subject = subject;
        EntityId = entityId;
        Request = request;
    ...
    [IgnoreMember] public string Verb => "ListRestoreDrills";
