...
/// <summary>Direct-key query for GetBackupSet.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record GetDatabaseBackupSetQuery : IDatabaseBackupQuery, IQuery<DatabaseBackupSetReadModel>
{
    /// <summary>Creates an empty query for serialization.</summary>
    public GetDatabaseBackupSetQuery() { }
    ...
    [IgnoreMember] public string Verb => "GetBackupSet";
