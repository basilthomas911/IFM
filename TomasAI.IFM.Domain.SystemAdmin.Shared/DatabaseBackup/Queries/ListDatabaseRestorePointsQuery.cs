...
/// <summary>Direct-key query for ListRestorePoints.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record ListDatabaseRestorePointsQuery : IDatabaseBackupQuery, IQuery<DatabaseRestorePointReadModel[]>
{
    /// <summary>Creates an empty query for serialization.</summary>
    public ListDatabaseRestorePointsQuery() { }
    ...
    public ListDatabaseRestorePointsQuery(ActorSubject subject, DatabaseRecoveryOperationId entityId, DatabaseRequestEnvelope request, BackupSource source, DatabaseRecoveryOperationId? operationId, DatabaseBackupSetId? backupSetId, DatabaseRestorePointId? restorePointId, DatabaseBackupPolicyId? policyId, DatabaseProtectionSetId? protectionSetId, DatabaseRetentionPlanId? retentionPlanId, int pageSize, string continuationIdentity, DateTimeOffset? fromUtc, DateTimeOffset? toUtc)
    {
        Subject = subject;
        EntityId = entityId;
        Request = request;
    ...
    [IgnoreMember] public string Verb => "ListRestorePoints";
