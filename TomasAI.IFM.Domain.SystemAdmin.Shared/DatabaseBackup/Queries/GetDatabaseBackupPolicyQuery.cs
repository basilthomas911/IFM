...
/// <summary>Direct-key query for GetPolicy.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record GetDatabaseBackupPolicyQuery : IDatabaseBackupQuery, IQuery<DatabaseBackupPolicyReadModel>
{
    /// <summary>Creates an empty query for serialization.</summary>
    public GetDatabaseBackupPolicyQuery() { }
    ...
    public GetDatabaseBackupPolicyQuery(ActorSubject subject, DatabaseRecoveryOperationId entityId, DatabaseRequestEnvelope request, BackupSource source, DatabaseRecoveryOperationId? operationId, DatabaseBackupSetId? backupSetId, DatabaseRestorePointId? restorePointId, DatabaseBackupPolicyId? policyId, DatabaseProtectionSetId? protectionSetId, DatabaseRetentionPlanId? retentionPlanId, int pageSize, string continuationIdentity, DateTimeOffset? fromUtc, DateTimeOffset? toUtc)
    {
        Subject = subject;
        EntityId = entityId;
        Request = request;
    ...
    [IgnoreMember] public string Verb => "GetPolicy";
