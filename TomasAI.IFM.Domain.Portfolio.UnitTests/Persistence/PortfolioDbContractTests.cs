...
public sealed class PortfolioDbContractTests
{
    ...
    public void Projection_factory_creates_stable_canonical_hash_and_rejects_invalid_metadata()
    {
        ...
        var value = new PortfolioReadModel { PortfolioId=1,PortfolioCode="P1",Name="P1",PortfolioVersion=1,OperatingState=PortfolioOperatingState.Draft,EffectiveFromUtc=now,CreatedOnUtc=now,CreatedBy="unit" };
