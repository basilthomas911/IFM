...
namespace TomasAI.IFM.Framework.Storage.ScyllaDb
{
    internal class DateOnlyToLocalDateTypeSerializer :  TypeSerializer<DateOnly>
    {
        ...
        public DateOnlyToLocalDateTypeSerializer() { }

        public override DateOnly Deserialize(ushort protocolVersion, byte[] buffer,
        ...
        public override byte[] Serialize(ushort protocolVersion, DateOnly value)
        {
