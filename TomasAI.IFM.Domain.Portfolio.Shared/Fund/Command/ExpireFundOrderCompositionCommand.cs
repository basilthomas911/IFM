...
/// <summary>Represents the ExpireFundOrderCompositionCommand actor message.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record ExpireFundOrderCompositionCommand : ICommand<PortfolioFundId>, ICommandRetryIdentity
{
    ...
    public ExpireFundOrderCompositionCommand(Guid commandId, ActorSubject subject, bool postEvents, PortfolioFundId entityId, int errorCode, BoundedContextName routeTo, PortfolioFundOrderId orderId, long expectedVersion, string reason, Guid correlationId, DateTime requestedOnUtc, PortfolioAccessContext access)
    {
        CommandId = commandId;
        Subject = subject;
    ...
    public const string Verb = "ExpireFundOrderComposition";
    ...
    [IgnoreMember] public string CommandName => nameof(ExpireFundOrderCompositionCommand);
    ...
    public ExpireFundOrderCompositionCommand() { }
    ...
    public ExpireFundOrderCompositionCommand(PortfolioFundOrderId orderId, long expectedVersion, string reason)
    {
        OrderId = orderId;
        ExpectedVersion = expectedVersion;
        Reason = reason;
