...
public sealed record CloseManualFundOrderCommand : ICommand<PortfolioFundId>, ICommandRetryIdentity
{
    ...
    public CloseManualFundOrderCommand(Guid commandId, ActorSubject subject, bool postEvents, PortfolioFundId entityId, int errorCode, BoundedContextName routeTo, ManualFundOrderMutationRequest request, Guid correlationId, DateTime requestedOnUtc, PortfolioAccessContext access)
    {
        CommandId = commandId;
        Subject = subject;
