...
/// <summary>Represents the RemoveManualFundOrderTradeCommand actor message.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record RemoveManualFundOrderTradeCommand : ICommand<PortfolioFundId>, ICommandRetryIdentity
{
    ...
    public RemoveManualFundOrderTradeCommand(Guid commandId, ActorSubject subject, bool postEvents, PortfolioFundId entityId, int errorCode, BoundedContextName routeTo, ManualFundOrderTradeMutationRequest request, Guid correlationId, DateTime requestedOnUtc, PortfolioAccessContext access)
    {
        CommandId = commandId;
        Subject = subject;
    ...
    public const string Verb = "RemoveManualFundOrderTrade";
    ...
    [IgnoreMember] public string CommandName => nameof(RemoveManualFundOrderTradeCommand);
    ...
    public RemoveManualFundOrderTradeCommand() { }

    /// <summary>Initializes the command from its application values.</summary>
    /// <param name="request">The Request command value.</param>
    public RemoveManualFundOrderTradeCommand(ManualFundOrderTradeMutationRequest request)
    {
        Request = request;
    }
