...
/// <summary>Represents the RecordFundOrderComposedCommand actor message.</summary>
...
public sealed record RecordFundOrderComposedCommand : ICommand<PortfolioFundId>, ICommandRetryIdentity
{
    ...
    [Key(8)] public OrderCompositionResultReference Result { get; init; } = default!;
    ...
    [IgnoreMember] public string CommandName => nameof(RecordFundOrderComposedCommand);
    ...
    public RecordFundOrderComposedCommand() { }
    ...
    public RecordFundOrderComposedCommand(PortfolioFundOrderId orderId, long expectedVersion, OrderCompositionResultReference result)
    {
        OrderId = orderId;
        ExpectedVersion = expectedVersion;
        Result = result;
