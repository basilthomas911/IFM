...
/// <summary>Represents the ChangeManualFundOrderTradeStateCommand actor message.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record ChangeManualFundOrderTradeStateCommand : ICommand<PortfolioFundId>, ICommandRetryIdentity
{
    ...
    public ChangeManualFundOrderTradeStateCommand(Guid commandId, ActorSubject subject, bool postEvents, PortfolioFundId entityId, int errorCode, BoundedContextName routeTo, ManualFundOrderTradeMutationRequest request, Guid correlationId, DateTime requestedOnUtc, PortfolioAccessContext access)
    {
        CommandId = commandId;
        Subject = subject;
    ...
    public const string Verb = "ChangeManualFundOrderTradeState";
    ...
    [Key(6)] public ManualFundOrderTradeMutationRequest Request { get; init; } = default!;
    ...
    [IgnoreMember] public string CommandName => nameof(ChangeManualFundOrderTradeStateCommand);
    ...
    public ChangeManualFundOrderTradeStateCommand() { }

    /// <summary>Initializes the command from its application values.</summary>
    /// <param name="request">The Request command value.</param>
    public ChangeManualFundOrderTradeStateCommand(ManualFundOrderTradeMutationRequest request)
    {
        Request = request;
    }
