...
/// <summary>Represents the DeleteManualFundOrderCommand actor message.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record DeleteManualFundOrderCommand : ICommand<PortfolioFundId>, ICommandRetryIdentity
{
    ...
    public DeleteManualFundOrderCommand(Guid commandId, ActorSubject subject, bool postEvents, PortfolioFundId entityId, int errorCode, BoundedContextName routeTo, ManualFundOrderMutationRequest request, Guid correlationId, DateTime requestedOnUtc, PortfolioAccessContext access)
    {
        CommandId = commandId;
        Subject = subject;
    ...
    public const string Verb = "DeleteManualFundOrder";
    ...
    [IgnoreMember] public string CommandName => nameof(DeleteManualFundOrderCommand);
