...
/// <summary>Represents the GetFundAllocationQuery actor message.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record GetFundAllocationQuery : IQuery<FundAllocationReadModel>
{
    public const string Actor = PortfolioQueryRoutes.Fund;
    public const string Verb = "GetFundAllocation";
    ...
    public GetFundAllocationQuery(int portfolioId, int fundId)
    {
    ...
    public GetFundAllocationQuery(ActorSubject subject, ActorEntityId entityId, int portfolioId, int fundId, Guid correlationId, DateTime requestedOnUtc, PortfolioAccessContext access)
    {
        Subject = subject;
        EntityId = entityId;
        PortfolioId = portfolioId;
