...
/// <summary>Represents the GetFundRevisionQuery actor message.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record GetFundRevisionQuery : IQuery<PortfolioAggregateRevision>
{
    public const string Actor = PortfolioQueryRoutes.Fund;
    public const string Verb = "GetFundRevision";
    ...
    public GetFundRevisionQuery(int portfolioId, int fundId)
    {
    ...
    public GetFundRevisionQuery(ActorSubject subject, ActorEntityId entityId, int portfolioId, int fundId, Guid correlationId, DateTime requestedOnUtc, PortfolioAccessContext access)
    {
        Subject = subject;
        EntityId = entityId;
        PortfolioId = portfolioId;
