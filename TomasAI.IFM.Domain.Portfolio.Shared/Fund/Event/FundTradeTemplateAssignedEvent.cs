...
/// <summary>Represents the FundTradeTemplateAssignedEvent actor event.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record FundTradeTemplateAssignedEvent : IPortfolioFundDomainEvent
{
    public const string Actor = "PortfolioEvent";
    public const string Verb = nameof(FundTradeTemplateAssignedEvent);
    ...
    [Key(14)] public FundTradeTemplateAssignmentReadModel Assignment { get; init; } = default!;

    [IgnoreMember] public string UserName => Principal;
    [IgnoreMember] public string EventName => nameof(FundTradeTemplateAssignedEvent);
    [IgnoreMember] public EventType EventType => EventType.DomainEvent;

    /// <summary>Initializes an empty event for serialization.</summary>
    public FundTradeTemplateAssignedEvent() { }
    ...
    public FundTradeTemplateAssignedEvent(Guid id, Guid commandId, long revision, DateTime occurredOnUtc, string principal, FundTradeTemplateAssignmentReadModel assignment)
    {
        Id = id;
        CommandId = commandId;
        Revision = revision;
