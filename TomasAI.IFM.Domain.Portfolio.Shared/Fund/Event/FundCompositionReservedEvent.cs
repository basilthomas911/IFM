...
/// <summary>Represents the FundCompositionReservedEvent actor event.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record FundCompositionReservedEvent : IPortfolioFundDomainEvent
{
    public const string Actor = "PortfolioEvent";
    public const string Verb = nameof(FundCompositionReservedEvent);
    ...
    [IgnoreMember] public string EventName => nameof(FundCompositionReservedEvent);
    [IgnoreMember] public EventType EventType => EventType.DomainEvent;

    /// <summary>Initializes an empty event for serialization.</summary>
    public FundCompositionReservedEvent() { }
    ...
    public FundCompositionReservedEvent(Guid id, Guid commandId, long revision, DateTime occurredOnUtc, string principal, FundCompositionReservationResult reservation)
    {
        Id = id;
        CommandId = commandId;
        Revision = revision;
