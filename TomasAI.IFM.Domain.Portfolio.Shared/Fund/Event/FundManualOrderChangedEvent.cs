...
/// <summary>Represents the FundManualOrderChangedEvent actor event.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record FundManualOrderChangedEvent : IPortfolioFundDomainEvent
{
    public const string Actor = "PortfolioEvent";
    public const string Verb = nameof(FundManualOrderChangedEvent);
    ...
    [Key(14)] public FundCompositionReservationResult Reservation { get; init; } = default!;
    [Key(15)] public int RemovedTradeId { get; init; } = default!;

    [IgnoreMember] public string UserName => Principal;
    [IgnoreMember] public string EventName => nameof(FundManualOrderChangedEvent);
    [IgnoreMember] public EventType EventType => EventType.DomainEvent;

    /// <summary>Initializes an empty event for serialization.</summary>
    public FundManualOrderChangedEvent() { }
    ...
    public FundManualOrderChangedEvent(Guid id, Guid commandId, long revision, DateTime occurredOnUtc, string principal, FundCompositionReservationResult reservation, int removedTradeId = default)
    {
        Id = id;
        CommandId = commandId;
        Revision = revision;
