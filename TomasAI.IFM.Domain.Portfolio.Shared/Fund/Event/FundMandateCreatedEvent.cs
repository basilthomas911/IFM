...
/// <summary>Represents the FundMandateCreatedEvent actor event.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record FundMandateCreatedEvent : IPortfolioFundDomainEvent
{
    public const string Actor = "PortfolioEvent";
    public const string Verb = nameof(FundMandateCreatedEvent);
    ...
    [IgnoreMember] public string EventName => nameof(FundMandateCreatedEvent);
    [IgnoreMember] public EventType EventType => EventType.DomainEvent;

    /// <summary>Initializes an empty event for serialization.</summary>
    public FundMandateCreatedEvent() { }
    ...
    public FundMandateCreatedEvent(Guid id, Guid commandId, long revision, DateTime occurredOnUtc, string principal, FundMandateReadModel mandate, Guid idempotencyKey = default)
    {
        Id = id;
        CommandId = commandId;
        Revision = revision;
