...
public sealed record GetFinancialLedgerConfigurationQuery : IFinancialQueryMessage<GetFinancialLedgerConfigurationRequest, FinancialLedgerConfiguration>
{
    ...
    public GetFinancialLedgerConfigurationQuery(ActorSubject subject, LedgerPortfolioId entityId, FinancialReadScope scope, Guid correlationId, DateTime requestedAtUtc)
    {
        Subject = subject;
        EntityId = entityId;
        Scope = scope;
