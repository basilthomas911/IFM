...
[MessagePackObject]
public sealed record LedgerConfigurationCompletedEvent : ICompleteEvent<LedgerPortfolioId>, IFinancialCompletedEvent, IRequireDurableProjection
{
    ...
    [IgnoreMember] public string EventName => nameof(LedgerConfigurationCompletedEvent);
    [IgnoreMember] public EventType EventType => EventType.CompletedEvent;
    [IgnoreMember] public DurableProjectionRequirement RequiredProjection => new("LedgerConfigurationCommandActor", "LedgerConfigurationProjector", EventProjectorStageType.ApplyProjection);
}
