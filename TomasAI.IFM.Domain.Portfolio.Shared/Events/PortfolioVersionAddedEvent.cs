...
/// <summary>Represents the PortfolioVersionAddedEvent actor event.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record PortfolioVersionAddedEvent : IPortfolioDomainEvent
{
    public const string Actor = "PortfolioEvent";
    public const string Verb = nameof(PortfolioVersionAddedEvent);
    ...
    [IgnoreMember] public string EventName => nameof(PortfolioVersionAddedEvent);
    [IgnoreMember] public EventType EventType => EventType.DomainEvent;

    /// <summary>Initializes an empty event for serialization.</summary>
    public PortfolioVersionAddedEvent() { }
    ...
    public PortfolioVersionAddedEvent(Guid id, Guid commandId, long revision, DateTime occurredOnUtc, string principal, PortfolioReadModel portfolio)
    {
        Id = id;
        CommandId = commandId;
        Revision = revision;
