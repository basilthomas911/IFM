...
/// <summary>Represents the DraftPortfolioDeletedEvent actor event.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record DraftPortfolioDeletedEvent : IPortfolioDomainEvent
{
    public const string Actor = "PortfolioEvent";
    public const string Verb = nameof(DraftPortfolioDeletedEvent);
    ...
    [IgnoreMember] public string EventName => nameof(DraftPortfolioDeletedEvent);
    [IgnoreMember] public EventType EventType => EventType.DomainEvent;

    /// <summary>Initializes an empty event for serialization.</summary>
    public DraftPortfolioDeletedEvent() { }
    ...
    public DraftPortfolioDeletedEvent(Guid id, Guid commandId, long revision, DateTime occurredOnUtc, string principal, string reason)
    {
        Id = id;
        CommandId = commandId;
        Revision = revision;
