...
/// <summary>Represents the FundAddedToPortfolioEvent actor event.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record FundAddedToPortfolioEvent : IPortfolioDomainEvent
{
    public const string Actor = "PortfolioEvent";
    public const string Verb = nameof(FundAddedToPortfolioEvent);
    ...
    [Key(14)] public PortfolioFundId FundId { get; init; } = default!;

    [IgnoreMember] public string UserName => Principal;
    [IgnoreMember] public string EventName => nameof(FundAddedToPortfolioEvent);
    [IgnoreMember] public EventType EventType => EventType.DomainEvent;

    /// <summary>Initializes an empty event for serialization.</summary>
    public FundAddedToPortfolioEvent() { }
    ...
    /// <param name="fundId">The fundId value.</param>
    public FundAddedToPortfolioEvent(Guid id, Guid commandId, long revision, DateTime occurredOnUtc, string principal, PortfolioFundId fundId)
    {
        Id = id;
        CommandId = commandId;
        Revision = revision;
