...
/// <summary>Represents the PortfolioRetiredEvent actor event.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record PortfolioRetiredEvent : IPortfolioDomainEvent
{
    public const string Actor = "PortfolioEvent";
    public const string Verb = nameof(PortfolioRetiredEvent);
    ...
    [IgnoreMember] public string EventName => nameof(PortfolioRetiredEvent);
    [IgnoreMember] public EventType EventType => EventType.DomainEvent;

    /// <summary>Initializes an empty event for serialization.</summary>
    public PortfolioRetiredEvent() { }
    ...
    public PortfolioRetiredEvent(Guid id, Guid commandId, long revision, DateTime occurredOnUtc, string principal, string reason)
    {
        Id = id;
        CommandId = commandId;
        Revision = revision;
