...
/// <summary>Represents the FundAllocationDelegatedEvent actor event.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record FundAllocationDelegatedEvent : IPortfolioDomainEvent
{
    public const string Actor = "PortfolioEvent";
    public const string Verb = nameof(FundAllocationDelegatedEvent);
    ...
    [Key(14)] public FundAllocationReadModel Allocation { get; init; } = default!;

    [IgnoreMember] public string UserName => Principal;
    [IgnoreMember] public string EventName => nameof(FundAllocationDelegatedEvent);
    [IgnoreMember] public EventType EventType => EventType.DomainEvent;

    /// <summary>Initializes an empty event for serialization.</summary>
    public FundAllocationDelegatedEvent() { }
    ...
    public FundAllocationDelegatedEvent(Guid id, Guid commandId, long revision, DateTime occurredOnUtc, string principal, FundAllocationReadModel allocation)
    {
        Id = id;
        CommandId = commandId;
        Revision = revision;
