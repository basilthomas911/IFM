...
/// <summary>Represents the FundRiskEnvelopeDelegatedEvent actor event.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record FundRiskEnvelopeDelegatedEvent : IPortfolioDomainEvent
{
    public const string Actor = "PortfolioEvent";
    public const string Verb = nameof(FundRiskEnvelopeDelegatedEvent);
    ...
    [Key(14)] public FundRiskEnvelopeReadModel Envelope { get; init; } = default!;

    [IgnoreMember] public string UserName => Principal;
    [IgnoreMember] public string EventName => nameof(FundRiskEnvelopeDelegatedEvent);
    [IgnoreMember] public EventType EventType => EventType.DomainEvent;

    /// <summary>Initializes an empty event for serialization.</summary>
    public FundRiskEnvelopeDelegatedEvent() { }
    ...
    public FundRiskEnvelopeDelegatedEvent(Guid id, Guid commandId, long revision, DateTime occurredOnUtc, string principal, FundRiskEnvelopeReadModel envelope)
    {
        Id = id;
        CommandId = commandId;
        Revision = revision;
