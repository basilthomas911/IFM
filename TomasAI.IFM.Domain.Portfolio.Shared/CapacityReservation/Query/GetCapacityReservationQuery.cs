...
public sealed record GetCapacityReservationQuery : IFinancialQueryMessage<GetCapacityReservationRequest, FinancialReservationView>
{
    ...
    /// <param name="reservationId">The ReservationId field.</param>
    ...
    public GetCapacityReservationQuery(ActorSubject subject, LedgerPortfolioId entityId, Guid reservationId, FinancialReadScope scope, Guid correlationId, DateTime requestedAtUtc)
    {
        Subject = subject;
        EntityId = entityId;
