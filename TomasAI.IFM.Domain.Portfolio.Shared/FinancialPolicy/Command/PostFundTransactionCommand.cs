...
public sealed record PostFundTransactionCommand : ICommand<LedgerPortfolioId>, IFinancialRequest<LedgerPostingRequest>
{
    ...
    public PostFundTransactionCommand() { }
