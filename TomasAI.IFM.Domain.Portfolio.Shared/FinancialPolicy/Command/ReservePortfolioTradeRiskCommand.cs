...
public sealed record ReservePortfolioTradeRiskCommand : ICommand<FinancialExecutionId>, IFinancialRequest<CapacityReservationRequest>
{
    ...
    public ReservePortfolioTradeRiskCommand() { }
    ...
    public ReservePortfolioTradeRiskCommand(int schemaVersion, Guid commandId, ActorSubject subject, bool postEvents, FinancialExecutionId entityId, int errorCode, BoundedContextName routeTo, Guid operationId, int portfolioId, Guid correlationId, Guid causationId, DateTime requestedAtUtc, DateTime expiresAtUtc, long expectedFinancialRevision, CapacityReservationRequest body, string inputSha256, FinancialAccess access)
    {
