...
public sealed record ConsumeCapacityReservationCommand : ICommand<FinancialExecutionId>, IFinancialRequest<CapacityLifecycleRequest>
{
    ...
    public ConsumeCapacityReservationCommand() { }
    ...
    public ConsumeCapacityReservationCommand(int schemaVersion, Guid commandId, ActorSubject subject, bool postEvents, FinancialExecutionId entityId, int errorCode, BoundedContextName routeTo, Guid operationId, int portfolioId, Guid correlationId, Guid causationId, DateTime requestedAtUtc, DateTime expiresAtUtc, long expectedFinancialRevision, CapacityLifecycleRequest body, string inputSha256, FinancialAccess access)
    {
