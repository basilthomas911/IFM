...
/// <summary>Represents the PortfolioFinancialPolicyActivatedEvent actor event.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record PortfolioFinancialPolicyActivatedEvent : IPortfolioFinancialPolicyDomainEvent
{
    public const string Actor = "PortfolioEvent";
    public const string Verb = nameof(PortfolioFinancialPolicyActivatedEvent);
    ...
    [IgnoreMember] public string EventName => nameof(PortfolioFinancialPolicyActivatedEvent);
    [IgnoreMember] public EventType EventType => EventType.DomainEvent;

    /// <summary>Initializes an empty event for serialization.</summary>
    public PortfolioFinancialPolicyActivatedEvent() { }
    ...
    public PortfolioFinancialPolicyActivatedEvent(Guid id, Guid commandId, long revision, DateTime occurredOnUtc, string principal, long policyVersion)
    {
        Id = id;
        CommandId = commandId;
        Revision = revision;
