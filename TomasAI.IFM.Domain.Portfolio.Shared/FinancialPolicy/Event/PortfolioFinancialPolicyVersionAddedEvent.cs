...
/// <summary>Represents the PortfolioFinancialPolicyVersionAddedEvent actor event.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record PortfolioFinancialPolicyVersionAddedEvent : IPortfolioFinancialPolicyDomainEvent
{
    public const string Actor = "PortfolioEvent";
    public const string Verb = nameof(PortfolioFinancialPolicyVersionAddedEvent);
    ...
    [IgnoreMember] public string EventName => nameof(PortfolioFinancialPolicyVersionAddedEvent);
    [IgnoreMember] public EventType EventType => EventType.DomainEvent;

    /// <summary>Initializes an empty event for serialization.</summary>
    public PortfolioFinancialPolicyVersionAddedEvent() { }
    ...
    public PortfolioFinancialPolicyVersionAddedEvent(Guid id, Guid commandId, long revision, DateTime occurredOnUtc, string principal, PortfolioFinancialPolicyReadModel policy)
    {
        Id = id;
        CommandId = commandId;
        Revision = revision;
