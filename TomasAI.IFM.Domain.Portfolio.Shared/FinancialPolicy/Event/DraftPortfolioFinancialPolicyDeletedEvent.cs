...
/// <summary>Represents the DraftPortfolioFinancialPolicyDeletedEvent actor event.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record DraftPortfolioFinancialPolicyDeletedEvent : IPortfolioFinancialPolicyDomainEvent
{
    public const string Actor = "PortfolioEvent";
    public const string Verb = nameof(DraftPortfolioFinancialPolicyDeletedEvent);
    ...
    [Key(14)] public string Reason { get; init; } = default!;

    [IgnoreMember] public string UserName => Principal;
    [IgnoreMember] public string EventName => nameof(DraftPortfolioFinancialPolicyDeletedEvent);
    [IgnoreMember] public EventType EventType => EventType.DomainEvent;

    /// <summary>Initializes an empty event for serialization.</summary>
    public DraftPortfolioFinancialPolicyDeletedEvent() { }
    ...
    public DraftPortfolioFinancialPolicyDeletedEvent(Guid id, Guid commandId, long revision, DateTime occurredOnUtc, string principal, string reason)
    {
        Id = id;
        CommandId = commandId;
        Revision = revision;
