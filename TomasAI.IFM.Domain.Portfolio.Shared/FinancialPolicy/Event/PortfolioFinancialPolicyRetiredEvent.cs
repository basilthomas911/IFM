...
/// <summary>Represents the PortfolioFinancialPolicyRetiredEvent actor event.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record PortfolioFinancialPolicyRetiredEvent : IPortfolioFinancialPolicyDomainEvent
{
    public const string Actor = "PortfolioEvent";
    public const string Verb = nameof(PortfolioFinancialPolicyRetiredEvent);
    ...
    [Key(14)] public long PolicyVersion { get; init; } = default!;
    [Key(15)] public string Reason { get; init; } = default!;

    [IgnoreMember] public string UserName => Principal;
    [IgnoreMember] public string EventName => nameof(PortfolioFinancialPolicyRetiredEvent);
    [IgnoreMember] public EventType EventType => EventType.DomainEvent;

    /// <summary>Initializes an empty event for serialization.</summary>
    public PortfolioFinancialPolicyRetiredEvent() { }
    ...
    public PortfolioFinancialPolicyRetiredEvent(Guid id, Guid commandId, long revision, DateTime occurredOnUtc, string principal, long policyVersion, string reason)
    {
        Id = id;
        CommandId = commandId;
        Revision = revision;
