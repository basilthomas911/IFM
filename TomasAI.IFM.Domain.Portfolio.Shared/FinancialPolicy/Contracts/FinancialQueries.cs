...
public interface IFinancialQueryMessage<out TRequest, TResult> : IQuery<FinancialRead<TResult>> where TResult : class
{
    int SchemaVersion { get; }
    LedgerPortfolioId QueryEntityId { get; }
    FinancialReadScope Scope { get; }
