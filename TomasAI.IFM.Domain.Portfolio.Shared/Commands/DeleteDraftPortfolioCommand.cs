...
/// <summary>Represents the DeleteDraftPortfolioCommand actor message.</summary>
[MessagePackObject(AllowPrivate = true)]
public sealed record DeleteDraftPortfolioCommand : ICommand<PortfolioId>, ICommandRetryIdentity
{
    ...
    public DeleteDraftPortfolioCommand(Guid commandId, ActorSubject subject, bool postEvents, PortfolioId entityId, int errorCode, BoundedContextName routeTo, long expectedVersion, string reason, Guid correlationId, DateTime requestedOnUtc, PortfolioAccessContext access)
    {
        CommandId = commandId;
        Subject = subject;
    ...
    public const string Verb = "DeleteDraftPortfolio";
    ...
    [IgnoreMember] public string CommandName => nameof(DeleteDraftPortfolioCommand);
    ...
    public DeleteDraftPortfolioCommand() { }
    ...
    public DeleteDraftPortfolioCommand(long expectedVersion, string reason)
    {
        ExpectedVersion = expectedVersion;
        Reason = reason;
    }
