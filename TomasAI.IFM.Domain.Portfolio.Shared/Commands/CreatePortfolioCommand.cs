...
public sealed record CreatePortfolioCommand : ICommand<PortfolioId>, ICommandRetryIdentity
{
    ...
    public CreatePortfolioCommand(Guid commandId, ActorSubject subject, bool postEvents, PortfolioId entityId, int errorCode, BoundedContextName routeTo, PortfolioReadModel portfolio, Guid idempotencyKey, Guid correlationId, DateTime requestedOnUtc, PortfolioAccessContext access)
    {
        CommandId = commandId;
        Subject = subject;
