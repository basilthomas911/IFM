...
public sealed record RetirePortfolioCommand : ICommand<PortfolioId>, ICommandRetryIdentity
{
    ...
    public RetirePortfolioCommand(Guid commandId, ActorSubject subject, bool postEvents, PortfolioId entityId, int errorCode, BoundedContextName routeTo, long expectedVersion, string reason, Guid correlationId, DateTime requestedOnUtc, PortfolioAccessContext access)
    {
        CommandId = commandId;
        Subject = subject;
