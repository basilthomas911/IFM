...
public sealed record AddPortfolioVersionCommand : ICommand<PortfolioId>, ICommandRetryIdentity
{
    ...
    /// <param name="portfolio">The Portfolio field.</param>
    ...
    public AddPortfolioVersionCommand(Guid commandId, ActorSubject subject, bool postEvents, PortfolioId entityId, int errorCode, BoundedContextName routeTo, PortfolioReadModel portfolio, long expectedVersion, Guid correlationId, DateTime requestedOnUtc, PortfolioAccessContext access)
    {
        CommandId = commandId;
        Subject = subject;
