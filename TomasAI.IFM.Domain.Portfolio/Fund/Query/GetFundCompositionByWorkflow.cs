...
public static class GetFundCompositionByWorkflow
{
    ...
    public static ValueTask ExecuteAsync<TActor>(this GetFundCompositionByWorkflowQuery query, IQueryActorContext<TActor> context, PortfolioQueryParameters parameters, CancellationToken cancellationToken)
        where TActor : IActor
