...
public static class GetFundOrderByOrderId
{
    ...
    public static ValueTask ExecuteAsync<TActor>(this GetFundOrderByOrderIdQuery query, IQueryActorContext<TActor> context, PortfolioQueryParameters parameters, CancellationToken cancellationToken)
        where TActor : IActor
