...
public static class GetTrialBalance
{
    ...
    public static ValueTask ExecuteAsync<TActor>(this FinancialQuery<GetTrialBalanceRequest, FinancialTrialBalance> query, IFinancialQueryStore dependency, IQueryActorContext<TActor> context, CancellationToken cancellationToken) where TActor : IActor
