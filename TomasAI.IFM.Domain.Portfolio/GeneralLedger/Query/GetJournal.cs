...
public static class GetJournal
{
    ...
    public static ValueTask ExecuteAsync<TActor>(this FinancialQuery<GetJournalRequest, FinancialJournal> query, IFinancialQueryStore dependency, IQueryActorContext<TActor> context, CancellationToken cancellationToken) where TActor : IActor
