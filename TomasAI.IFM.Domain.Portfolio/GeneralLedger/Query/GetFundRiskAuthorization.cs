...
public static class GetFundRiskAuthorization
{
    ...
    public static ValueTask ExecuteAsync<TActor>(this GetFundRiskAuthorizationQuery query, IFinancialQueryStore dependency, IQueryActorContext<TActor> context, CancellationToken cancellationToken) where TActor : IActor
