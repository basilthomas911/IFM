...
public static class GetFinancialLedgerConfiguration
{
    ...
    public static ValueTask ExecuteAsync<TActor>(this FinancialQuery<GetFinancialLedgerConfigurationRequest, FinancialLedgerConfiguration> query, IFinancialQueryStore dependency, IQueryActorContext<TActor> context, CancellationToken cancellationToken) where TActor : IActor
