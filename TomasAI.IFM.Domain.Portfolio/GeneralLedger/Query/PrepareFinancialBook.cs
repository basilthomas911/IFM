...
public static class PrepareFinancialBook
{
    ...
    public static ValueTask ExecuteAsync<TActor>(this FinancialQuery<PrepareFinancialBookRequest, FinancialBookSetup> query, FinancialBookPreparation preparation, IQueryActorContext<TActor> context, CancellationToken cancellationToken) where TActor : IActor
