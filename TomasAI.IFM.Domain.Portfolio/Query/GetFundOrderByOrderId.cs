...
public static class GetFundOrderByOrderId
{
    ...
    public static ValueTask ExecuteAsync(
        this GetFundOrderByOrderIdQuery query,
        IQueryActorContext<PortfolioQueryActor> context,
        PortfolioQueryParameters parameters,
        CancellationToken cancellationToken) =>
        TomasAI.IFM.Domain.Portfolio.Fund.Query.GetFundOrderByOrderId.ExecuteAsync(query, context, parameters, cancellationToken);
}
