...
public static class GetPortfolioFundStrategyReferenceCombinations
{
    ...
    public static ValueTask ExecuteAsync(
        this GetPortfolioFundStrategyReferenceCombinationsQuery query,
        IQueryActorContext<PortfolioQueryActor> context,
        PortfolioQueryParameters parameters,
        CancellationToken cancellationToken) =>
        TomasAI.IFM.Domain.Portfolio.Fund.Query.GetPortfolioFundStrategyReferenceCombinations.ExecuteAsync(query, context, parameters, cancellationToken);
}
