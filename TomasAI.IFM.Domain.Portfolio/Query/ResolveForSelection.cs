...
public static class ResolveForSelection
{
    ...
    public static ValueTask ExecuteAsync(
        this ResolveForSelectionQuery query,
        IQueryActorContext<PortfolioQueryActor> context,
        PortfolioQueryParameters parameters,
        CancellationToken cancellationToken) =>
        TomasAI.IFM.Domain.Portfolio.Fund.Query.ResolveForSelection.ExecuteAsync(query, context, parameters, cancellationToken);
}
