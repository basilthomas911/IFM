...
public static class GetFundCompositionByWorkflow
{
    ...
    public static ValueTask ExecuteAsync(
        this GetFundCompositionByWorkflowQuery query,
        IQueryActorContext<PortfolioQueryActor> context,
        PortfolioQueryParameters parameters,
        CancellationToken cancellationToken) =>
        TomasAI.IFM.Domain.Portfolio.Fund.Query.GetFundCompositionByWorkflow.ExecuteAsync(query, context, parameters, cancellationToken);
}
