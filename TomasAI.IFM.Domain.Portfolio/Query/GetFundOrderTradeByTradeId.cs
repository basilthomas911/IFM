...
public static class GetFundOrderTradeByTradeId
{
    ...
    public static ValueTask ExecuteAsync(
        this GetFundOrderTradeByTradeIdQuery query,
        IQueryActorContext<PortfolioQueryActor> context,
        PortfolioQueryParameters parameters,
        CancellationToken cancellationToken) =>
        TomasAI.IFM.Domain.Portfolio.Fund.Query.GetFundOrderTradeByTradeId.ExecuteAsync(query, context, parameters, cancellationToken);
}
