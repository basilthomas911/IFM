...
public static class GetFundRiskEnvelope
{
    ...
    public static ValueTask ExecuteAsync(
        this GetFundRiskEnvelopeQuery query,
        IQueryActorContext<PortfolioQueryActor> context,
        PortfolioQueryParameters parameters,
        CancellationToken cancellationToken) =>
        TomasAI.IFM.Domain.Portfolio.Fund.Query.GetFundRiskEnvelope.ExecuteAsync(query, context, parameters, cancellationToken);
}
