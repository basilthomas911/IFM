...
| 8 | `GetFuturesPriceAsync` | Validated | None | Futures quote/trade records and aggregation worker exist | Shared hot store update in aggregation path; read fresh last trade; typed unavailable exception | Phase A runtime gate passed |
