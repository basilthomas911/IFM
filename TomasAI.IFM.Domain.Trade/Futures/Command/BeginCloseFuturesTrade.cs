...
public static class BeginCloseFuturesTrade
{
    /// <summary>Validates the current futures-trade status and begins its close transition.</summary>
    /// <param name="command">The command requesting that the futures trade begin closing.</param>
    ...
    /// <summary>Creates the private event that changes the futures trade to closing status.</summary>
