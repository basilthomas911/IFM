        ...
        Typed(context).Logger)
{
    ...
    static readonly IReadOnlyDictionary<Type,
        Func<ICommand, FuturesOptionTradeCommandState, ServiceResult<GuidResult>>> ReceiveMap =
        new Dictionary<Type,
