...
namespace TomasAI.IFM.Domain.Trade.Futures.Option.Query.Model;

internal static class FuturesOptionTradeQueryModel
{
    /// <summary>
        ...
        CancellationToken cancellationToken = default)
    {
        var query = dbFactory.TradeDb
            .Use($"{nameof(FuturesOptionTradeQueryCql)}.{nameof(FuturesOptionTradeQueryCql.GetTradeHistory)}", FuturesOptionTradeQueryCql.GetTradeHistory)
    ...
    {
        var query = dbFactory.TradeDb
            .Use($"{nameof(FuturesOptionTradeQueryCql)}.{nameof(FuturesOptionTradeQueryCql.GetTradeLimit)}", FuturesOptionTradeQueryCql.GetTradeLimit)
    ...
    {
        var query = dbFactory.TradeDb
            .Use($"{nameof(FuturesOptionTradeQueryCql)}.{nameof(FuturesOptionTradeQueryCql.GetTradeTypeLimit)}", FuturesOptionTradeQueryCql.GetTradeTypeLimit)
    ...
    {
        var query = dbFactory.TradeDb
            .Use($"{nameof(FuturesOptionTradeQueryCql)}.{nameof(FuturesOptionTradeQueryCql.GetTradePosition)}", FuturesOptionTradeQueryCql.GetTradePosition)
    ...
    {
        var query = dbFactory.TradeDb
            .Use($"{nameof(FuturesOptionTradeQueryCql)}.{nameof(FuturesOptionTradeQueryCql.GetOptionLegs)}", FuturesOptionTradeQueryCql.GetOptionLegs)
