...
{
    /// <summary>Creates a broker-neutral closing composition by reversing every remaining position leg.</summary>
    /// <param name="started">The committed exit-workflow start.</param>
    /// <param name="composedAtUtc">The UTC composition time.</param>
    /// <returns>The validated closing composition.</returns>
