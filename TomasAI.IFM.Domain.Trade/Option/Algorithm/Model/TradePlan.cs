...
public abstract class TradePlan
{
        ...
        double stopLossLimit)
    {
        ...
        _daysToExpiry = MaturityDate.DayNumber - ValueDate.DayNumber;
        _tradingDays = MaturityDate.DayNumber - TradeDate.DayNumber;
        _tradeDiaryEvents = [];
    ...
    public FuturesTradeSignalV2ReadModel FuturesTradeSignal { get; private set; } = default!;
    public FuturesEodDataV2ReadModel FuturesEodData { get; private set; } = default!;
    ...
    public TradePlanReadModel ToViewModel(DateTime createdOn, string createdBy)
        => new(
            sequenceId: 0,
            orderId: OrderId,
            tradeId: TradeId,
    ...
    public TSource As<TSource>() where TSource : TradePlan
        => this as TSource ?? throw new InvalidCastException($"Unable to cast {GetType().Name} to {typeof(TSource).Name}.");
    ...
    protected TradePlan SetFuturesTradeSignal(FuturesTradeSignalV2ReadModel futuresTradeSignal)
    {
        FuturesTradeSignal = futuresTradeSignal;
        return this;
    }

    protected TradePlan SetFuturesEodData(FuturesEodDataV2ReadModel futuresEodData)
    {
