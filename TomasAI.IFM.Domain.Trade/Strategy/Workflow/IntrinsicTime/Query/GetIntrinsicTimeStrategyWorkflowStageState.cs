...
/// <summary>Handles <see cref="GetIntrinsicTimeStrategyWorkflowStageStateQuery"/>.</summary>
public static class GetIntrinsicTimeStrategyWorkflowStageState
{
    /// <summary>Executes the mapped workflow projection query and replies with its typed result.</summary>
    public static ValueTask ExecuteAsync(this GetIntrinsicTimeStrategyWorkflowStageStateQuery query, IIntrinsicTimeStrategyWorkflowQueryContext services, IQueryActorContext<IntrinsicTimeStrategyWorkflowQueryActor> context, CancellationToken cancellationToken)
