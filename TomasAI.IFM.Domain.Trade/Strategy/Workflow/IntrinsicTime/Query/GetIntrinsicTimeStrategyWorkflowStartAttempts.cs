...
/// <summary>Handles <see cref="GetIntrinsicTimeStrategyWorkflowStartAttemptsQuery"/>.</summary>
public static class GetIntrinsicTimeStrategyWorkflowStartAttempts
{
    /// <summary>Executes the mapped workflow projection query and replies with its typed result.</summary>
    public static ValueTask ExecuteAsync(this GetIntrinsicTimeStrategyWorkflowStartAttemptsQuery query, IIntrinsicTimeStrategyWorkflowQueryContext services, IQueryActorContext<IntrinsicTimeStrategyWorkflowQueryActor> context, CancellationToken cancellationToken)
