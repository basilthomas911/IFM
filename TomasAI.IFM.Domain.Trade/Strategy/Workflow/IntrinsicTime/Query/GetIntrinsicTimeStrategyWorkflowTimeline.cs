...
/// <summary>Handles <see cref="GetIntrinsicTimeStrategyWorkflowTimelineQuery"/>.</summary>
public static class GetIntrinsicTimeStrategyWorkflowTimeline
{
    /// <summary>Executes the mapped workflow projection query and replies with its typed result.</summary>
    public static ValueTask ExecuteAsync(this GetIntrinsicTimeStrategyWorkflowTimelineQuery query, IIntrinsicTimeStrategyWorkflowQueryContext services, IQueryActorContext<IntrinsicTimeStrategyWorkflowQueryActor> context, CancellationToken cancellationToken)
