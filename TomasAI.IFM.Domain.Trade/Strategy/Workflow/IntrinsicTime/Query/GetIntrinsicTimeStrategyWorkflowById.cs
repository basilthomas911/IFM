...
/// <summary>Handles <see cref="GetIntrinsicTimeStrategyWorkflowByIdQuery"/>.</summary>
public static class GetIntrinsicTimeStrategyWorkflowById
{
    /// <summary>Executes the mapped workflow projection query and replies with its typed result.</summary>
    public static ValueTask ExecuteAsync(this GetIntrinsicTimeStrategyWorkflowByIdQuery query, IIntrinsicTimeStrategyWorkflowQueryContext services, IQueryActorContext<IntrinsicTimeStrategyWorkflowQueryActor> context, CancellationToken cancellationToken)
