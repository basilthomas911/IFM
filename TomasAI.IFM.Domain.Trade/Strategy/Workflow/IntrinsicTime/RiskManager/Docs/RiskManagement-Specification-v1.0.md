...
At evaluation time, candidate age is at most 1,000 ms. Candidate and snapshot must remain valid. Quotes require nonnegative bid, ask at least bid, positive bid/ask sizes, event time no later than received time, received time no later than evaluation, and event age at most 1,000 ms. Option and underlying quote event times may differ by at most 250 ms.
