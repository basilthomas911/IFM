...
> **Strategy catalog direction (2026-09-06):** The target catalog separates trading logic from structure and variant. TradeSelection will supply exact strategy/deployment/structure/variant versions; Composer builds one unit using the required supported builder. Desired coverage includes Long/Short futures, all four credit/debit verticals and Long/Short iron condors with independent Balanced/Bullish/Bearish bias. Existing three-profile algorithms below are a limited baseline, not complete support for these variants. Leg count and expiry constraints are per structure; Jade Lizards and double calendars require explicit builder/data/risk capabilities. TradeSelection catalog alignment is complete as of 2026-09-07; TS-01 is ready to begin and its coding gates remain unimplemented. No algorithms are changed by this document update. See [ConfigurationDb strategy catalog design](../../../../../../TomasAI.IFM.Application.Storage/Docs/ConfigurationDb-Strategy-Catalog-Design-v1.0.md).

> **Selector handoff alignment (2026-09-07):** The [TradeSelection specification v1.1](../../TradeSelection/Docs/TradeSelection-Specification-v1.0.md) now governs the incoming exact deployment/strategy/structure/variant/parameter references, independent Side/Bias/PremiumMode, immutable evidence and Portfolio reservation boundary. Every supported structure may be deployed at Daily, Weekly or Monthly; older horizon-to-template mappings below are retained builder baseline examples only. Composition must preserve the selected intent and validate actual premiums/delta/legs through qualified capabilities. Its existing algorithms are not upgraded or qualified for all twelve variants by this documentation alignment.
...
| Related specifications | [Trade Selection result specification](../../TradeSelection/Docs/TradeSelection-Specification-v1.0.md#12-typed-result-and-complete-decision-context), [Composer selection](../../../../../../Documents/system/Order-Composition-Strategy-Selection-Specification-v1.0.md), [pricing](../../../../../../Documents/system/Market-Data-Resiliency-Stage-4-Pricing-Specification-v1.0.md), [Stage 4 plan](../../../../../../Documents/system/Market-Data-Resiliency-Stage-4-Implementation-Plan-v1.0.md) |
