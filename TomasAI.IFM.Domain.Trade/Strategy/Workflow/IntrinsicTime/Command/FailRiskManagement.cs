...
/// <summary>Handles failed Risk Management completion.</summary>
public static class FailRiskManagement
{
    /// <summary>Records the Risk Management failure or timeout and closes the workflow.</summary>
    public static ServiceResult<GuidResult> Execute(this FailRiskManagementCommand command,
    ...
    static void AppendSnapshot(IntrinsicTimeStrategyWorkflowCommandState state,
        FailRiskManagementCommand command, WorkflowStrategyMachineStatus previousStatus,
    ...
    static void LogStale(ICommandActorContext<IntrinsicTimeStrategyWorkflowCommandActor> context,
        FailRiskManagementCommand command, IntrinsicTimeStrategyWorkflowView? current)
    ...
    static void LogDeadline(ICommandActorContext<IntrinsicTimeStrategyWorkflowCommandActor> context,
        FailRiskManagementCommand command, IntrinsicTimeStrategyWorkflowView view)
    ...
    static ServiceResult<GuidResult> Ok(FailRiskManagementCommand command)
