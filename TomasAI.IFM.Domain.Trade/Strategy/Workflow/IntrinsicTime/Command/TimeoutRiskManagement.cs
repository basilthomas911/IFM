...
/// <summary>Handles a Risk Management timeout.</summary>
public static class TimeoutRiskManagement
{
    /// <summary>Marks Risk Management and the workflow as timed out.</summary>
    public static ServiceResult<GuidResult> Execute(this TimeoutRiskManagementCommand command,
    ...
    static void AppendSnapshot(IntrinsicTimeStrategyWorkflowCommandState state,
        TimeoutRiskManagementCommand command, WorkflowStrategyMachineStatus previousStatus,
