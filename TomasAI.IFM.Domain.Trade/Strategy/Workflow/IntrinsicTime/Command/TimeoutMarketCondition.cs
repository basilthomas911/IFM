...
/// <summary>Handles a Market Condition timeout.</summary>
public static class TimeoutMarketCondition
{
    /// <summary>Marks Market Condition and the workflow as timed out.</summary>
    public static ServiceResult<GuidResult> Execute(this TimeoutMarketConditionCommand command,
    ...
    static void AppendSnapshot(IntrinsicTimeStrategyWorkflowCommandState state,
        TimeoutMarketConditionCommand command, WorkflowStrategyMachineStatus previousStatus,
    ...
    static void LogStale(ICommandActorContext<IntrinsicTimeStrategyWorkflowCommandActor> context,
        TimeoutMarketConditionCommand command, IntrinsicTimeStrategyWorkflowView? current)
    ...
    static ServiceResult<GuidResult> Ok(TimeoutMarketConditionCommand command)
