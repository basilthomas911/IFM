...
/// <summary>Handles failed Regime Discovery completion.</summary>
public static class FailRegimeDiscovery
{
    /// <summary>Records the Regime failure or timeout and closes the workflow.</summary>
    public static ServiceResult<GuidResult> Execute(this FailRegimeDiscoveryCommand command,
    ...
    static void AppendSnapshot(IntrinsicTimeStrategyWorkflowCommandState state,
        FailRegimeDiscoveryCommand command, WorkflowStrategyMachineStatus previousStatus,
    ...
    static void LogStale(ICommandActorContext<IntrinsicTimeStrategyWorkflowCommandActor> context,
        FailRegimeDiscoveryCommand command, IntrinsicTimeStrategyWorkflowView? current)
    ...
    static void LogDeadline(ICommandActorContext<IntrinsicTimeStrategyWorkflowCommandActor> context,
        FailRegimeDiscoveryCommand command, IntrinsicTimeStrategyWorkflowView view)
    ...
    static ServiceResult<GuidResult> Ok(FailRegimeDiscoveryCommand command)
