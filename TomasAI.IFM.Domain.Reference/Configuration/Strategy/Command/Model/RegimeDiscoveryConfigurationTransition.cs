...
internal static class RegimeDiscoveryConfigurationTransition
{
    /// <summary>Creates one immutable Draft version.</summary>
    internal static Task<ServiceResult<GuidResult>> ExecuteAsync(
        CreateRegimeDiscoveryParameterSetCommand command,
    ...
    internal static Task<ServiceResult<GuidResult>> ExecuteAsync(
        PublishRegimeDiscoveryParameterSetCommand command,
        ICommandActorContext context,
        RegimeDiscoveryConfigurationCommandState state)
    {
    ...
    internal static Task<ServiceResult<GuidResult>> ExecuteAsync(
        RetireRegimeDiscoveryParameterSetCommand command,
        ICommandActorContext context,
        RegimeDiscoveryConfigurationCommandState state)
    {
