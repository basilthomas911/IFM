...
using TomasAI.IFM.Domain.MarketData.Feed.Shared.CommandParameters;
...
{
    public static IEndpointRouteBuilder MapApiCommands(this IEndpointRouteBuilder endpoints)
    {
    ...
    public static IEndpointRouteBuilder MapFundCommands(this IEndpointRouteBuilder endpoints)
    {
        ...
        endpoints.MapPost(FundUriPath.AddOrderToFund, async (IActorService e, AddOrderToFundParameter cmdParam)
           => {
               ...
               var response = await e.RequestAsync<AddOrderToFundCommand, FundId>(cmd);
               return response;
           });
    ...
    public static IEndpointRouteBuilder MapReferenceCommands(this IEndpointRouteBuilder endpoints)
    {
        ...
        endpoints.MapPost(MarketDataUriPath.ImportEconomicCalendars, async (IActorService e, ImportEconomicCalendarsParameter cmdParam)
            => {
                ...
                ImportEconomicCalendarsCommand cmd = new(cmdParam.ImportedDate, cmdParam.CountryCodes)
                {
                    CommandId = Guid.NewGuid(),
...
public static class MarketDataCommands
{
    public static IEndpointRouteBuilder MapMarketDataCommands(this IEndpointRouteBuilder endpoints)
    {
        ...
        endpoints.MapPost(MarketDataUriPath.AddFuturesOptionContract, async (IActorService e, AddFuturesOptionContractParameter cp)
            => {
                var entityId =  cp.Contract.EntityId;
        ...
        endpoints.MapPost(MarketDataUriPath.AddFuturesOptionContracts, async (IActorService e, AddFuturesOptionContractsParameter cmdParam)
            => {
                var entityId = new FuturesOptionContractsEntityId(cmdParam.Year);
                AddFuturesOptionContractsCommand cmd = new(cmdParam.Contracts)
                {
                    CommandId = Guid.NewGuid(),
        ...
        endpoints.MapPost(MarketDataUriPath.ChangeFuturesOptionContract, async (IActorService e, ChangeFuturesOptionContractParameter cmdParam)
            => {
                var entityId = cmdParam.Contract.EntityId;
                ChangeFuturesOptionContractCommand cmd = new(cmdParam.ContractId, cmdParam.Contract, cmdParam.Overwrite)
                {
                    CommandId = Guid.NewGuid(),
        ...
        endpoints.MapPost(MarketDataUriPath.RemoveFuturesOptionContract, async (IActorService e, RemoveFuturesOptionContractParameter cmdParam)
            => {
                var futuresOptionContractId = new FuturesOptionContractId(cmdParam.ContractId);
                var entityId = new FuturesOptionContractEntityId(cmdParam.ContractId, futuresOptionContractId.MaturityDate.Year);
                RemoveFuturesOptionContractCommand cmd = new(cmdParam.ContractId, cmdParam.Overwrite)
                {
                    CommandId = Guid.NewGuid(),
        ...
        endpoints.MapPost(MarketDataUriPath.ImportYieldCurveRates, async (IActorService e, ImportYieldCurveRatesParameter cmdParam)
            => {
                ...
                ImportYieldCurveRatesCommand cmd = new(cmdParam.ImportDate)
                {
                    CommandId = Guid.NewGuid(),
