...
public static class MarketDataQueries
{
    public static IEndpointRouteBuilder MapMarketDataQueries(this IEndpointRouteBuilder endpoints)
    {
        ...
        endpoints.MapGet(MarketDataQueryUriPath.GetOnTheRunFuturesContract, async (IActorService e, string symbol) =>
        {
            ...
            GetOnTheRunFuturesContractQuery query = new GetOnTheRunFuturesContractQuery(symbol)
            {
...
public static class MarketDataFeedQueries
{
    public static IEndpointRouteBuilder MapMarketDataFeedQueries(this IEndpointRouteBuilder endpoints)
    {
        ...
        endpoints.MapPost(MarketDataFeedQueryUriPath.GetFuturesOptionContract, async (IActorService e, [FromQuery] string contractId, [FromBody] global::TomasAI.IFM.Domain.MarketData.Feed.Shared.QueryParameters.GetFuturesOptionContractParameter queryParam) =>
        {
    ...
    public static IEndpointRouteBuilder MapMarketDataAnalyticsQueries(this IEndpointRouteBuilder endpoints)
    {
            ...
            int? slowEmaPeriod) =>
        {
            ...
            var entityId = new FuturesMacdSignalEntityId(
                contractId!, valueDate, timePeriod, signalPeriod, fastPeriod, slowPeriod);
            GetFuturesMacdSignalQuery query = new(
                contractId, valueDate, timePeriod, signalPeriod, fastPeriod, slowPeriod)
            {
