...
namespace IBApi
{
    ...
    public class Execution
    {
        ...
        {
            // Equals uses case-insensitive comparison (String.Compare(..., true)).
            // To be consistent, normalize to upper invariant (or lower) before computing hash.
            return ExecId != null ? StringComparer.OrdinalIgnoreCase.GetHashCode(ExecId) : 0;
        }
    }
}
