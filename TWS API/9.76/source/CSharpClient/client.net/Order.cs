	 ...
	 * Mark order as exempt from short sale uptick rule 
       ...
       */
        ...
        */
        ...
        {
            // Try to mirror the fields used in Equals. If PermId is set, it's used as an equivalence in Equals.
            unchecked
            {
                if (PermId != 0)
                    return PermId.GetHashCode();

                int hash = 17;
                hash = hash * 31 + OrderId.GetHashCode();
                hash = hash * 31 + ClientId.GetHashCode();
                hash = hash * 31 + TotalQuantity.GetHashCode();
                hash = hash * 31 + LmtPrice.GetHashCode();
                hash = hash * 31 + AuxPrice.GetHashCode();
                hash = hash * 31 + OcaType.GetHashCode();
                hash = hash * 31 + Transmit.GetHashCode();
                hash = hash * 31 + ParentId.GetHashCode();
                hash = hash * 31 + BlockOrder.GetHashCode();
                hash = hash * 31 + SweepToFill.GetHashCode();
                hash = hash * 31 + DisplaySize.GetHashCode();
                hash = hash * 31 + TriggerMethod.GetHashCode();
                hash = hash * 31 + OutsideRth.GetHashCode();
                hash = hash * 31 + Hidden.GetHashCode();
                hash = hash * 31 + OverridePercentageConstraints.GetHashCode();
                hash = hash * 31 + AllOrNone.GetHashCode();
                hash = hash * 31 + MinQty.GetHashCode();
                hash = hash * 31 + PercentOffset.GetHashCode();
                hash = hash * 31 + TrailStopPrice.GetHashCode();
                hash = hash * 31 + TrailingPercent.GetHashCode();
                hash = hash * 31 + Origin.GetHashCode();
                hash = hash * 31 + ShortSaleSlot.GetHashCode();
                hash = hash * 31 + DiscretionaryAmt.GetHashCode();
                hash = hash * 31 + ETradeOnly.GetHashCode();
                hash = hash * 31 + FirmQuoteOnly.GetHashCode();
                hash = hash * 31 + NbboPriceCap.GetHashCode();
                hash = hash * 31 + OptOutSmartRouting.GetHashCode();
                hash = hash * 31 + AuctionStrategy.GetHashCode();
                hash = hash * 31 + StartingPrice.GetHashCode();
                hash = hash * 31 + StockRefPrice.GetHashCode();
                hash = hash * 31 + Delta.GetHashCode();
                hash = hash * 31 + StockRangeLower.GetHashCode();
                hash = hash * 31 + StockRangeUpper.GetHashCode();
                hash = hash * 31 + Volatility.GetHashCode();
                hash = hash * 31 + VolatilityType.GetHashCode();
                hash = hash * 31 + ContinuousUpdate.GetHashCode();
                hash = hash * 31 + ReferencePriceType.GetHashCode();
                hash = hash * 31 + DeltaNeutralAuxPrice.GetHashCode();
                hash = hash * 31 + DeltaNeutralConId.GetHashCode();
                hash = hash * 31 + DeltaNeutralShortSale.GetHashCode();
                hash = hash * 31 + DeltaNeutralShortSaleSlot.GetHashCode();
                hash = hash * 31 + BasisPoints.GetHashCode();
                hash = hash * 31 + BasisPointsType.GetHashCode();
                hash = hash * 31 + ScaleInitLevelSize.GetHashCode();
                hash = hash * 31 + ScaleSubsLevelSize.GetHashCode();
                hash = hash * 31 + ScalePriceIncrement.GetHashCode();
                hash = hash * 31 + ScalePriceAdjustValue.GetHashCode();
                hash = hash * 31 + ScalePriceAdjustInterval.GetHashCode();
                hash = hash * 31 + ScaleProfitOffset.GetHashCode();
                hash = hash * 31 + ScaleAutoReset.GetHashCode();
                hash = hash * 31 + ScaleInitPosition.GetHashCode();
                hash = hash * 31 + ScaleInitFillQty.GetHashCode();
                hash = hash * 31 + ScaleRandomPercent.GetHashCode();
                hash = hash * 31 + WhatIf.GetHashCode();
                hash = hash * 31 + NotHeld.GetHashCode();
                hash = hash * 31 + ExemptCode.GetHashCode();
                hash = hash * 31 + RandomizePrice.GetHashCode();
                hash = hash * 31 + RandomizeSize.GetHashCode();
                hash = hash * 31 + Solicited.GetHashCode();
                hash = hash * 31 + ConditionsIgnoreRth.GetHashCode();
                hash = hash * 31 + ConditionsCancelOrder.GetHashCode();
                hash = hash * 31 + CashQty.GetHashCode();
                hash = hash * 31 + DontUseAutoPriceForHedge.GetHashCode();
                hash = hash * 31 + IsOmsContainer.GetHashCode();
                hash = hash * 31 + (UsePriceMgmtAlgo.HasValue ? UsePriceMgmtAlgo.Value.GetHashCode() : 0);
                hash = hash * 31 + FilledQuantity.GetHashCode();
                hash = hash * 31 + RefFuturesConId.GetHashCode();
                hash = hash * 31 + AutoCancelParent.GetHashCode();
                hash = hash * 31 + ImbalanceOnly.GetHashCode();
                hash = hash * 31 + RouteMarketableToBbo.GetHashCode();
                hash = hash * 31 + ParentPermId.GetHashCode();

                // strings compared using Util.StringCompare (case-sensitive), so use Ordinal comparer
                hash = hash * 31 + (Action != null ? StringComparer.Ordinal.GetHashCode(Action) : 0);
                hash = hash * 31 + (OrderType != null ? StringComparer.Ordinal.GetHashCode(OrderType) : 0);
                hash = hash * 31 + (Tif != null ? StringComparer.Ordinal.GetHashCode(Tif) : 0);
                hash = hash * 31 + (ActiveStartTime != null ? StringComparer.Ordinal.GetHashCode(ActiveStartTime) : 0);
                hash = hash * 31 + (ActiveStopTime != null ? StringComparer.Ordinal.GetHashCode(ActiveStopTime) : 0);
                hash = hash * 31 + (OcaGroup != null ? StringComparer.Ordinal.GetHashCode(OcaGroup) : 0);
                hash = hash * 31 + (OrderRef != null ? StringComparer.Ordinal.GetHashCode(OrderRef) : 0);
                hash = hash * 31 + (GoodAfterTime != null ? StringComparer.Ordinal.GetHashCode(GoodAfterTime) : 0);
                hash = hash * 31 + (GoodTillDate != null ? StringComparer.Ordinal.GetHashCode(GoodTillDate) : 0);
                hash = hash * 31 + (Rule80A != null ? StringComparer.Ordinal.GetHashCode(Rule80A) : 0);
                hash = hash * 31 + (FaGroup != null ? StringComparer.Ordinal.GetHashCode(FaGroup) : 0);
                hash = hash * 31 + (FaProfile != null ? StringComparer.Ordinal.GetHashCode(FaProfile) : 0);
                hash = hash * 31 + (FaMethod != null ? StringComparer.Ordinal.GetHashCode(FaMethod) : 0);
                hash = hash * 31 + (FaPercentage != null ? StringComparer.Ordinal.GetHashCode(FaPercentage) : 0);
                hash = hash * 31 + (OpenClose != null ? StringComparer.Ordinal.GetHashCode(OpenClose) : 0);
                hash = hash * 31 + (DesignatedLocation != null ? StringComparer.Ordinal.GetHashCode(DesignatedLocation) : 0);
                hash = hash * 31 + (DeltaNeutralOrderType != null ? StringComparer.Ordinal.GetHashCode(DeltaNeutralOrderType) : 0);
                hash = hash * 31 + (DeltaNeutralSettlingFirm != null ? StringComparer.Ordinal.GetHashCode(DeltaNeutralSettlingFirm) : 0);
                hash = hash * 31 + (DeltaNeutralClearingAccount != null ? StringComparer.Ordinal.GetHashCode(DeltaNeutralClearingAccount) : 0);
                hash = hash * 31 + (DeltaNeutralClearingIntent != null ? StringComparer.Ordinal.GetHashCode(DeltaNeutralClearingIntent) : 0);
                hash = hash * 31 + (DeltaNeutralOpenClose != null ? StringComparer.Ordinal.GetHashCode(DeltaNeutralOpenClose) : 0);
                hash = hash * 31 + (DeltaNeutralDesignatedLocation != null ? StringComparer.Ordinal.GetHashCode(DeltaNeutralDesignatedLocation) : 0);
                hash = hash * 31 + (HedgeType != null ? StringComparer.Ordinal.GetHashCode(HedgeType) : 0);
                hash = hash * 31 + (HedgeParam != null ? StringComparer.Ordinal.GetHashCode(HedgeParam) : 0);
                hash = hash * 31 + (Account != null ? StringComparer.Ordinal.GetHashCode(Account) : 0);
                hash = hash * 31 + (SettlingFirm != null ? StringComparer.Ordinal.GetHashCode(SettlingFirm) : 0);
                hash = hash * 31 + (ClearingAccount != null ? StringComparer.Ordinal.GetHashCode(ClearingAccount) : 0);
                hash = hash * 31 + (ClearingIntent != null ? StringComparer.Ordinal.GetHashCode(ClearingIntent) : 0);
                hash = hash * 31 + (AlgoStrategy != null ? StringComparer.Ordinal.GetHashCode(AlgoStrategy) : 0);
                hash = hash * 31 + (AlgoId != null ? StringComparer.Ordinal.GetHashCode(AlgoId) : 0);
                hash = hash * 31 + (ScaleTable != null ? StringComparer.Ordinal.GetHashCode(ScaleTable) : 0);
                hash = hash * 31 + (ModelCode != null ? StringComparer.Ordinal.GetHashCode(ModelCode) : 0);
                hash = hash * 31 + (ExtOperator != null ? StringComparer.Ordinal.GetHashCode(ExtOperator) : 0);
                hash = hash * 31 + (AutoCancelDate != null ? StringComparer.Ordinal.GetHashCode(AutoCancelDate) : 0);
                hash = hash * 31 + (Shareholder != null ? StringComparer.Ordinal.GetHashCode(Shareholder) : 0);
