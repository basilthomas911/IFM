    ...
    public class OrderState
    {
        ...
        */
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hash = 17;
                hash = hash * 31 + commission.GetHashCode();
                hash = hash * 31 + minCommission.GetHashCode();
                hash = hash * 31 + maxCommission.GetHashCode();
                hash = hash * 31 + (status != null ? StringComparer.OrdinalIgnoreCase.GetHashCode(status) : 0);
                hash = hash * 31 + (initMarginBefore != null ? StringComparer.OrdinalIgnoreCase.GetHashCode(initMarginBefore) : 0);
                hash = hash * 31 + (maintMarginBefore != null ? StringComparer.OrdinalIgnoreCase.GetHashCode(maintMarginBefore) : 0);
                hash = hash * 31 + (equityWithLoanBefore != null ? StringComparer.OrdinalIgnoreCase.GetHashCode(equityWithLoanBefore) : 0);
                hash = hash * 31 + (initMarginChange != null ? StringComparer.OrdinalIgnoreCase.GetHashCode(initMarginChange) : 0);
                hash = hash * 31 + (maintMarginChange != null ? StringComparer.OrdinalIgnoreCase.GetHashCode(maintMarginChange) : 0);
                hash = hash * 31 + (equityWithLoanChange != null ? StringComparer.OrdinalIgnoreCase.GetHashCode(equityWithLoanChange) : 0);
                hash = hash * 31 + (initMarginAfter != null ? StringComparer.OrdinalIgnoreCase.GetHashCode(initMarginAfter) : 0);
                hash = hash * 31 + (maintMarginAfter != null ? StringComparer.OrdinalIgnoreCase.GetHashCode(maintMarginAfter) : 0);
                hash = hash * 31 + (equityWithLoanAfter != null ? StringComparer.OrdinalIgnoreCase.GetHashCode(equityWithLoanAfter) : 0);
                hash = hash * 31 + (commissionCurrency != null ? StringComparer.OrdinalIgnoreCase.GetHashCode(commissionCurrency) : 0);
                hash = hash * 31 + (completedTime != null ? StringComparer.OrdinalIgnoreCase.GetHashCode(completedTime) : 0);
                hash = hash * 31 + (completedStatus != null ? StringComparer.OrdinalIgnoreCase.GetHashCode(completedStatus) : 0);
                return hash;
            }
        }
    }
