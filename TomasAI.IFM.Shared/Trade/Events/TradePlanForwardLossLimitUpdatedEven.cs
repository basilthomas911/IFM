...
namespace TomasAI.IFM.Shared.Trade.Events
{
    ...
    public record TradePlanForwardLossLimitUpdatedEvent : IEvent
    {
        [IgnoreMember] public const string Actor = "TradePlanEvent";
        [IgnoreMember] public const string Verb = "ForwardLossLimitUpdated";
        ...
        [IgnoreMember] public string EventName => nameof(TradePlanForwardLossLimitUpdatedEvent);
        [IgnoreMember] public EventType EventType => EventType.DomainEvent;

        public TradePlanForwardLossLimitUpdatedEvent() { }
        ...
        public ICompleteEvent ToCompletedEvent() => new TradePlanForwardLossLimitUpdatedCompleteEvent
        {
            TradePlanForwardLossLimit = this.TradePlanForwardLossLimit,
            UpdatedOn = this.UpdatedOn,
            UpdatedBy = this.UpdatedBy
        };
        public IErrorEvent ToFailedEvent(Exception ex) => new TradePlanForwardLossLimitUpdatedFailEvent
        {
    ...
    public record TradePlanForwardLossLimitUpdatedCompleteEvent : CompleteEvent
    {
    ...
    public record TradePlanForwardLossLimitUpdatedFailEvent : ErrorEvent
    {
    }
}
