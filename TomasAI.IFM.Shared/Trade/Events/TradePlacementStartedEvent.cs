...
namespace TomasAI.IFM.Shared.Trade.Events
{
    ...
    public record TradePlacementStartedEvent : IEvent
    {
        ...
        [IgnoreMember] public string EventName => nameof(TradePlacementStartedEvent);
        [IgnoreMember] public EventType EventType => EventType.DomainEvent;

        public TradePlacementStartedEvent() { }
