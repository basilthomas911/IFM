...
namespace TomasAI.IFM.Shared.Trade.Events
{
    ...
    public record TradePlanForwardLossLimitReachedUpdatedEvent : IEvent
    {
        [IgnoreMember] public const string Actor = "TradePlanEvent";
        [IgnoreMember] public const string Verb = "ForwardLossLimitReachedUpdated";
        [IgnoreMember] public const int ErrorCode = 7051;
        ...
        [IgnoreMember] public string EventName => nameof(TradePlanForwardLossLimitReachedUpdatedEvent);
        [IgnoreMember] public EventType EventType => EventType.DomainEvent;

        public TradePlanForwardLossLimitReachedUpdatedEvent() { }
        ...
        public ICompleteEvent ToCompletedEvent() => new TradePlanForwardLossLimitReachedUpdatedCompleteEvent
        {
            TradePlanForwardLossLimit = this.TradePlanForwardLossLimit,
            UpdatedOn = this.UpdatedOn,
            UpdatedBy = this.UpdatedBy
        };
        public IErrorEvent ToFailedEvent(Exception ex) => new TradePlanForwardLossLimitReachedUpdatedFailEvent
        {
    ...
    public record TradePlanForwardLossLimitReachedUpdatedCompleteEvent : CompleteEvent
    {
    ...
    public record TradePlanForwardLossLimitReachedUpdatedFailEvent : ErrorEvent
    {
    }
}
