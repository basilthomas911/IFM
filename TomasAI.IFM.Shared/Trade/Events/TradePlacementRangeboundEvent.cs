...
public record TradePlacementRangeboundEvent : IEvent
{
    [IgnoreMember] public const string Actor = "TradePlacementEvent";
    [IgnoreMember] public const string Verb = "Rangebound";
    ...
    [IgnoreMember] public string EventName => nameof(TradePlacementRangeboundEvent);
    [IgnoreMember] public EventType EventType => EventType.DomainEvent;

    public TradePlacementRangeboundEvent() { }
...
public record TradePlacementRangeboundCompleteEvent : CompleteEvent
{
...
public record TradePlacementRangeboundFailEvent : ErrorEvent
{
}
