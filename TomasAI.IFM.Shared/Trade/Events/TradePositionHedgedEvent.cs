...
namespace TomasAI.IFM.Shared.Trade.Events
{
    ...
    public record TradePositionHedgedEvent : IEvent, ITradeDiaryEvent
    {
        [IgnoreMember] public const string Actor = "TradePositionEvent";
        [IgnoreMember] public const string Verb = "Hedged";
        [IgnoreMember] public const int ErrorCode = 9063;
        ...
        [IgnoreMember] public string EventName => nameof(TradePositionHedgedEvent);
        [IgnoreMember] public EventType EventType => EventType.DomainEvent;

        public TradePositionHedgedEvent() { }
        ...
        public ICompleteEvent ToCompletedEvent() => new TradePositionHedgedCompleteEvent
        {
        ...
        public IErrorEvent ToFailedEvent(Exception ex) => new TradePositionHedgedFailEvent
        {
            CommandId = this.CommandId,
    ...
    public record TradePositionHedgedCompleteEvent : CompleteEvent
    {
    ...
    public record TradePositionHedgedFailEvent : ErrorEvent
    {
    }
