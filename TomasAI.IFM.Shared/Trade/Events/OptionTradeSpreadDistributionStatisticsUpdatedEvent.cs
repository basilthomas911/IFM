...
public record OptionTradeSpreadDistributionStatisticsUpdatedEvent : IEvent<OptionTradeEntityId>
{
    [IgnoreMember] public const string Actor = "OptionTradeEvent";
    [IgnoreMember] public const string Verb = "SpreadDistributionStatisticsUpdated";
    ...
    [Key(18)] public string UpdatedBy { get; init; }

    [IgnoreMember] public string UserName => $"{Environment.UserDomainName}\\{Environment.UserName}";
    [IgnoreMember] public string EventName => GetType().Name;
    [IgnoreMember] public EventType EventType => EventType.DomainEvent;

    public OptionTradeSpreadDistributionStatisticsUpdatedEvent() { }
        ...
        where TEntityId : IActorEntityId
    {
        ...
        ICompleteEvent<OptionTradeEntityId> completed = new OptionTradeSpreadDistributionStatisticsUpdatedCompleteEvent
        {
            Subject = new ActorSubject(ActorType.Event, OptionTradeSpreadDistributionStatisticsUpdatedCompleteEvent.Actor, OptionTradeSpreadDistributionStatisticsUpdatedCompleteEvent.Verb, this.Subject.EntityId),
        ...
        where TEntityId : IActorEntityId
    {
        ...
        IErrorEvent<OptionTradeEntityId> failed = new OptionTradeSpreadDistributionStatisticsUpdatedFailEvent
        {
            Subject = new ActorSubject(ActorType.Event, OptionTradeSpreadDistributionStatisticsUpdatedFailEvent.Actor, OptionTradeSpreadDistributionStatisticsUpdatedFailEvent.Verb, this.Subject.EntityId),
            EntityId = this.EntityId,
            Id = this.Id,
...
[MessagePackObject(AllowPrivate = true)]
public record OptionTradeSpreadDistributionStatisticsUpdatedCompleteEvent : ICompleteEvent<OptionTradeEntityId>
{
    [IgnoreMember] public const string Actor = "OptionTradeEvent";
    [IgnoreMember] public const string Verb = "SpreadDistributionStatisticsUpdatedComplete";
    ...
    public OptionTradeSpreadDistributionStatisticsUpdatedCompleteEvent() { }
...
[MessagePackObject(AllowPrivate = true)]
public record OptionTradeSpreadDistributionStatisticsUpdatedFailEvent : IErrorEvent<OptionTradeEntityId>
{
    [IgnoreMember] public const string Actor = "OptionTradeEvent";
    [IgnoreMember] public const string Verb = "SpreadDistributionStatisticsUpdatedFail";
    ...
    public OptionTradeSpreadDistributionStatisticsUpdatedFailEvent() { }
