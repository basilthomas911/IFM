...
/// <summary>
/// Event published when an application shutdown is initiated.
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record ApplicationShutdownEvent : IEvent<ApplicationEntityId>
{
    [IgnoreMember] public const string Actor = "ApplicationEvent";
    [IgnoreMember] public const string Verb = "Shutdown";
    [IgnoreMember] public const int ErrorCode = 10002;
        ...
        where TEntityId : IActorEntityId
    {
        ...
        {
            Subject = new ActorSubject(ActorType.Event, ApplicationShutdownCompleteEvent.Actor, ApplicationShutdownCompleteEvent.Verb, Subject.EntityId),
    ...
    public IErrorEvent<TEntityId> ToFailEvent<TFail, TEntityId>(Exception ex)
        ...
        where TEntityId : IActorEntityId
    {
        var failed = new ApplicationShutdownFailEvent
        {
            Subject = new ActorSubject(ActorType.Event, ApplicationShutdownFailEvent.Actor, ApplicationShutdownFailEvent.Verb, Subject.EntityId),
            EntityId = this.EntityId,
            Id = this.Id,
...
/// <summary>
/// Event published when the application shutdown has completed successfully.
/// Carries metadata from the original shutdown event.
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record ApplicationShutdownCompleteEvent : ICompleteEvent<ApplicationEntityId>
{
    [IgnoreMember] public const string Actor = "ApplicationEvent";
    [IgnoreMember] public const string Verb = "ShutdownComplete";
    [Key(0)] public ActorSubject Subject { get; init; }
...
/// <summary>
/// Error event published when handling the application shutdown failed.
/// Contains standardized error details.
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record ApplicationShutdownFailEvent : IErrorEvent<ApplicationEntityId>
{
    [IgnoreMember] public const string Actor = "ApplicationEvent";
    [IgnoreMember] public const string Verb = "ShutdownFail";
    [Key(0)] public ActorSubject Subject { get; init; }
    [Key(1)] public ApplicationEntityId EntityId { get; init; }
    [Key(2)] public Guid Id { get; init; }
