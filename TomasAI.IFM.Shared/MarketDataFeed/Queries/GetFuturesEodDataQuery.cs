...
/// <summary>
/// MessagePack-serializable query to retrieve end-of-day (EOD) futures data for a specific contract and value date.
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public class GetFuturesEodDataQuery : IQuery<FuturesEodDataV2ReadModel>
{
    [IgnoreMember] public const string Actor = "FuturesEodDataQuery";
    [IgnoreMember] public const string Verb = "GetFuturesEodData";
    ...
    public GetFuturesEodDataQuery() { }

    public GetFuturesEodDataQuery(string contractId, DateOnly valueDate)
    {
        ContractId = contractId ?? string.Empty;
        ValueDate = valueDate;
        EntityId = new GetFuturesEodDataParameter(contractId, valueDate);
        ErrorCode = ErrorId;
    }
