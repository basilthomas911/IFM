...
/// <summary>
/// MessagePack-serializable query to retrieve VIX futures EOD data for a given contract and date.
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public class GetLastVixFuturesEodDataQuery : IQuery<VixFuturesEodDataReadModel>
{
    [IgnoreMember] public const string Actor = "FuturesEodDataQuery";
    [IgnoreMember] public const string Verb = "GetLastVixFuturesEodData";
    ...
    public GetLastVixFuturesEodDataQuery() { }

    public GetLastVixFuturesEodDataQuery(string contractId, DateOnly valueDate)
    {
        ContractId = contractId ?? string.Empty;
        ValueDate = valueDate;
        EntityId = new GetLastVixFuturesEodDataParameter(contractId, valueDate);
        ErrorCode = ErrorId;
    }
