...
/// <summary>
/// Represents a domain event indicating that a trade live feed has been removed.
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record TradeLiveFeedRemovedEvent : IEvent<TradeLiveFeedId>
{
    [IgnoreMember] public const string Actor = "MarketDataFeedEvent";
    [IgnoreMember] public const string Verb = "TradeLiveFeedRemoved";
    ...
    public TradeLiveFeedRemovedEvent() { }
        ...
        where TEntityId : IActorEntityId
    {
        ...
        ICompleteEvent<TradeLiveFeedId> completed = new TradeLiveFeedRemovedCompleteEvent
        {
            Subject = new ActorSubject(ActorType.Event, TradeLiveFeedRemovedCompleteEvent.Actor, TradeLiveFeedRemovedCompleteEvent.Verb, this.Subject.EntityId),
        ...
        where TEntityId : IActorEntityId
    {
        ...
        IErrorEvent<TradeLiveFeedId> failed = new TradeLiveFeedRemovedFailEvent
        {
            Subject = new ActorSubject(ActorType.Event, TradeLiveFeedRemovedFailEvent.Actor, TradeLiveFeedRemovedFailEvent.Verb, this.Subject.EntityId),
            EntityId = this.EntityId,
            Id = this.Id,
...
/// <summary>
/// Event published when a trade live feed has been removed successfully.
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record TradeLiveFeedRemovedCompleteEvent : ICompleteEvent<TradeLiveFeedId>
{
    [IgnoreMember] public const string Actor = "MarketDataFeedEvent";
    [IgnoreMember] public const string Verb = "TradeLiveFeedRemovedComplete";
    ...
    public TradeLiveFeedRemovedCompleteEvent() { }
...
/// <summary>
/// Event published when removing a trade live feed fails.
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record TradeLiveFeedRemovedFailEvent : IErrorEvent<TradeLiveFeedId>
{
    [IgnoreMember] public const string Actor = "MarketDataFeedEvent";
    [IgnoreMember] public const string Verb = "TradeLiveFeedRemovedFail";
    ...
    public TradeLiveFeedRemovedFailEvent() { }
