...
public record FuturesOptionTickDataInsertedEvent : IEvent<FuturesOptionTickEntityId>
{
    ...
    public FuturesOptionTickDataInsertedEvent() { }
        ...
        where TEntityId : IActorEntityId
    {
        ...
        ICompleteEvent<FuturesOptionTickEntityId> completed = new FuturesOptionTickDataInsertedCompleteEvent
        {
            Subject = new ActorSubject(ActorType.Event, FuturesOptionTickDataInsertedCompleteEvent.Actor, FuturesOptionTickDataInsertedCompleteEvent.Verb, this.Subject.EntityId),
        ...
        where TEntityId : IActorEntityId
    {
        ...
        IErrorEvent<FuturesOptionTickEntityId> failed = new FuturesOptionTickDataInsertedFailEvent
        {
            Subject = new ActorSubject(ActorType.Event, FuturesOptionTickDataInsertedFailEvent.Actor, FuturesOptionTickDataInsertedFailEvent.Verb, this.Subject.EntityId),
            EntityId = this.EntityId,
            Id = this.Id,
...
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record FuturesOptionTickDataInsertedCompleteEvent : ICompleteEvent<FuturesOptionTickEntityId>
{
    [IgnoreMember] public const string Actor = "FuturesOptionTickDataEvent";
    ...
    public FuturesOptionTickDataInsertedCompleteEvent() { }
...
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record FuturesOptionTickDataInsertedFailEvent : IErrorEvent<FuturesOptionTickEntityId>
{
    [IgnoreMember] public const string Actor = "FuturesOptionTickDataEvent";
    ...
    public FuturesOptionTickDataInsertedFailEvent() { }
