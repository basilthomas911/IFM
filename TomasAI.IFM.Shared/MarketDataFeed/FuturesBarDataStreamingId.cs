...
/// <summary>
/// Unique identifier for a streaming futures bar data session associated with a specific value (trading) date.
/// </summary>
/// <remarks>
...
public record FuturesBarDataStreamingId : IActorEntityId
{
    /// <summary>The value (trading) date for the streaming bar data session.</summary>
    [Key(0)]
