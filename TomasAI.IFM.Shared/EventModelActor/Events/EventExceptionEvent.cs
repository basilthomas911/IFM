...
/// <summary>
/// Exception-level error event produced when an event processing error occurs.
...
public record EventExceptionEvent : IErrorEvent<ActorEntityId>
{
    [IgnoreMember] public const string Verb = "EventFail";
    ...
    /// </summary>
    public EventExceptionEvent() { EntityId = ActorEntityId.Default; }

    /// <summary>
    /// MessagePack constructor used for deserialization.
    /// </summary>
    [SerializationConstructor]
    public EventExceptionEvent(
