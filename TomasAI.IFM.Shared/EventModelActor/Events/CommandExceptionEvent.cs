...
/// <summary>
/// Exception-level error event produced when a command causes an exception.
...
public record CommandExceptionEvent : IErrorEvent<ActorEntityId>
{
    [IgnoreMember] public const string CommandFail = "CommandFail";
    ...
    /// </summary>
    public CommandExceptionEvent() { EntityId = ActorEntityId.Default; }
