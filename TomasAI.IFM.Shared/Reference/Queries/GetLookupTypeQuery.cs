...
/// <summary>
/// MessagePack-serializable query to retrieve lookup type data based on the specified lookup type name.
/// </summary>
/// <remarks>
...
public class GetLookupTypeQuery : IQuery<LookupTypeCollection>
{
    [IgnoreMember] public const string Actor = "LookupTypeQuery";
    [IgnoreMember] public const string Verb = "GetLookupType";
    ...
    /// </summary>
    /// <param name="lookupTypeName">The name of the lookup type to retrieve.</param>
    public GetLookupTypeQuery(string lookupTypeName)
    {
        LookupTypeName = lookupTypeName ?? string.Empty;
        EntityId = new GetLookupTypeParameter(lookupTypeName!);
        ErrorCode = ErrorId;
    }
