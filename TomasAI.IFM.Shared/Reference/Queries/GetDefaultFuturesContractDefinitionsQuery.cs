...
/// <summary>
/// MessagePack-serializable query to retrieve the default futures contract definitions.
/// </summary>
/// <remarks>
...
public class GetDefaultFuturesContractDefinitionsQuery : IQuery<DefaultFuturesContractDefinitionsReadModel>
{
    [IgnoreMember] public const string Actor = "ReferenceQuery";
    [IgnoreMember] public const string Verb = "GetDefaultFuturesContractDefinitions";
    [IgnoreMember] public const int ErrorId = 1025;
    ...
    /// </summary>
    public GetDefaultFuturesContractDefinitionsQuery()
    {
