...
/// <summary>
/// Represents a domain event indicating that a yield curve rate entry has been removed. Used to communicate the deletion
/// of a yield curve rate entry within the event-driven system and to support denormalization workflows.
/// </summary>
/// <remarks>This event is typically published when a yield curve rate entry is successfully deleted. It carries
/// metadata and the details of the removed yield curve rate entry for downstream processing, auditing, or projection
...
public record YieldCurveRateRemovedEvent : IEvent<YieldCurveRateEntityId>
{
    [IgnoreMember] public const string Actor = "YieldCurveRateEvent";
    [IgnoreMember] public const string Verb = "Removed";
    [IgnoreMember] public const int ErrorCode = 2009;
    ...
    public YieldCurveRateRemovedEvent() { }
        ...
        where TEntityId : IActorEntityId
    {
        ...
        ICompleteEvent<YieldCurveRateEntityId> completed = new YieldCurveRateRemovedCompleteEvent
        {
            Subject = new ActorSubject(ActorType.Event, YieldCurveRateRemovedCompleteEvent.Actor, YieldCurveRateRemovedCompleteEvent.Verb, this.Subject.EntityId),
        ...
        where TEntityId : IActorEntityId
    {
        ...
        IErrorEvent<YieldCurveRateEntityId> failed = new YieldCurveRateRemovedFailEvent
        {
            Subject = new ActorSubject(ActorType.Event, YieldCurveRateRemovedFailEvent.Actor, YieldCurveRateRemovedFailEvent.Verb, this.Subject.EntityId),
            EntityId = this.EntityId,
            Id = this.Id,
...
/// <summary>
/// Event published when a yield curve rate entry has been removed successfully.
/// Carries metadata from the original event.
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record YieldCurveRateRemovedCompleteEvent : ICompleteEvent<YieldCurveRateEntityId>
{
    [IgnoreMember] public const string Actor = "YieldCurveRateEvent";
    ...
    public YieldCurveRateRemovedCompleteEvent() { }
...
/// <summary>
/// Event published when removing a yield curve rate entry fails.
/// Carries standardized error details from the error event contract.
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record YieldCurveRateRemovedFailEvent : IErrorEvent<YieldCurveRateEntityId>
{
    [IgnoreMember] public const string Actor = "YieldCurveRateEvent";
    ...
    public YieldCurveRateRemovedFailEvent() { }
