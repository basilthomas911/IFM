...
/// <summary>
/// MessagePack-serializable query to retrieve details of a futures contract by its contract identifier.
/// </summary>
/// <remarks>
...
public record GetFuturesContractQuery : IQuery<FuturesContractV2ReadModel>
{
    ...
    [IgnoreMember] public const int ErrorId = 1001;
    ...
    /// </summary>
    public GetFuturesContractQuery() { }

    /// <summary>
    /// Creates a new query for the specified contract id.
    /// </summary>
    /// <param name="contractId">Futures contract identifier.</param>
    public GetFuturesContractQuery(string contractId)
    {
        ContractId = contractId ?? string.Empty;
        EntityId = new GetFuturesContractParameter(ContractId);
        ErrorCode = ErrorId;
    }
