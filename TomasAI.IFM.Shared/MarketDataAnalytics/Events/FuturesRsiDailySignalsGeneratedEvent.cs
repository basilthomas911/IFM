...
public record FuturesRsiDailySignalsGeneratedEvent : IEvent<FuturesRsiDailySignalEntityId>
{
    [IgnoreMember] public const string Actor = "FuturesRsiSignalEvent";
    [IgnoreMember] public const string Verb = "FuturesRsiDailySignalsGenerated";
    ...
    public FuturesRsiDailySignalsGeneratedEvent() { }
        ...
        where TEntityId : IActorEntityId
    {
        ...
        ICompleteEvent<FuturesRsiDailySignalEntityId> completed = new FuturesRsiDailySignalsGeneratedCompleteEvent
        {
            Subject = new ActorSubject(ActorType.Event, FuturesRsiDailySignalsGeneratedCompleteEvent.Actor, FuturesRsiDailySignalsGeneratedCompleteEvent.Verb, this.Subject.EntityId),
        ...
        where TEntityId : IActorEntityId
    {
        ...
        IErrorEvent<FuturesRsiDailySignalEntityId> failed = new FuturesRsiDailySignalsGeneratedFailEvent
        {
            Subject = new ActorSubject(ActorType.Event, FuturesRsiDailySignalsGeneratedFailEvent.Actor, FuturesRsiDailySignalsGeneratedFailEvent.Verb, this.Subject.EntityId),
            EntityId = this.EntityId,
            Id = this.Id,
...
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record FuturesRsiDailySignalsGeneratedCompleteEvent : ICompleteEvent<FuturesRsiDailySignalEntityId>
{
    [IgnoreMember] public const string Actor = "FuturesRsiSignalEvent";
    [IgnoreMember] public const string Verb = "FuturesRsiDailySignalsGeneratedComplete";
    ...
    public FuturesRsiDailySignalsGeneratedCompleteEvent() { }
...
/// </summary>
[MessagePackObject(AllowPrivate = true)]
public record FuturesRsiDailySignalsGeneratedFailEvent : IErrorEvent<FuturesRsiDailySignalEntityId>
{
    [IgnoreMember] public const string Actor = "FuturesRsiSignalEvent";
    [IgnoreMember] public const string Verb = "FuturesRsiDailySignalsGeneratedFail";
    ...
    public FuturesRsiDailySignalsGeneratedFailEvent() { }
