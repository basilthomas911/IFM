...
public record GetFuturesAtrSignalQuery : IQuery<FuturesAtrSignalReadModel>
{
    [IgnoreMember] public const string Actor = "FuturesAtrSignalQuery";
    [IgnoreMember] public const string Verb = "GetFuturesAtrSignal";
    ...
    public GetFuturesAtrSignalQuery()
    {
        ErrorCode = ErrorId;
    }
    ...
    public GetFuturesAtrSignalQuery(string contractId, DateOnly valueDate, TradeTimePeriodType timePeriod, int periodLength)
    {
        ...
        EntityId = new FuturesAtrSignalEntityId(contractId, valueDate, timePeriod, periodLength);
        ErrorCode = ErrorId;
    }
