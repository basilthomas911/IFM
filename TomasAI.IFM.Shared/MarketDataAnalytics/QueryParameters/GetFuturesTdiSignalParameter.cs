...
/// <summary>
/// Represents the parameters required to retrieve a futures TDI signal for a specific contract and value date.
/// </summary>
[MessagePackObject(false)]
public record GetFuturesTdiSignalParameter : IActorEntityId, IQueryParameter
{
