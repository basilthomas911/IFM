...
public record GenerateFuturesAdxSignalCommand : ICommand<FuturesAdxSignalEntityId>
{
    public const string Actor = "FuturesAdxSignalCommand";
    public const string Verb = "GenerateFuturesAdxSignal";
    ...
    [Key(3)] public FuturesAdxSignalEntityId EntityId { get; init; } 
    ...
    /// <param name="futuresItiSignals">An array of FuturesItiSignalV2ReadModel objects that represent the associated futures ITI signals. This
