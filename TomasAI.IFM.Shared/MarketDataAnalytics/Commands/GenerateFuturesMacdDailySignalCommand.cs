...
public record GenerateFuturesMacdDailySignalCommand : ICommand<FuturesMacdDailySignalEntityId>
{
    public const string Actor = "FuturesMacdSignalCommand";
    public const string Verb = "GenerateFuturesMacdDailySignal";
    ...
    [Key(3)] public FuturesMacdDailySignalEntityId EntityId { get; init; }
    ...
    /// </summary>
    public GenerateFuturesMacdDailySignalCommand() { }
        ...
        decimal futuresPrice)
    {
        ...
        EntityId = futuresMacdSignalId.ToDailyEntityId();
        ErrorCode = ErrorId;
