...
/// <summary>
/// Command to stop (terminate) an LLM-based futures trade signal workflow for the specified trade signal entity.
/// </summary>
/// <remarks>
/// Follows the MessagePack serialization pattern used by other analytics commands. Routes to
/// <see cref="BoundedContextName.FuturesTradeSignalLLMBoundedContext"/>. Custom properties begin at key index 6
/// because base command members occupy keys 0–5.
/// </remarks>
[MessagePackObject(AllowPrivate = true)]
public record StopFuturesTradeSignalLLMCommand
    : ICommand<FuturesTradeSignalId>
{
    ...
    /// </summary>
    public StopFuturesTradeSignalLLMCommand() { }

    /// <summary>
    /// Creates a new command to stop processing for the specified LLM trade signal entity.
    /// </summary>
    /// <param name="id">Trade signal entity identifier (cannot be null).</param>
    public StopFuturesTradeSignalLLMCommand(FuturesTradeSignalId id)
    {
