...
{
    public partial class AdjustFundTransactionForm : Form, IForm<AdjustFundTransactionForm>, IFormControl
    {
        AdjustFundTransactionReadModel _viewModel;

        public AdjustFundTransactionForm()
        {
            InitializeComponent();
        }
        ...
        public void LoadModel(AdjustFundTransactionReadModel viewModel)
        {
            ...
            _viewModel.OnFundTransactionAdjustment = () =>
                this.Post(() =>
                {
                    this.ShowErrorMessage($"Adjustment on Fund Transaction: {_viewModel.FundTransaction.TransactionId} was created", "Fund Transaction Adjustment");
