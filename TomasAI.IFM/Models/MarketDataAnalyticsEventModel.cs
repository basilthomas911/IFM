...
namespace TomasAI.IFM.Models
{
    public class MarketDataAnalyticsEventModel : BaseModel<MarketDataAnalyticsEventModel>
    {
        ...
        public async Task StartFuturesItiSignalEventListenersAsync( 
            Action<FuturesItiSignalViewModel> trendDirectionChangedAction,
            Action<FuturesItiSignalViewModel> trendExtremeChangedAction,
            Action<FuturesTradeSignalViewModel> futuresTradeSignalAction) 
