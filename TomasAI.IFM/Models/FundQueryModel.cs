...
namespace TomasAI.IFM.Models
{
    public class FundQueryModel : BaseModel<FundQueryModel>
    {
        ...
        /// </summary>
        /// <param name="onCompleted"></param>
        public async Task GetFundTransactionsAsync(int fundId, DateTime startDate, DateTime endDate, Action<FundTransactionReadModel[]> onCompleted)
        ...
        /// <param name="onCompleted"></param>
        public async Task GetFundPnlReportAsync(int fundId, DateTime startDate, DateTime endDate, Action<FundPnlReportReadModel> onCompleted)
        ...
        /// <param name="endDate"></param>
        /// <param name="onCompleted"></param>
        public async Task GetFundWinLossRatioAsync(int fundId, DateTime startDate, DateTime endDate, Action<FundWinLossRatioReadModel> onCompleted)
