...
namespace TomasAI.IFM.Models
{
    public class SpreadDistributionJobModel : BaseModel<SpreadDistributionJobModel>
    {
        ...
        public async Task ClearSpreadDistributionJobsAsync(OptionTradeId optionTradeId)
            => await ExecuteCommandAsync(() => _optionPricerCommandApi.ClearSpreadDistributionJobAsync(optionTradeId));

        /// <summary>
        /// delete spread distribution jobs in progress
        /// </summary>
        /// <param name="optionTradeId"></param>
        public async Task DeleteSpreadDistributionJobsInProgressAsync(OptionTradeId optionTradeId)
            => await ExecuteCommandAsync(() => _optionPricerCommandApi.DeleteSpreadDistributionJobsInProgressAsync(optionTradeId));
