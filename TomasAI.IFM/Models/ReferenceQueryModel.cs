...
namespace TomasAI.IFM.Models
{
    public class ReferenceQueryModel : BaseModel<ReferenceQueryModel>
    {
        ...
        /// </summary>
        /// <param name="onCompleted"></param>
        public async Task LoadMarketDataDefinitionTypesAsync(Action<LookupTypeReadModel[]> onCompleted)
        ...
        /// </summary>
        /// <param name="onCompleted"></param>
        public async Task LoadReferenceDataDefinitionTypesAsync(Action<LookupTypeReadModel[]> onCompleted)
        ...
        /// </summary>
        /// <param name="onCompleted"></param>
        public async Task LoadSystemAdminFunctionTypesAsync(Action<LookupTypeReadModel[]> onCompleted)
        ...
        /// </summary>
        /// <param name="onCompleted"></param>
        public async Task LoadSymbolsAsync(Action<LookupTypeReadModel[]> onCompleted)
        ...
        /// </summary>
        /// <param name="onCompleted"></param>
        public async Task LoadSecurityTypesAsync(Action<LookupTypeReadModel[]> onCompleted)
        ...
        /// </summary>
        /// <param name="onCompleted"></param>
        public async Task LoadCurrenciesAsync(Action<LookupTypeReadModel[]> onCompleted)
        ...
        /// </summary>
        /// <param name="onCompleted"></param>
        public async Task LoadExchangesAsync(Action<LookupTypeReadModel[]> onCompleted)
        ...
        /// </summary>
        /// <param name="onCompleted"></param>
        public async Task LoadMultipliersAsync(Action<LookupTypeReadModel[]> onCompleted)
        ...
        /// </summary>
        /// <param name="onCompleted"></param>
        public async Task LoadOptionTypesAsync(Action<LookupTypeReadModel[]> onCompleted)
        ...
        public async Task LoadEconomicCalendarAsync(DateTime todaysDate, EconomicCalendarViewType calendarViewType, string countryCode,  Action<EconomicCalendarReadModel[]> onCompleted)
            => await ExecuteAsync(() => _queryApi.GetEconomicCalendarAsync(todaysDate, calendarViewType, countryCode), onCompleted);
        ...
        /// <param name="onCompleted"></param>
        /// <returns></returns>
        public async Task LoadEconomicCalendarsAsync(Action<EconomicCalendarReadModel[]> onCompleted)
            => await ExecuteAsync(() => _queryApi.GetEconomicCalendarsAsync(), onCompleted);
        ...
        /// <param name="onCompleted"></param>
        /// <returns></returns>
        public async Task LoadLookupTypesAsync(Action<LookupTypeReadModel[]> onCompleted)
