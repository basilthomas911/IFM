    ...
    public class AdjustFundTransactionReadModel : BaseEditorViewModel
    {
        ...
        public AdjustFundTransactionReadModel(IAppRoot appRoot, FundTransactionReadModel fundTransaction, decimal fundBalance) : base(appRoot)
        {
            ...
            _consumeEvents = new IEvent[]{
                new OpeningTradeFundTransactionAdjustmentCreatedCompleteEvent { }.SetEventSource($"{EventTopic.FundEvents}"),
                new OpeningTradeFundTransactionAdjustmentCreatedFailEvent{ }.SetEventSource($"{EventTopic.FundEvents}"),
                new RealizedTradePnlFundTransactionAdjustmentCreatedCompleteEvent{ }.SetEventSource($"{EventTopic.FundEvents}"),
                new RealizedTradePnlFundTransactionAdjustmentCreatedFailEvent{ }.SetEventSource($"{EventTopic.FundEvents}"),
                new TradeCommissionFundTransactionAdjustmentCreatedCompleteEvent{ }.SetEventSource($"{EventTopic.FundEvents}"),
                new TradeCommissionFundTransactionAdjustmentCreatedFailEvent{ }.SetEventSource($"{EventTopic.FundEvents}"),
                new UnrealizedTradePnlFundTransactionAdjustmentCreatedCompleteEvent{ }.SetEventSource($"{EventTopic.FundEvents}"),
                new UnrealizedTradePnlFundTransactionAdjustmentCreatedFailEvent{ }.SetEventSource($"{EventTopic.FundEvents}"),
            };
        }

        public FundTransactionReadModel FundTransaction => _fundTransaction;
        public decimal FundBalance => _fundBalance;
        public Action OnFundTransactionAdjustment { get; set; }
        ...
        public void AdjustFundTransaction(FundTransactionReadModel e)
            => _commandModel.Execute(async model =>  {
                ...
                await model.CreateAdjustmentTransactionAsync(
                    ...
                    amount: e.Amount, 
                    balance: _fundBalance, _setCommandId);
            });
        ...
        Task FundTransactionAdjustmentCompleted()
        {
        ...
        Task FundTransactionAdjustmentFailed(IErrorEvent e)
        {
