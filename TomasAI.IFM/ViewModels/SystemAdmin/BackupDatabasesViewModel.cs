...
namespace TomasAI.IFM.ViewModels.SystemAdmin
{
    ...
    {
        static Dictionary<string, Queue<string>> _statusMessagesMap;
        ...
        public Action<string, string> OnStatusMessagesUpdate;
        public Action OnDatabaseNamesLoaded;
        public Action<string> OnDatabaseBackupComplete;
