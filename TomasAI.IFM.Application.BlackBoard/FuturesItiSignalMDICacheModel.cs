...
public class FuturesItiSignalMDICacheModel
{
    ...
    public FuturesItiSignalMDICacheModel(IRedisCache redisCache, IJsonSerializer jsonSerializer)
    {
    ...
    /// </summary>
    public FuturesItiSignalMDICacheModel() : this(default!, default!)
    {
    }
