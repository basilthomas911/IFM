...
public class FuturesItiSignalAveragePredictedTrendDeltaRangeCacheModel
{
    ...
    public FuturesItiSignalAveragePredictedTrendDeltaRangeCacheModel(IRedisCache redisCache, IJsonSerializer jsonSerializer)
    {
    ...
    /// </summary>
    public FuturesItiSignalAveragePredictedTrendDeltaRangeCacheModel() : this(default!, default!)
    {
    }
