...
public class FuturesRsiSignalCacheModel(IRedisCache redisCache, IJsonSerializer jsonSerializer)
{
    readonly string CacheName = $"{DataCacheName.FuturesRsiSignal}";
    ...
    /// <returns></returns>
    public FuturesRsiSignalReadModel? Get(FuturesRsiSignalEntityId rsiSignalId)
    {
