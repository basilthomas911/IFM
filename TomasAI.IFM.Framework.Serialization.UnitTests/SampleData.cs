...
/// <summary>
/// MessagePack-serializable test command used in serialization unit tests.
/// </summary>
/// <remarks>
...
/// <summary>
/// MessagePack-serializable test entity identifier used in unit tests.
/// </summary>
/// <remarks>
/// - Annotated with <see cref="MessagePackObjectAttribute"/> and sequential <see cref="KeyAttribute"/> indices.
/// - Implements <see cref="IActorEntityId"/>. The <see cref="Format"/> method returns a dot-separated
///   representation of the record parameters; for the single <see cref="ValueDate"/> parameter this yields
...
public readonly record struct TestId : IActorEntityId
{
    ...
    /// <summary>
    /// Formats the identifier using dot-separated record parameters.
    /// For the current single-parameter record this returns "yyyy-MM-dd".
    /// If additional fields are added later, join them with '.' to preserve a dotted format.
    /// </summary>
