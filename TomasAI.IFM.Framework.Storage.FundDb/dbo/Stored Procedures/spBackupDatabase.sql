...
BEGIN
	...
	if @backupType = 'full'
		BACKUP DATABASE [funddb] TO  URL = @backupName WITH  FORMAT, INIT,  NAME = N'funddb-Full Database Backup', SKIP, NOREWIND, NOUNLOAD,  STATS = 10
	else
		BACKUP DATABASE [funddb] TO  URL = @backupName WITH  DIFFERENTIAL , FORMAT, INIT,  NAME = N'funddb-Full Database Backup', SKIP, NOREWIND, NOUNLOAD,  STATS = 10
END