...
-- =============================================
CREATE PROCEDURE [dbo].[spGetLastFuturesItiSignalTrendReversalChange] 
...
BEGIN
	...
	declare @sequenceLastTrendDirectionChanged bigint
	select @sequenceLastTrendDirectionChanged = Max(SequenceId) from futures_iti_signal
	...
	where SequenceId = (select Max(SequenceId) from futures_iti_signal
					  ...
					  and SequenceId > @sequenceLastTrendDirectionChanged)
