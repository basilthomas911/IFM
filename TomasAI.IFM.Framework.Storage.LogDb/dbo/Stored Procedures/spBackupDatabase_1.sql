...
BEGIN
	...
	if @backupType = 'full'
		BACKUP DATABASE [logdb] TO  URL = @backupName WITH  FORMAT, INIT,  NAME = N'logdb-Full Database Backup', SKIP, NOREWIND, NOUNLOAD,  STATS = 10
	else
		BACKUP DATABASE [logdb] TO  URL = @backupName WITH  DIFFERENTIAL , FORMAT, INIT,  NAME = N'logdb-Full Database Backup', SKIP, NOREWIND, NOUNLOAD,  STATS = 10
END