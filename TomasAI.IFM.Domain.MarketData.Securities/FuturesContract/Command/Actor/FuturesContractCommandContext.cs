...
/// <summary>Provides the typed runtime context used by <see cref="FuturesContractCommandActor"/>.</summary>
public sealed class FuturesContractCommandContext : CommandActorContext,
    ICommandActorContext<FuturesContractCommandActor>, IFuturesContractCommandContext
{
    ...
    readonly Lazy<IEventProjector<FuturesContractCommandActor>> _eventProjector;
    readonly Lazy<IReferenceLookupService> _referenceLookupService;

    /// <summary>Initializes a futures-contract command context.</summary>
    public FuturesContractCommandContext(IActorSupervisor supervisor, IDbContextFactory dbFactory,
        IBlackboardService blackboardService, ILogger<FuturesContractCommandActor> logger)
        : base(supervisor, new ActorMailboxId(ActorType.Command, FuturesContractCommandActor.ActorName))
    {
        ...
        _eventProjector = ResolveOnce<IEventProjector<FuturesContractCommandActor>>();
    ...
    /// <inheritdoc/>
    public ILogger<FuturesContractCommandActor> Logger { get; }
    /// <inheritdoc/>
    ...
    /// <inheritdoc/>
    public IEventProjector<FuturesContractCommandActor> EventProjector => _eventProjector.Value;
    /// <inheritdoc/>
